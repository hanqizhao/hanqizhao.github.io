...
`,document.head.appendChild(Pf);var Ff=document.createElement(`div`);Ff.id=`hud-loader-root`,Ff.innerHTML=`
  ...
  <div class="hud-core">
    ...
    <div class="hud-start-prompt" id="hud-start-prompt">Click anywhere to start</div>
  </div>`,document.body.appendChild(Ff);var If,Lf=new Promise(e=>{If=e});(function(){let e=Ff.querySelector(`#hud-bar`),t=Ff.querySelector(`#hud-hex`),n=Ff.querySelector(`#hud-status`);for(let t=0;t<18;t++){let t=document.createElement(`div`);t.className=`hud-block`,e.appendChild(t)}let r=e.querySelectorAll(`.hud-block`),i=0;function a(){i+=Math.random()*2+1,i>100&&(i=100);let e=Math.round(i/100*18);r.forEach((t,n)=>t.classList.toggle(`lit`,n<e)),t.textContent=`0x`+Math.floor(Math.random()*65535).toString(16).toUpperCase(),i<100?setTimeout(a,Math.random()*100+20):(n.textContent=`Boot sequence complete.`,setTimeout(If,800))}setTimeout(a,1e3)})();function Rf(){return new Promise(e=>{let t=Ff.querySelector(`.hud-core`);if(!t){e();return}let n=!1,r=t=>{n||(n=!0,Ff.removeEventListener(`pointerdown`,i,!0),Ff.removeEventListener(`keydown`,a,!0),typeof Gp?.releaseQueuedPlayback==`function`&&Gp.releaseQueuedPlayback(t),e())},i=e=>{e.preventDefault(),r(`loader-start-pointer`)},a=e=>{e.key!==`Enter`&&e.key!==` `||(e.preventDefault(),r(`loader-start-keyboard`))};t.classList.add(`is-awaiting-start`),Ff.tabIndex=0,Ff.focus({preventScroll:!0}),Ff.addEventListener(`pointerdown`,i,!0),Ff.addEventListener(`keydown`,a,!0)})}var zf=document.getElementById(`app`),Bf=new Ln,Vf={fov:65,near:.1,far:1e3},Hf={exposure:1.1,saturation:1.25,highlights:.95,repeatX:2,repeatY:1.2,offsetY:0,rotationY:-3*Math.PI/4},Uf={exposure:.9,bloom:{strength:.01,radius:0,threshold:0}},Wf={appearAt:3,fadeDuration:1},Gf={sources:[`/audio/outer-bgm.ogg`,`/audio/outer-bgm.m4a`],loop:!0,initialVolume:.56,defaultWantsToPlay:!0},Kf={minVolumeRatio:.2,volumeSyncEpsilon:.003},Z=new bo(Vf.fov,window.innerWidth/window.innerHeight,Vf.near,Vf.far),qf=new H().subVectors(X.intro.startTarget,X.intro.startPos).normalize(),Jf=X.intro.startPos.clone().addScaledVector(qf,-X.loader.cameraPush.distance);Z.position.copy(Jf);var Yf=new _u({antialias:!0,alpha:!0}),Xf=Math.min(window.devicePixelRatio,2);Yf.setPixelRatio(Xf),Yf.setSize(window.innerWidth,window.innerHeight),Yf.setClearColor(0,1),Yf.outputColorSpace=He,Yf.useLegacyLights=!1,Yf.toneMapping=4,Yf.toneMappingExposure=Uf.exposure,zf.style.position=`relative`,zf.style.backgroundColor=`#000000`,Yf.domElement.style.position=`absolute`,Yf.domElement.style.top=`0`,Yf.domElement.style.left=`0`,Yf.domElement.style.zIndex=`1`,Yf.domElement.style.pointerEvents=`auto`,zf.appendChild(Yf.domElement);var Zf=window.innerWidth*Xf,Qf=window.innerHeight*Xf,$f=new $d(Yf,new Qt(Zf,Qf,{samples:4,type:y}));$f.addPass(new ef(Bf,Z));var ep=new nf(new V(window.innerWidth,window.innerHeight),Uf.bloom.strength,Uf.bloom.radius,Uf.bloom.threshold);$f.addPass(ep),$f.addPass(new sf(Zf,Qf)),$f.addPass(new lf);var tp=new Ou(Z,Yf.domElement);tp.enabled=!1,tp.target.copy(X.intro.startTarget);var np=new oo,rp=new Wu,ip=new Wd,ap=null,Q=null,op=null,sp=[],cp=null,lp=null,up={runtimeEnabled:!1,current:0,target:0},dp={quad:null},fp={currentGain:1,fullVolumeDistance:0,minimumVolumeDistance:0,lastSyncedVolume:null};function pp(e){if(!Q)return;let t=Mt.clamp(e,0,1),n=t.toFixed(3);up.current=t,Q.element.style.opacity!==n&&(Q.element.style.opacity=n)}function mp(e){Q?.element&&(Q.element.style.pointerEvents!==e&&(Q.element.style.pointerEvents=e),op&&op.style.pointerEvents!==e&&(op.style.pointerEvents=e))}function hp(e,t){return[e[0]*t[0]+e[1]*t[3]+e[2]*t[6],e[0]*t[1]+e[1]*t[4]+e[2]*t[7],e[0]*t[2]+e[1]*t[5]+e[2]*t[8],e[3]*t[0]+e[4]*t[3]+e[5]*t[6],e[3]*t[1]+e[4]*t[4]+e[5]*t[7],e[3]*t[2]+e[4]*t[5]+e[5]*t[8],e[6]*t[0]+e[7]*t[3]+e[8]*t[6],e[6]*t[1]+e[7]*t[4]+e[8]*t[7],e[6]*t[2]+e[7]*t[5]+e[8]*t[8]]}function gp(e,t){return[e[0]*t[0]+e[1]*t[1]+e[2]*t[2],e[3]*t[0]+e[4]*t[1]+e[5]*t[2],e[6]*t[0]+e[7]*t[1]+e[8]*t[2]]}function _p(e){return[e[4]*e[8]-e[5]*e[7],e[2]*e[7]-e[1]*e[8],e[1]*e[5]-e[2]*e[4],e[5]*e[6]-e[3]*e[8],e[0]*e[8]-e[2]*e[6],e[2]*e[3]-e[0]*e[5],e[3]*e[7]-e[4]*e[6],e[1]*e[6]-e[0]*e[7],e[0]*e[4]-e[1]*e[3]]}function vp(e,t,n,r,i,a,o,s){let c=[e,n,i,t,r,a,1,1,1],l=gp(_p(c),[o,s,1]);return hp(c,[l[0],0,0,0,l[1],0,0,0,l[2]])}function yp(e,t,n){let r=vp(0,0,e,0,e,t,0,t),i=hp(vp(n[0].x,n[0].y,n[1].x,n[1].y,n[2].x,n[2].y,n[3].x,n[3].y),_p(r)),a=i.map(e=>e/i[8]);return`matrix3d(${[a[0],a[3],0,a[6],a[1],a[4],0,a[7],0,0,1,0,a[2],a[5],0,a[8]].map(e=>Number.isFinite(e)?e.toFixed(10):`0`).join(`,`)})`}function bp(e){if(e.clone().applyMatrix4(Z.matrixWorldInverse).z>=-.001)return null;let t=e.clone().project(Z);return!Number.isFinite(t.x)||!Number.isFinite(t.y)?null:{x:(t.x*.5+.5)*window.innerWidth,y:(-t.y*.5+.5)*window.innerHeight}}function xp(){if(!Q)return null;Q.updateMatrixWorld(!0);let e=[new H(-jf.width/2,jf.height/2,0),new H(jf.width/2,jf.height/2,0),new H(jf.width/2,-jf.height/2,0),new H(-jf.width/2,-jf.height/2,0)],t=[];for(let n of e){let e=bp(n.applyMatrix4(Q.matrixWorld));if(!e)return null;t.push(e)}return t}function Sp(){Q?.element&&(Q.element.style.display=`none`,dp.quad=null)}function Cp(){if(!Q?.element||!op?.src){Sp();return}Z.updateMatrixWorld(!0),Z.updateProjectionMatrix();let e=xp();if(!e){Sp();return}let t=yp(jf.width,jf.height,e),{element:n}=Q;dp.quad=e,n.style.display!==`block`&&(n.style.display=`block`),n.style.transform!==t&&(n.style.transform=t)}function wp(e,t){if(!dp.quad||dp.quad.length!==4)return!1;let n=0;for(let r=0;r<dp.quad.length;r+=1){let i=dp.quad[r],a=dp.quad[(r+1)%dp.quad.length],o=(a.x-i.x)*(t-i.y)-(a.y-i.y)*(e-i.x);if(Math.abs(o)<=.5)continue;let s=Math.sign(o);if(n===0){n=s;continue}if(n!==s)return!1}return!0}function Tp(e){e.traverse(e=>{e.isMesh&&(e.name.toLowerCase().includes(`screen_plane`)||e.name.toLowerCase().includes(`hitbox`)||(Array.isArray(e.material)?e.material:[e.material]).forEach(e=>{kf.includes(e)||(kf.push(e),e.onBeforeCompile=t=>{e.userData.shader=t,t.uniforms.uShockwaveRadius={value:0},t.uniforms.uShockwaveCenter={value:Af},t.uniforms.uEdgeIntensity={value:X.loader.shockwave.edgeIntensity},t.vertexShader=`
        ...
        `.replace(`#include <dithering_fragment>`,`
          ...
          `)})}))})}function Ep(e){return e.wrapS=r,e.wrapT=i,new wa({transparent:!0,uniforms:{tSky:{value:e},uExposure:{value:Hf.exposure},uSaturation:{value:Hf.saturation},uHighlights:{value:Hf.highlights},uRepeat:{value:new V(Hf.repeatX,Hf.repeatY)},uOffsetY:{value:Hf.offsetY},uSkyOpacity:{value:0}},vertexShader:`varying vec2 vUv; void main() { vUv = uv; gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0); }`,fragmentShader:`
    ...
    `,side:0,toneMapped:!1})}var Dp={computer:{path:`/textures/computer shadow.png`}},Op={room:{path:`/textures/room baked.png`},table:{path:`/textures/table baked.png`},chairBack:{path:`/textures/chair back final.png`},chairLeft:{path:`/textures/chair left final.png`},chairRight:{path:`/textures/chair right final.png`}},kp={computer:{envMapIntensity:10.95,roughnessMin:.8}};function Ap(e){e.map&&(e.map.colorSpace=He),e.emissiveMap&&(e.emissiveMap.colorSpace=He)}function jp(e){let t=e.getAttribute(`uv`);if(!t)return;let n=new Float32Array(t.array.length);n.set(t.array),e.setAttribute(`uv1`,new xr(n,t.itemSize))}function Mp(e){return e.includes(`room`)||e.includes(`wall`)||e.includes(`floor`)||e.includes(`ceiling`)?`room`:(e.includes(`table`)||e.includes(`desk`))&&!e.includes(`portable`)?`table`:e.includes(`chair_back`)||e.includes(`chair`)&&e.includes(`back`)?`chairBack`:e.includes(`chair_left`)||e.includes(`chair`)&&e.includes(`left`)?`chairLeft`:e.includes(`chair_right`)||e.includes(`chair`)&&e.includes(`right`)?`chairRight`:null}function Np(e){return e.includes(`computer`)||e.includes(`pc`)||e.includes(`monitor`)||e.includes(`portable`)||e.includes(`bm86`)?`computer`:null}async function Pp(e,t={}){let n=await np.loadAsync(e);return n.flipY=t.flipY??!1,t.colorSpace&&(n.colorSpace=t.colorSpace),n}function Fp(){let e=document.createElement(`div`);e.style.width=`${jf.width}px`,e.style.height=`${jf.height}px`,e.style.backgroundColor=`#ffffff`,e.style.backfaceVisibility=`hidden`,e.style.position=`fixed`,e.style.left=`0`,e.style.top=`0`,e.style.overflow=`hidden`,e.style.pointerEvents=`none`,e.style.display=`none`,e.style.opacity=`0`,e.style.transformOrigin=`0 0`,e.style.willChange=`transform, opacity`,e.style.zIndex=`2`;let t=document.createElement(`iframe`);return t.style.position=`absolute`,t.style.left=`0`,t.style.top=`0`,t.style.width=`100%`,t.style.height=`100%`,t.style.border=`0`,t.style.backgroundColor=`#ffffff`,t.style.pointerEvents=`none`,t.allow=`autoplay`,e.appendChild(t),op=t,fp.lastSyncedVolume=null,e}function Ip(e){if(!e||Q)return;let t=Fp();Q=new On,Q.element=t,Bf.add(Q),document.body.appendChild(t),e.updateWorldMatrix(!0,!1),e.geometry.computeBoundingBox();let n=e.geometry.boundingBox,r=new H;n.getCenter(r);let i=r.applyMatrix4(e.matrixWorld);Q.position.copy(i),Q.rotation.set(jf.rotationX,jf.rotationY,jf.rotationZ,`YXZ`),Q.translateZ(jf.offsetZ),Q.translateX(jf.offsetX),Q.translateY(jf.offsetY);let a=new H;n.getSize(a);let o=[a.x,a.y,a.z].sort((e,t)=>t-e),s=o[0]/jf.width*jf.scaleMultiplier*jf.scaleX,c=o[1]/jf.height*jf.scaleMultiplier*jf.scaleY;Q.scale.set(s,c,1),Q.updateMatrixWorld(!0);let l=new H(0,0,1).applyQuaternion(Q.quaternion).normalize();Df.copy(Q.position).addScaledVector(l,X.focus.distance),Df.y+=X.focus.yOffset,Of.copy(Q.position),Of.x+=X.focus.targetOffsetX,Of.y+=X.focus.targetOffsetY,Of.z+=X.focus.targetOffsetZ,fp.fullVolumeDistance=Df.distanceTo(Q.position),fp.minimumVolumeDistance=Math.max(fp.fullVolumeDistance+1e-4,Jf.distanceTo(Q.position),X.intro.startPos.distanceTo(Q.position),X.unfocus.endPos.distanceTo(Q.position)),fp.currentGain=Rp(Z.position.distanceTo(Q.position))}function Lp(e){return Mt.clamp(e,0,1)}function Rp(e){let t=fp.fullVolumeDistance,n=Math.max(fp.minimumVolumeDistance,t+1e-4);if(!(t>0)||!(n>t)||e<=t)return 1;if(e>=n)return Kf.minVolumeRatio;let r=(e-t)/(n-t),i=r*r*(3-2*r);return Mt.lerp(1,Kf.minVolumeRatio,i)}function zp(e){return Lp(e*fp.currentGain)}function Bp(){if(!Q||!op||!Gp)return;let e=Rp(Z.position.distanceTo(Q.position));Math.abs(e-fp.currentGain)<.001||(fp.currentGain=e,Up(Gp.getState().volume))}function Vp(){!op||op.getAttribute(`src`)||(op.src=jf.url,op.addEventListener(`load`,()=>{Hp(Gp.getState().isMuted),Up(Gp.getState().volume)},{once:!0}))}function Hp(e){op?.contentWindow&&op.contentWindow.postMessage({type:wf.SET_MUTED,muted:!!e},window.location.origin)}function Up(e){if(!op?.contentWindow)return;let t=zp(e);fp.lastSyncedVolume!==null&&Math.abs(fp.lastSyncedVolume-t)<Kf.volumeSyncEpsilon||(fp.lastSyncedVolume=t,op.contentWindow.postMessage({type:wf.SET_VOLUME,volume:t},window.location.origin))}function Wp(){let e=(Array.isArray(Gf.sources)?Gf.sources:[Gf.src]).filter(Boolean),t=new Audio;t.preload=`auto`,t.loop=Gf.loop,t.volume=Gf.initialVolume,t.playsInline=!0;let n=!1,r=!0,i=0,a=null,o=0,s=null,c=0,l=null,u=null,d={hasSource:e.length>0,hasError:!1,isMuted:!1,isPlaying:!1,needsUserGesture:!1,unlockArmed:!1,volume:Gf.initialVolume,wantsToPlay:Gf.defaultWantsToPlay},f=()=>e[o]||``,p=()=>{let e=f();return e?(t.getAttribute(`src`)!==e&&(t.src=e),!0):(t.removeAttribute(`src`),!1)},m=()=>o>=e.length-1?!1:(o+=1,n=!1,p()),h=()=>{typeof l==`function`&&l({...d,currentSource:f()})},g=()=>{a!==null&&(window.clearTimeout(a),a=null)},_=()=>{i=0,g()},v=(e,n=240)=>!d.wantsToPlay||d.needsUserGesture?!1:a===null?i>=12?!1:(a=window.setTimeout(()=>{a=null,i+=1,t.readyState===0&&!d.hasError&&t.load(),k(`${e}-retry-${i}`)},n),!0):!0,y=({restoreVolume:e=!1}={})=>{c+=1,s!==null&&(window.cancelAnimationFrame(s),s=null),e&&(t.volume=Lp(d.volume))},b=e=>{if(t.paused||t.muted||r||t.volume<=.001){e();return}y();let n=c,i=t.volume,a=performance.now(),o=r=>{if(n!==c)return;let l=Math.min((r-a)/Ef,1);if(t.volume=Mt.lerp(i,0,l),l<1){s=window.requestAnimationFrame(o);return}s=null,e()};s=window.requestAnimationFrame(o)},x=(e=!1)=>{t.muted=e||d.isMuted||r,t.volume=Lp(d.volume)},S=async()=>{if(!d.hasSource||n)return!1;x(!0);try{return await t.play(),_(),n=!0,d.hasError=!1,d.isPlaying=!0,d.needsUserGesture=!1,O(),h(),!0}catch{return x(),v(`prime-muted-autoplay`),!1}},C=()=>!n||t.paused?!1:(y({restoreVolume:!0}),t.currentTime=0,x(),_(),d.hasError=!1,d.isPlaying=!0,d.needsUserGesture=!1,O(),h(),!0),w=()=>{if(!n||t.paused)return!1;t.pause();try{t.currentTime=0}catch{return!1}return d.isPlaying=!1,!0},T=(e=`timeline-sync`)=>{if(!r){d.wantsToPlay&&!d.isPlaying?k(e):(x(),h());return}if(r=!1,d.needsUserGesture=!1,d.hasError=!1,_(),O(),x(),!d.wantsToPlay){h();return}k(w()?`${e}-restart-from-zero`:e)},E=()=>{window.setTimeout(()=>{t.currentTime<.25&&(t.currentTime=0),x(),h()},80)},D=async()=>{x(!0);try{return await t.play(),_(),d.hasError=!1,d.isPlaying=!0,d.needsUserGesture=!1,O(),E(),h(),!0}catch{return x(),!1}},O=()=>{!d.unlockArmed||!u||([`pointerdown`,`keydown`,`touchstart`].forEach(e=>{window.removeEventListener(e,u,!0)}),u=null,d.unlockArmed=!1)},ee=()=>{d.unlockArmed||=(u=()=>{O(),d.wantsToPlay&&k(`user-gesture`)},[`pointerdown`,`keydown`,`touchstart`].forEach(e=>{window.addEventListener(e,u,!0)}),!0)},k=async(e=`manual`)=>{if(d.wantsToPlay=!0,y({restoreVolume:!0}),!d.hasSource)return h(),!1;if(C())return!0;d.hasError&&=(t.load(),!1),x();try{return await t.play(),_(),d.hasError=!1,d.isPlaying=!0,d.needsUserGesture=!1,O(),h(),!0}catch(n){return d.isPlaying=!t.paused,n?.name===`NotAllowedError`?await D()||(d.hasError=!1,v(`autoplay-blocked`)||(d.needsUserGesture=!0,ee())):n?.name===`AbortError`||n?.name===`NotSupportedError`?(d.hasError=!1,v(n.name===`AbortError`?`media-aborted`:`media-not-ready`)||(d.hasError=!0)):(d.hasError=!0,console.warn(`[BGM] Unable to play audio (${e}).`,n)),h(),!1}},te=()=>{d.wantsToPlay=!1,d.needsUserGesture=!1,_(),O(),b(()=>{t.pause(),y({restoreVolume:!0}),d.isPlaying=!1,h()})},A=()=>{if(d.isPlaying||d.wantsToPlay){te();return}k(`toggle`)},j=e=>{let t=()=>{d.isMuted=e,x(),Hp(d.isMuted),h()};if(e!==d.isMuted){if(e){b(t);return}y({restoreVolume:!0}),t()}};return t.addEventListener(`play`,()=>{d.isPlaying=!0,h()}),t.addEventListener(`pause`,()=>{d.isPlaying=!1,h()}),t.addEventListener(`ended`,()=>{d.isPlaying=!1,h()}),t.addEventListener(`canplay`,()=>{d.wantsToPlay&&!d.isPlaying&&!d.needsUserGesture&&v(`canplay`,0)}),t.addEventListener(`error`,()=>{let e=t.error?.code??null;if(e===1||e===null){v(`media-load-aborted`);return}if(e===4){if(m()){_(),d.hasError=!1,d.isPlaying=!1,t.load(),d.wantsToPlay&&(r?S():k(`media-source-fallback`)),h();return}if(v(`media-source-error`,320))return}d.hasError=!0,d.isPlaying=!1,console.warn(`[BGM] Audio source could not be loaded: ${f()}`),h()}),x(),d.hasSource&&p()&&(t.load(),d.wantsToPlay&&S()),{getState(){return{...d,currentSource:f()}},pause:te,play:k,releaseQueuedPlayback:T,setVolume:e=>{y(),d.volume=Lp(e),d.volume>0&&d.isMuted&&(d.isMuted=!1),x(),Up(d.volume),Hp(d.isMuted),h()},setOnChange(e){l=e,h()},toggleMute:()=>{j(!d.isMuted)},togglePlay:A}}var Gp=Wp(),Kp={soundOn:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M15.54 8.46a5 5 0 0 1 0 7.07"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14"/></svg>`,soundOff:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><line x1="23" y1="9" x2="17" y2="15"/><line x1="17" y1="9" x2="23" y2="15"/></svg>`,play:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round"><polygon points="8 5 19 12 8 19 8 5"/></svg>`,pause:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="9" y1="5" x2="9" y2="19"/><line x1="15" y1="5" x2="15" y2="19"/></svg>`,volumeLow:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M15 12a3 3 0 0 0 0-0.01"/></svg>`,volumeMid:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M15.5 9.5a4 4 0 0 1 0 5"/></svg>`,volumeHigh:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M15.5 8.5a5.5 5.5 0 0 1 0 7"/><path d="M18.8 6a9 9 0 0 1 0 12"/></svg>`,camUnfocused:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/><circle cx="12" cy="13" r="4"/></svg>`,camFocused:`<svg width="13" height="13" viewBox="0 0 24 24" fill="#ff7b00" stroke="#ff7b00" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/><circle cx="12" cy="13" r="4"/></svg>`},qp={wasd:`<svg width="46" height="30" viewBox="0 0 46 30" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`};function Jp(){mf&&(ff?mf.innerHTML=Kp.camFocused:mf.innerHTML=Kp.camUnfocused)}function Yp(e){return e>=.75?Kp.volumeHigh:e>=.4?Kp.volumeMid:Kp.volumeLow}function Xp(e){return e.isMuted?`Muted`:`${Math.round(e.volume*100)}%`}function Zp(){Cf!==null&&(window.clearTimeout(Cf),Cf=null)}function Qp(){Zp(),Sf&&(Cf=window.setTimeout(()=>{$p(!1)},Tf))}function $p(e){Sf=e,vf&&vf.classList.toggle(`is-open`,Sf),Sf?Qp():Zp()}function em(e=Gp.getState()){hf&&(hf.innerHTML=e.isMuted?Kp.soundOff:Kp.soundOn,hf.title=e.isMuted?`Unmute all audio`:`Mute all audio`),gf&&(gf.innerHTML=e.isPlaying||e.wantsToPlay?Kp.pause:Kp.play,e.hasError?gf.title=`BGM unavailable (${e.currentSource||`no source`})`:e.needsUserGesture&&!e.isPlaying?gf.title=`Click to start music`:e.wantsToPlay&&!e.isPlaying?gf.title=`Music queued to start`:gf.title=e.isPlaying?`Pause music`:`Play music`),_f&&(_f.innerHTML=Yp(e.volume),_f.title=`Adjust volume (${Math.round(e.volume*100)}%)`),yf&&(yf.value=`${Math.round(e.volume*100)}`),bf&&(bf.textContent=Xp(e))}Gp.setOnChange(em);function tm(){let e=document.createElement(`style`);e.textContent=`
    #ui-tl {
      position: fixed; top: 18px; left: 18px; z-index: 100;
      display: flex; align-items: center; gap: 10px;
      opacity: 0; transition: opacity ${Wf.fadeDuration}s ease;
      font-family: "Controller W01 Two Oblique", 'Courier New', Courier, monospace;
  ...
  `,document.head.appendChild(e);let t=document.createElement(`div`);t.id=`ui-tl`;let n=document.createElement(`span`);n.id=`ui-name`,n.textContent=`Hanqi Zhao`,gf=document.createElement(`button`),gf.className=`ui-btn`,gf.addEventListener(`click`,()=>{Gp.togglePlay()});let r=document.createElement(`div`);xf=r,r.className=`ui-volume-control`,_f=document.createElement(`button`),_f.className=`ui-btn`,_f.addEventListener(`click`,()=>{$p(!Sf)}),vf=document.createElement(`div`),vf.className=`ui-volume-panel`;let i=document.createElement(`div`);i.className=`ui-volume-title`,i.innerHTML=`<span>Volume</span>`,bf=document.createElement(`span`),bf.className=`ui-volume-value`,i.appendChild(bf),yf=document.createElement(`input`),yf.className=`ui-volume-slider`,yf.type=`range`,yf.min=`0`,yf.max=`100`,yf.step=`1`,yf.addEventListener(`input`,e=>{Gp.setVolume(Number(e.target.value)/100),Qp()}),vf.appendChild(i),vf.appendChild(yf),r.appendChild(_f),r.appendChild(vf),hf=document.createElement(`button`),hf.className=`ui-btn`,hf.addEventListener(`click`,()=>{Gp.toggleMute()}),mf=document.createElement(`button`),mf.className=`ui-btn`,mf.innerHTML=Kp.camUnfocused,mf.title=`Toggle focus`,mf.addEventListener(`click`,()=>{pf||!uf||(ff?(ff=!1,Jp(),lm(Z.position.clone(),tp.target.clone(),X.unfocus.endPos,X.unfocus.endTarget,X.unfocus.duration,X.unfocus.easing)):(ff=!0,Jp(),lm(Z.position.clone(),tp.target.clone(),Df,Of,X.focus.duration,X.focus.easing)))}),t.appendChild(n),t.appendChild(gf),t.appendChild(r),t.appendChild(hf),t.appendChild(mf),document.body.appendChild(t),document.addEventListener(`pointerdown`,e=>{if(Sf){if(xf?.contains(e.target)){Qp();return}$p(!1)}}),document.addEventListener(`pointermove`,()=>{Sf&&Qp()}),document.addEventListener(`wheel`,()=>{Sf&&Qp()},{passive:!0}),document.addEventListener(`keydown`,e=>{if(e.key===`Escape`){$p(!1);return}Sf&&Qp()}),em();let a=document.createElement(`div`);a.id=`ui-bl`,a.innerHTML=`
    <div class="ui-hint">${qp.wasd}<span>: move</span></div>
    <div class="ui-hint">${qp.space}<span>: up</span></div>
    <div class="ui-hint">${qp.ctrl}<span>: down</span></div>
  `,document.body.appendChild(a);let o=document.createElement(`div`);return o.id=`ui-br`,o.innerHTML=`<div class="ui-copy">© Copyright 2026 Hanqi Zhao.</div>`,document.body.appendChild(o),{tl:t,bl:a,br:o}}async function nm(){try{let[e,t,n,r,i]=await Promise.all([ip.loadAsync(`/textures/new_sky.hdr`),ip.loadAsync(`/textures/room.hdr`),rp.loadAsync(`/models/room_all.glb`),Promise.all(Object.entries(Op).map(async([e,t])=>[e,await Pp(t.path,{colorSpace:He})])),Promise.all(Object.entries(Dp).map(async([e,t])=>{let n=await Pp(t.path,{colorSpace:``});return n.channel=1,[e,n]}))]),a=Object.fromEntries(r),o=Object.fromEntries(i),s=new ga(200,60,40);s.scale(-1,1,1),lp=new ci(s,Ep(e)),lp.position.y=-100,lp.rotation.y=Hf.rotationY,Bf.add(lp),t.mapping=303,Bf.environment=t,Bf.environmentIntensity=1.2;let c=n.scene;if(c.traverse(e=>{if(!e.isMesh)return;let t=(e.name??``).toLowerCase();(t.includes(`computer`)||t.includes(`screen`)||t.includes(`monitor`))&&sp.push(e),t.includes(`screen_plane`)&&(ap=e,Af.setFromMatrixPosition(e.matrixWorld),Af.add(X.loader.shockwave.centerOffset),ap.material=new Xr({colorWrite:!1,depthWrite:!0}),ap.renderOrder=-1)}),Tp(c),c.traverse(e=>{if(!e.isMesh)return;let t=(e.name??``).toLowerCase();t.includes(`screen_plane`)||(Array.isArray(e.material)?e.material:[e.material]).forEach(n=>{if(!n)return;Ap(n);let r=Mp(t),i=Np(t);if(r&&a[r]){n.map=a[r],n.needsUpdate=!0;return}n.isMeshStandardMaterial&&i&&o[i]&&(jp(e.geometry),n.lightMap=o[i],kp[i]&&(n.envMapIntensity=kp[i].envMapIntensity,n.roughness<kp[i].roughnessMin&&(n.roughness=kp[i].roughnessMin)),n.needsUpdate=!0)})}),Bf.add(c),sp.length>0){let e=new Qn;sp.forEach(t=>{t.updateMatrixWorld(!0),e.union(new Qn().setFromObject(t))});let t=new H;e.getCenter(t);let n=new H;e.getSize(n),cp=new ci(new ma(n.x,n.y,n.z),new Xr({colorWrite:!1,depthWrite:!1,transparent:!0,opacity:0})),cp.position.copy(t),cp.scale.setScalar(X.focus.hitboxScale),Bf.add(cp),ap||(Af.copy(t),Af.add(X.loader.shockwave.centerOffset))}ap&&Ip(ap),await Promise.all([Lf,new Promise(e=>setTimeout(e,X.loader.minLoadTime))]),await Rf(),Ff.style.opacity=`0`,await new Promise(e=>setTimeout(e,X.loader.fadeTime*1e3)),Ff.remove(),Vp();let l=tm();{let e=performance.now(),t=!1,n=e=>e===1?1:1-2**(-10*e),r=e=>e<.5?4*e*e*e:1-(-2*e+2)**3/2;function i(){let a=(performance.now()-e)/1e3;if(!uf){let e=X.loader.cameraPush,t=0;a>=e.startTime&&(t=Math.min((a-e.startTime)/e.duration,1)),Z.position.lerpVectors(Jf,X.intro.startPos,r(t)),Z.lookAt(tp.target)}let o=X.loader.shockwave,s=0;a>=o.startTime&&(s=Math.min((a-o.startTime)/o.duration,1));let c=Mt.lerp(o.startRadius,o.endRadius,n(s));s>=1&&(c=9999),kf.forEach(e=>{e.userData.shader&&(e.userData.shader.uniforms.uShockwaveRadius.value=c)});let u=X.loader.skyFade,d=0;a>=u.startTime&&(d=Math.min((a-u.startTime)/u.duration,1)),lp&&lp.material&&(lp.material.uniforms.uSkyOpacity.value=d),!uf&&a>=X.loader.controlsUnlockTime&&(uf=!0,im.locked=!0,im.targetMouse.set(0,0),im.currentMouse.set(0,0),im.lockBaseMouse.copy(rm),sm());let f=X.loader.screenFade;a>=f.startTime&&!df&&(df=!0,up.runtimeEnabled=!1,Q&&(Q.element.style.transition=`opacity ${f.duration}s ease-in-out`,requestAnimationFrame(()=>{Q.element.style.opacity=`1`,setTimeout(()=>{Q&&(Q.element.style.transition=``,up.runtimeEnabled=!0,up.target=1,pp(1))},f.duration*1e3+100)}))),!t&&a>=Wf.appearAt&&(t=!0,l.tl.style.opacity=`1`,l.bl.style.opacity=`1`,l.br.style.opacity=`1`),a<Math.max(X.loader.cameraPush.startTime+X.loader.cameraPush.duration,o.startTime+o.duration,u.startTime+u.duration,f.startTime+f.duration,X.loader.controlsUnlockTime)&&requestAnimationFrame(i)}i()}}catch(e){console.error(e)}}var rm=new V,im={locked:!0,lockBaseMouse:new V,targetMouse:new V,currentMouse:new V,velocity:new V},am={w:!1,a:!1,s:!1,d:!1," ":!1,control:!1},om=performance.now();function sm(){om=performance.now()}window.addEventListener(`pointermove`,e=>{rm.x=e.clientX/window.innerWidth*2-1,rm.y=-(e.clientY/window.innerHeight)*2+1,uf&&(sm(),!pf&&!ff&&im.locked&&rm.distanceTo(im.lockBaseMouse)>X.parallax.unlockThreshold&&(im.locked=!1))}),window.addEventListener(`keydown`,e=>{if(!uf)return;sm();let t=e.key.toLowerCase();t===` `&&e.preventDefault(),am[t]!==void 0&&(am[t]=!0)},{passive:!1}),window.addEventListener(`keyup`,e=>{if(!uf)return;sm();let t=e.key.toLowerCase();am[t]!==void 0&&(am[t]=!1)}),window.addEventListener(`wheel`,()=>{uf&&sm()}),Yf.domElement.addEventListener(`contextmenu`,e=>e.preventDefault());var cm={linear:e=>e,easeOutCubic:e=>1-(1-e)**3,easeInOutCubic:e=>e<.5?4*e*e*e:1-(-2*e+2)**3/2};function lm(e,t,n,r,i,a,o){pf=!0;let s=performance.now(),c=cm[a]||cm.easeInOutCubic;function l(){let a=(performance.now()-s)/i;a>1&&(a=1);let u=c(a);Z.position.lerpVectors(e,n,u),tp.target.lerpVectors(t,r,u),Z.lookAt(tp.target),Z.updateProjectionMatrix(),a<1?requestAnimationFrame(l):(pf=!1,$.velocity.set(0,0,0),im.locked=!0,im.lockBaseMouse.copy(rm),im.targetMouse.set(0,0),im.currentMouse.set(0,0),im.velocity.set(0,0),sm(),o&&o())}l()}var um=new Xo,dm=0;Yf.domElement.addEventListener(`pointerdown`,e=>{!uf||pf||(sm(),dm=performance.now())}),Yf.domElement.addEventListener(`pointerup`,e=>{if(!(!uf||pf)&&performance.now()-dm<300){if(rm.x=e.clientX/window.innerWidth*2-1,rm.y=-(e.clientY/window.innerHeight)*2+1,ff){if(wp(e.clientX,e.clientY))return;ff=!1,Jp(),lm(Z.position.clone(),tp.target.clone(),X.unfocus.endPos,X.unfocus.endTarget,X.unfocus.duration,X.unfocus.easing);return}um.setFromCamera(rm,Z);let t=cp?[cp]:sp;if(um.intersectObjects(t,!0).length>0&&Q){let e=new H(0,0,1).applyQuaternion(Q.quaternion).normalize(),t=new H().subVectors(Z.position,Q.position).normalize();e.angleTo(t)*(180/Math.PI)<=X.focus.maxTriggerAngle&&(ff=!0,Jp(),lm(Z.position.clone(),tp.target.clone(),Df,Of,X.focus.duration,X.focus.easing))}}});function fm(){if(!ap||!Q)return;let e=ff&&!pf&&!!op?.src;if(!df){mp(e?`auto`:`none`);return}if(!up.runtimeEnabled){mp(e?`auto`:`none`);return}let t=new H(0,0,1).applyQuaternion(Q.quaternion).normalize(),n=new H().subVectors(Z.position,Q.position).normalize(),r=Z.position.distanceTo(Q.position),i=t.dot(n)>=0,a=0,o=`none`;if(e)a=1,o=`auto`;else if(i){let e=X.shield.maxClickDistance+X.shield.fadeDistance;if(r<=X.shield.maxClickDistance)a=1;else if(r>=e)a=X.shield.dimOpacity;else{let e=1-(r-X.shield.maxClickDistance)/X.shield.fadeDistance;a=Mt.lerp(X.shield.dimOpacity,1,e)}}up.target=a;let s=Mt.lerp(up.current,up.target,X.shield.opacityLerp);pp(Math.abs(s-up.target)<.002?up.target:s),mp(o)}var $={active:!1,chargeStart:0,releaseStart:0,dist:0,currentDir:new H,velocity:new H};function pm(){requestAnimationFrame(pm);let e=performance.now();if(lp&&(lp.rotation.y+=X.sky.rotationSpeed),!uf){Bp(),$f.render(),fm(),Cp();return}if(!ff&&!pf){let t=new H;Z.getWorldDirection(t),t.y=0,t.normalize();let n=new H().crossVectors(t,Z.up).normalize(),r=new H(0,1,0),i=new H;am.w&&i.add(t),am.s&&i.sub(t),am.a&&i.sub(n),am.d&&i.add(n),am[` `]&&i.add(r),am.control&&i.sub(r),i.lengthSq()>0?($.releaseStart=0,$.active?$.currentDir.lerp(i.normalize(),X.walk.dirLerp).normalize():($.chargeStart===0&&($.chargeStart=e),e-$.chargeStart>X.walk.chargeTime&&($.active=!0,$.dist=0,$.currentDir.copy(i.normalize())))):($.chargeStart=0,$.active&&($.releaseStart===0&&($.releaseStart=e),e-$.releaseStart>X.walk.releaseGrace&&($.active=!1))),$.active&&$.dist>=X.walk.maxDist&&($.active=!1);let a=new H;if($.active?(a.copy($.currentDir).multiplyScalar(X.walk.speed),$.velocity.lerp(a,X.walk.acceleration)):$.velocity.lerp(a,X.walk.deceleration),$.velocity.lengthSq()>1e-6){$.dist+=$.velocity.length();let e=$.velocity.clone(),t=X.walk.bounds,n=X.walk.dampingZone;e.x<0&&Z.position.x-t.minX<n?e.x*=Math.max(0,(Z.position.x-t.minX)/n):e.x>0&&t.maxX-Z.position.x<n&&(e.x*=Math.max(0,(t.maxX-Z.position.x)/n)),e.y<0&&Z.position.y-t.minY<n?e.y*=Math.max(0,(Z.position.y-t.minY)/n):e.y>0&&t.maxY-Z.position.y<n&&(e.y*=Math.max(0,(t.maxY-Z.position.y)/n)),e.z<0&&Z.position.z-t.minZ<n?e.z*=Math.max(0,(Z.position.z-t.minZ)/n):e.z>0&&t.maxZ-Z.position.z<n&&(e.z*=Math.max(0,(t.maxZ-Z.position.z)/n));let r=Z.position.clone().add(e);r.x<=t.minX?(r.x=t.minX,$.velocity.x=0):r.x>=t.maxX&&(r.x=t.maxX,$.velocity.x=0),r.y<=t.minY?(r.y=t.minY,$.velocity.y=0):r.y>=t.maxY&&(r.y=t.maxY,$.velocity.y=0),r.z<=t.minZ?(r.z=t.minZ,$.velocity.z=0):r.z>=t.maxZ&&(r.z=t.maxZ,$.velocity.z=0);let i=new H().subVectors(r,Z.position);Z.position.copy(r),tp.target.add(i)}}Z.lookAt(tp.target);let t=Z.quaternion.clone(),n=e-om>X.parallax.idleTimeout;ff||pf||n||im.locked?im.targetMouse.lerp(new V(0,0),X.parallax.catchupSpeed):im.targetMouse.lerp(rm,X.parallax.catchupSpeed);let r=new V().subVectors(im.targetMouse,im.currentMouse);im.velocity.add(r.multiplyScalar(X.parallax.springAccel)),im.velocity.multiplyScalar(1-X.parallax.springFriction),im.currentMouse.add(im.velocity);let i=im.currentMouse.y*Mt.degToRad(X.parallax.maxAngle),a=-im.currentMouse.x*Mt.degToRad(X.parallax.maxAngle);Z.rotateX(i),Z.rotateY(a),Bp(),$f.render(),fm(),Cp(),Z.quaternion.copy(t)}window.addEventListener(`resize`,()=>{Z.aspect=window.innerWidth/window.innerHeight,Z.updateProjectionMatrix(),Yf.setSize(window.innerWidth,window.innerHeight),$f.setSize(window.innerWidth,window.innerHeight),Cp()}),nm(),pm();