...
`,document.head.appendChild(Pp);var Fp=document.createElement(`div`);Fp.id=`hud-loader-root`,Fp.innerHTML=`
  ...
  <div class="hud-core">
    ...
    `,side:0,toneMapped:!1})}var Xm={computer:{path:Vf.lightMapPaths.computer}},Zm={room:{path:Vf.bakedSurfacePaths.room},table:{path:Vf.bakedSurfacePaths.table},chairBack:{path:Vf.bakedSurfacePaths.chairBack},chairLeft:{path:Vf.bakedSurfacePaths.chairLeft},chairRight:{path:Vf.bakedSurfacePaths.chairRight}},Qm={computer:{envMapIntensity:10.95,roughnessMin:.8}};function $m(e){e.map&&(e.map.colorSpace=Ue),e.emissiveMap&&(e.emissiveMap.colorSpace=Ue)}function eh(e){let t=e.getAttribute(`uv`);if(!t)return;let n=new Float32Array(t.array.length);n.set(t.array),e.setAttribute(`uv1`,new Sr(n,t.itemSize))}function th(e){return e.includes(`room`)||e.includes(`wall`)||e.includes(`floor`)||e.includes(`ceiling`)?`room`:(e.includes(`table`)||e.includes(`desk`))&&!e.includes(`portable`)?`table`:e.includes(`chair_back`)||e.includes(`chair`)&&e.includes(`back`)?`chairBack`:e.includes(`chair_left`)||e.includes(`chair`)&&e.includes(`left`)?`chairLeft`:e.includes(`chair_right`)||e.includes(`chair`)&&e.includes(`right`)?`chairRight`:null}function nh(e){return e.includes(`computer`)||e.includes(`pc`)||e.includes(`monitor`)||e.includes(`portable`)||e.includes(`bm86`)?`computer`:null}async function rh(e,t={}){let n=await pm.loadAsync(e);return n.flipY=t.flipY??!1,t.colorSpace&&(n.colorSpace=t.colorSpace),n}async function ih(e,t={}){if(e.toLowerCase().endsWith(`.ktx2`)){let n=await gm.loadAsync(e);return t.colorSpace&&(n.colorSpace=t.colorSpace),n}return rh(e,t)}function ah(){let e=document.createElement(`div`);e.style.width=`${jp.width}px`,e.style.height=`${jp.height}px`,e.style.backgroundColor=`#ffffff`,e.style.backfaceVisibility=`hidden`,e.style.position=`fixed`,e.style.left=`0`,e.style.top=`0`,e.style.overflow=`hidden`,e.style.pointerEvents=`none`,e.style.display=`none`,e.style.opacity=`0`,e.style.transformOrigin=`0 0`,e.style.willChange=`transform, opacity`,e.style.zIndex=`2`;let t=document.createElement(`iframe`);return t.style.position=`absolute`,t.style.left=`0`,t.style.top=`0`,t.style.width=`100%`,t.style.height=`100%`,t.style.border=`0`,t.style.backgroundColor=`#ffffff`,t.style.pointerEvents=`none`,t.allow=`autoplay`,e.appendChild(t),vm=t,wm.lastSyncedVolume=null,e}function oh(e){if(!e||Z)return;let t=ah();Z=new kn,Z.element=t,Bp.add(Z),document.body.appendChild(t),e.updateWorldMatrix(!0,!1),e.geometry.computeBoundingBox();let n=e.geometry.boundingBox,r=new V;n.getCenter(r);let i=r.applyMatrix4(e.matrixWorld);Z.position.copy(i),Z.rotation.set(jp.rotationX,jp.rotationY,jp.rotationZ,`YXZ`),Z.translateZ(jp.offsetZ),Z.translateX(jp.offsetX),Z.translateY(jp.offsetY);let a=new V;n.getSize(a);let o=[a.x,a.y,a.z].sort((e,t)=>t-e),s=o[0]/jp.width*jp.scaleMultiplier*jp.scaleX,c=o[1]/jp.height*jp.scaleMultiplier*jp.scaleY;Z.scale.set(s,c,1),Z.updateMatrixWorld(!0);let l=new V(0,0,1).applyQuaternion(Z.quaternion).normalize();xp.copy(Z.position).addScaledVector(l,Y.focus.distance),xp.y+=Y.focus.yOffset,Sp.copy(Z.position),Sp.x+=Y.focus.targetOffsetX,Sp.y+=Y.focus.targetOffsetY,Sp.z+=Y.focus.targetOffsetZ,wm.fullVolumeDistance=xp.distanceTo(Z.position),wm.minimumVolumeDistance=Math.max(wm.fullVolumeDistance+1e-4,Jp.distanceTo(Z.position),Y.intro.startPos.distanceTo(Z.position),Y.unfocus.endPos.distanceTo(Z.position)),wm.currentGain=ch(X.position.distanceTo(Z.position)),Mm()}function sh(e){return Nt.clamp(e,0,1)}function ch(e){let t=wm.fullVolumeDistance,n=Math.max(wm.minimumVolumeDistance,t+1e-4);if(!(t>0)||!(n>t)||e<=t)return 1;if(e>=n)return Kp.minVolumeRatio;let r=(e-t)/(n-t),i=r*r*(3-2*r);return Nt.lerp(1,Kp.minVolumeRatio,i)}function lh(e){return sh(e*wm.currentGain)}function uh(){if(!Z||!vm||!hh)return;let e=ch(X.position.distanceTo(Z.position));Math.abs(e-wm.currentGain)<.001||(wm.currentGain=e,ph(hh.getState().volume))}function dh(){!vm||vm.getAttribute(`src`)||(vm.src=jp.url,Mm(),vm.addEventListener(`load`,()=>{fh(hh.getState().isMuted),ph(hh.getState().volume),Mm()},{once:!0}))}function fh(e){vm?.contentWindow&&vm.contentWindow.postMessage({type:dp.SET_MUTED,muted:!!e},window.location.origin)}function ph(e){if(!vm?.contentWindow)return;let t=lh(e);wm.lastSyncedVolume!==null&&Math.abs(wm.lastSyncedVolume-t)<Kp.volumeSyncEpsilon||(wm.lastSyncedVolume=t,vm.contentWindow.postMessage({type:dp.SET_VOLUME,volume:t},window.location.origin))}function mh(){let e=(Array.isArray(Gp.sources)?Gp.sources:[Gp.src]).filter(Boolean),t=new Audio;t.preload=`auto`,t.loop=Gp.loop,t.volume=Gp.initialVolume,t.playsInline=!0;let n=!1,r=!0,i=0,a=null,o=0,s=null,c=0,l=null,u=null,d={hasSource:e.length>0,hasError:!1,isMuted:!1,isPlaying:!1,needsUserGesture:!1,unlockArmed:!1,volume:Gp.initialVolume,wantsToPlay:Gp.defaultWantsToPlay},f=()=>e[o]||``,p=()=>{let e=f();return e?(t.getAttribute(`src`)!==e&&(t.src=e),!0):(t.removeAttribute(`src`),!1)},m=()=>o>=e.length-1?!1:(o+=1,n=!1,p()),h=()=>{typeof l==`function`&&l({...d,currentSource:f()})},g=()=>{a!==null&&(window.clearTimeout(a),a=null)},_=()=>{i=0,g()},v=(e,n=240)=>!d.wantsToPlay||d.needsUserGesture?!1:a===null?i>=12?!1:(a=window.setTimeout(()=>{a=null,i+=1,t.readyState===0&&!d.hasError&&t.load(),k(`${e}-retry-${i}`)},n),!0):!0,y=({restoreVolume:e=!1}={})=>{c+=1,s!==null&&(window.cancelAnimationFrame(s),s=null),e&&(t.volume=sh(d.volume))},b=e=>{if(t.paused||t.muted||r||t.volume<=.001){e();return}y();let n=c,i=t.volume,a=performance.now(),o=r=>{if(n!==c)return;let l=Math.min((r-a)/mp,1);if(t.volume=Nt.lerp(i,0,l),l<1){s=window.requestAnimationFrame(o);return}s=null,e()};s=window.requestAnimationFrame(o)},x=(e=!1)=>{t.muted=e||d.isMuted||r,t.volume=sh(d.volume)},S=async()=>{if(!d.hasSource||n)return!1;x(!0);try{return await t.play(),_(),n=!0,d.hasError=!1,d.isPlaying=!0,d.needsUserGesture=!1,O(),h(),!0}catch{return x(),v(`prime-muted-autoplay`),!1}},C=()=>!n||t.paused?!1:(y({restoreVolume:!0}),t.currentTime=0,x(),_(),d.hasError=!1,d.isPlaying=!0,d.needsUserGesture=!1,O(),h(),!0),w=()=>{if(!n||t.paused)return!1;t.pause();try{t.currentTime=0}catch{return!1}return d.isPlaying=!1,!0},T=(e=`timeline-sync`)=>{if(!r){d.wantsToPlay&&!d.isPlaying?k(e):(x(),h());return}if(r=!1,d.needsUserGesture=!1,d.hasError=!1,_(),O(),x(),!d.wantsToPlay){h();return}k(w()?`${e}-restart-from-zero`:e)},E=()=>{window.setTimeout(()=>{t.currentTime<.25&&(t.currentTime=0),x(),h()},80)},D=async()=>{x(!0);try{return await t.play(),_(),d.hasError=!1,d.isPlaying=!0,d.needsUserGesture=!1,O(),E(),h(),!0}catch{return x(),!1}},O=()=>{!d.unlockArmed||!u||([`pointerdown`,`keydown`,`touchstart`].forEach(e=>{window.removeEventListener(e,u,!0)}),u=null,d.unlockArmed=!1)},ee=()=>{d.unlockArmed||=(u=()=>{O(),d.wantsToPlay&&k(`user-gesture`)},[`pointerdown`,`keydown`,`touchstart`].forEach(e=>{window.addEventListener(e,u,!0)}),!0)},k=async(e=`manual`)=>{if(d.wantsToPlay=!0,y({restoreVolume:!0}),!d.hasSource)return h(),!1;if(C())return!0;d.hasError&&=(t.load(),!1),x();try{return await t.play(),_(),d.hasError=!1,d.isPlaying=!0,d.needsUserGesture=!1,O(),h(),!0}catch(n){return d.isPlaying=!t.paused,n?.name===`NotAllowedError`?await D()||(d.hasError=!1,v(`autoplay-blocked`)||(d.needsUserGesture=!0,ee())):n?.name===`AbortError`||n?.name===`NotSupportedError`?(d.hasError=!1,v(n.name===`AbortError`?`media-aborted`:`media-not-ready`)||(d.hasError=!0)):(d.hasError=!0,console.warn(`[BGM] Unable to play audio (${e}).`,n)),h(),!1}},te=()=>{d.wantsToPlay=!1,d.needsUserGesture=!1,_(),O(),b(()=>{t.pause(),y({restoreVolume:!0}),d.isPlaying=!1,h()})},A=()=>{if(d.isPlaying||d.wantsToPlay){te();return}k(`toggle`)},j=e=>{let t=()=>{d.isMuted=e,x(),fh(d.isMuted),h()};if(e!==d.isMuted){if(e){b(t);return}y({restoreVolume:!0}),t()}};return t.addEventListener(`play`,()=>{d.isPlaying=!0,h()}),t.addEventListener(`pause`,()=>{d.isPlaying=!1,h()}),t.addEventListener(`ended`,()=>{d.isPlaying=!1,h()}),t.addEventListener(`canplay`,()=>{d.wantsToPlay&&!d.isPlaying&&!d.needsUserGesture&&v(`canplay`,0)}),t.addEventListener(`error`,()=>{let e=t.error?.code??null;if(e===1||e===null){v(`media-load-aborted`);return}if(e===4){if(m()){_(),d.hasError=!1,d.isPlaying=!1,t.load(),d.wantsToPlay&&(r?S():k(`media-source-fallback`)),h();return}if(v(`media-source-error`,320))return}d.hasError=!0,d.isPlaying=!1,console.warn(`[BGM] Audio source could not be loaded: ${f()}`),h()}),x(),d.hasSource&&p()&&(t.load(),d.wantsToPlay&&S()),{getState(){return{...d,currentSource:f()}},pause:te,play:k,releaseQueuedPlayback:T,setVolume:e=>{y(),d.volume=sh(e),d.volume>0&&d.isMuted&&(d.isMuted=!1),x(),ph(d.volume),fh(d.isMuted),h()},setOnChange(e){l=e,h()},toggleMute:()=>{j(!d.isMuted)},togglePlay:A}}var hh=mh(),gh={soundOn:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M15.54 8.46a5 5 0 0 1 0 7.07"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14"/></svg>`,soundOff:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><line x1="23" y1="9" x2="17" y2="15"/><line x1="17" y1="9" x2="23" y2="15"/></svg>`,play:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round"><polygon points="8 5 19 12 8 19 8 5"/></svg>`,pause:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="9" y1="5" x2="9" y2="19"/><line x1="15" y1="5" x2="15" y2="19"/></svg>`,volumeLow:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M15 12a3 3 0 0 0 0-0.01"/></svg>`,volumeMid:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M15.5 9.5a4 4 0 0 1 0 5"/></svg>`,volumeHigh:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M15.5 8.5a5.5 5.5 0 0 1 0 7"/><path d="M18.8 6a9 9 0 0 1 0 12"/></svg>`,camUnfocused:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/><circle cx="12" cy="13" r="4"/></svg>`,camFocused:`<svg width="13" height="13" viewBox="0 0 24 24" fill="#ff7b00" stroke="#ff7b00" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/><circle cx="12" cy="13" r="4"/></svg>`,fx:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 7h8"/><path d="M4 17h14"/><path d="M14 7h6"/><path d="M10 17h4"/><circle cx="12" cy="7" r="2"/><circle cx="8" cy="17" r="2"/></svg>`},_h={wasd:`<svg width="46" height="30" viewBox="0 0 46 30" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`};function vh(){qf&&(Gf?qf.innerHTML=gh.camFocused:qf.innerHTML=gh.camUnfocused)}function yh(e){return e>=.75?gh.volumeHigh:e>=.4?gh.volumeMid:gh.volumeLow}function bh(e){return e.isMuted?`Muted`:`${Math.round(e.volume*100)}%`}function xh(){cp!==null&&(window.clearTimeout(cp),cp=null)}function Sh(){xh(),sp&&(cp=window.setTimeout(()=>{Ch(!1)},pp))}function Ch(e){e&&lp&&Dh(!1),sp=e,Zf&&Zf.classList.toggle(`is-open`,sp),sp?Sh():xh()}function wh(){return`Bloom ${kp.bloomEnabled?`On`:`Off`} | MSAA ${Dp(kp.msaaSamples)}`}function Th(e,t,n,r=`On`,i=`Off`){e&&(e.classList.toggle(`is-active`,n),e.innerHTML=`<span>${t}</span><strong>${n?r:i}</strong>`)}function Eh(){if(tp&&(tp.classList.toggle(`is-active`,lp),tp.title=wh()),np&&np.classList.toggle(`is-open`,lp),Th(ip,`Bloom`,kp.bloomEnabled),Th(ap,`MSAA`,Ep(kp.msaaSamples,0)>0,Dp(kp.msaaSamples)),ap&&(ap.title=`Cycle MSAA: 4x, 2x, Off`),rp){let e=Xp(),t=Math.max(1,Math.floor(window.innerWidth*e)),n=Math.max(1,Math.floor(window.innerHeight*e)),r=Tp.avgRenderMs>0?Tp.avgRenderMs.toFixed(1):`0.0`,i=performance.now()-Tp.lastFrameNow>500?0:Math.round(Tp.fps);rp.textContent=`Avg ${r} ms | FPS ${i} | ${t}x${n}`}}function Dh(e){e&&sp&&Ch(!1),lp=e,Eh(),Am()}function Oh(e){kp.bloomEnabled=!!e.bloomEnabled,kp.msaaSamples=Ep(e.msaaSamples,kp.msaaSamples),Ap(),im(),Eh(),Am()}function kh(e){if(e===`msaaSamples`){let e=Ep(kp.msaaSamples,0),t=bp.indexOf(e),n=bp[t===-1?0:(t+1)%bp.length];Oh({...kp,msaaSamples:n});return}Oh({...kp,[e]:!kp[e]})}function Ah(e,t=performance.now()){if(Tp.lastRenderMs=e,Tp.avgRenderMs=Tp.avgRenderMs===0?e:Nt.lerp(Tp.avgRenderMs,e,.18),Tp.lastFrameNow>0){let e=t-Tp.lastFrameNow;e>0&&e<250&&(Tp.avgFrameMs=Tp.avgFrameMs===0?e:Nt.lerp(Tp.avgFrameMs,e,.2),Tp.fps=Tp.avgFrameMs>0?1e3/Tp.avgFrameMs:0)}Tp.lastFrameNow=t,!(t-Tp.lastUiUpdate<250)&&(Tp.lastUiUpdate=t,Eh())}function jh(e=hh.getState()){Jf&&(Jf.innerHTML=e.isMuted?gh.soundOff:gh.soundOn,Jf.title=e.isMuted?`Unmute all audio`:`Mute all audio`),Yf&&(Yf.innerHTML=e.isPlaying||e.wantsToPlay?gh.pause:gh.play,e.hasError?Yf.title=`BGM unavailable (${e.currentSource||`no source`})`:e.needsUserGesture&&!e.isPlaying?Yf.title=`Click to start music`:e.wantsToPlay&&!e.isPlaying?Yf.title=`Music queued to start`:Yf.title=e.isPlaying?`Pause music`:`Play music`),Xf&&(Xf.innerHTML=yh(e.volume),Xf.title=`Adjust volume (${Math.round(e.volume*100)}%)`),Qf&&(Qf.value=`${Math.round(e.volume*100)}`),$f&&($f.textContent=bh(e))}hh.setOnChange(jh);function Mh(){let e=document.createElement(`style`);e.textContent=`
    #ui-tl {
  ...
  `,document.head.appendChild(e);let t=document.createElement(`div`);t.id=`ui-tl`;let n=document.createElement(`span`);n.id=`ui-name`,n.textContent=`Hanqi Zhao`,Yf=document.createElement(`button`),Yf.className=`ui-btn`,Yf.addEventListener(`click`,()=>{hh.togglePlay()});let r=document.createElement(`div`);ep=r,r.className=`ui-volume-control`,Xf=document.createElement(`button`),Xf.className=`ui-btn`,Xf.addEventListener(`click`,()=>{Ch(!sp)}),Zf=document.createElement(`div`),Zf.className=`ui-volume-panel`;let i=document.createElement(`div`);i.className=`ui-volume-title`,i.innerHTML=`<span>Volume</span>`,$f=document.createElement(`span`),$f.className=`ui-volume-value`,i.appendChild($f),Qf=document.createElement(`input`),Qf.className=`ui-volume-slider`,Qf.type=`range`,Qf.min=`0`,Qf.max=`100`,Qf.step=`1`,Qf.addEventListener(`input`,e=>{hh.setVolume(Number(e.target.value)/100),Sh()}),Zf.appendChild(i),Zf.appendChild(Qf),r.appendChild(Xf),r.appendChild(Zf);let a=document.createElement(`div`);op=a,a.className=`ui-postfx-control`,tp=document.createElement(`button`),tp.className=`ui-btn`,tp.innerHTML=gh.fx,tp.addEventListener(`click`,()=>{Dh(!lp)}),np=document.createElement(`div`),np.className=`ui-postfx-panel`;let o=document.createElement(`div`);o.className=`ui-postfx-header`,o.innerHTML=`<span>Render FX</span>`;let s=document.createElement(`span`);s.className=`ui-postfx-summary`,s.textContent=Vf.label,o.appendChild(s);let c=document.createElement(`div`);c.className=`ui-postfx-toggles`,ip=document.createElement(`button`),ip.className=`ui-postfx-toggle`,ip.type=`button`,ip.addEventListener(`click`,()=>{kh(`bloomEnabled`)}),ap=document.createElement(`button`),ap.className=`ui-postfx-toggle`,ap.type=`button`,ap.addEventListener(`click`,()=>{kh(`msaaSamples`)}),c.appendChild(ip),c.appendChild(ap),rp=document.createElement(`div`),rp.className=`ui-postfx-stats`,np.appendChild(o),np.appendChild(c),np.appendChild(rp),a.appendChild(tp),a.appendChild(np),Jf=document.createElement(`button`),Jf.className=`ui-btn`,Jf.addEventListener(`click`,()=>{hh.toggleMute()}),qf=document.createElement(`button`),qf.className=`ui-btn`,qf.innerHTML=gh.camUnfocused,qf.title=`Toggle focus`,qf.addEventListener(`click`,()=>{Kf||!Uf||(Gf?(Gf=!1,vh(),zh(X.position.clone(),fm.target.clone(),Y.unfocus.endPos,Y.unfocus.endTarget,Y.unfocus.duration,Y.unfocus.easing)):(Gf=!0,vh(),zh(X.position.clone(),fm.target.clone(),xp,Sp,Y.focus.duration,Y.focus.easing)))}),t.appendChild(n),t.appendChild(Yf),t.appendChild(r),t.appendChild(Jf),t.appendChild(a),t.appendChild(qf),document.body.appendChild(t),document.addEventListener(`pointerdown`,e=>{let t=ep?.contains(e.target),n=op?.contains(e.target);sp&&t?Sh():sp&&Ch(!1),lp&&!n&&Dh(!1)}),document.addEventListener(`pointermove`,()=>{sp&&Sh()}),document.addEventListener(`wheel`,()=>{sp&&Sh()},{passive:!0}),document.addEventListener(`keydown`,e=>{if(e.key===`Escape`){Ch(!1),Dh(!1);return}sp&&Sh()}),jh(),Eh();let l=document.createElement(`div`);l.id=`ui-bl`,l.innerHTML=`
    <div class="ui-hint">${_h.wasd}<span>: move</span></div>
    <div class="ui-hint">${_h.space}<span>: up</span></div>
    <div class="ui-hint">${_h.ctrl}<span>: down</span></div>
  `,document.body.appendChild(l);let u=document.createElement(`div`);return u.id=`ui-br`,u.innerHTML=`<div class="ui-copy">© Copyright 2026 Hanqi Zhao.</div>`,document.body.appendChild(u),{tl:t,bl:l,br:u}}async function Nh(){try{let[e,t,n,r,i]=await Promise.all([Vf.visualSky.kind===`hdr`?hm.loadAsync(Vf.visualSky.path):rh(Vf.visualSky.path,{colorSpace:Ue}),hm.loadAsync(Vf.lightingHdrPath),mm.loadAsync(`/models/room_all.glb`),Promise.all(Object.entries(Zm).map(async([e,t])=>[e,await ih(t.path,{colorSpace:Ue})])),Promise.all(Object.entries(Xm).map(async([e,t])=>{let n=await ih(t.path,{colorSpace:``});return n.channel=1,[e,n]}))]),a=Object.fromEntries(r),o=Object.fromEntries(i),s=new ba(200,32,20);s.scale(-1,1,1),xm=new li(s,Ym(e,Vf.visualSky)),xm.position.y=-100,xm.rotation.y=Hp.rotationY,Bp.add(xm),t.mapping=303,Bp.environment=t,Bp.environmentIntensity=1.2;let c=n.scene;if(c.traverse(e=>{if(!e.isMesh)return;let t=(e.name??``).toLowerCase();(t.includes(`computer`)||t.includes(`screen`)||t.includes(`monitor`))&&ym.push(e),t.includes(`screen_plane`)&&(_m=e,wp.setFromMatrixPosition(e.matrixWorld),wp.add(Y.loader.shockwave.centerOffset),_m.material=new Zr({colorWrite:!1,depthWrite:!0}),_m.renderOrder=-1)}),Jm(c),c.traverse(e=>{if(!e.isMesh)return;let t=(e.name??``).toLowerCase();t.includes(`screen_plane`)||(Array.isArray(e.material)?e.material:[e.material]).forEach(n=>{if(!n)return;$m(n);let r=th(t),i=nh(t);if(r&&a[r]){n.map=a[r],n.needsUpdate=!0;return}n.isMeshStandardMaterial&&i&&o[i]&&(eh(e.geometry),n.lightMap=o[i],Qm[i]&&(n.envMapIntensity=Qm[i].envMapIntensity,n.roughness<Qm[i].roughnessMin&&(n.roughness=Qm[i].roughnessMin)),n.needsUpdate=!0)})}),Bp.add(c),ym.length>0){let e=new $n;ym.forEach(t=>{t.updateMatrixWorld(!0),e.union(new $n().setFromObject(t))});let t=new V;e.getCenter(t);let n=new V;e.getSize(n),bm=new li(new va(n.x,n.y,n.z),new Zr({colorWrite:!1,depthWrite:!1,transparent:!0,opacity:0})),bm.position.copy(t),bm.scale.setScalar(Y.focus.hitboxScale),Bp.add(bm),_m||(wp.copy(t),wp.add(Y.loader.shockwave.centerOffset))}_m&&oh(_m),await Promise.all([Lp,new Promise(e=>setTimeout(e,Y.loader.minLoadTime))]),await Rp(),Fp.style.opacity=`0`,await new Promise(e=>setTimeout(e,Y.loader.fadeTime*1e3)),Fp.remove(),dh();let l=Mh();{let e=performance.now(),t=!1,n=e=>e===1?1:1-2**(-10*e),r=e=>e<.5?4*e*e*e:1-(-2*e+2)**3/2;function i(){let a=(performance.now()-e)/1e3;if(!Uf){let e=Y.loader.cameraPush,t=0;a>=e.startTime&&(t=Math.min((a-e.startTime)/e.duration,1)),X.position.lerpVectors(Jp,Y.intro.startPos,r(t)),X.lookAt(fm.target)}let o=Y.loader.shockwave,s=0;a>=o.startTime&&(s=Math.min((a-o.startTime)/o.duration,1));let c=Nt.lerp(o.startRadius,o.endRadius,n(s));s>=1&&(c=9999),Cp.forEach(e=>{e.userData.shader&&(e.userData.shader.uniforms.uShockwaveRadius.value=c)});let u=Y.loader.skyFade,d=0;a>=u.startTime&&(d=Math.min((a-u.startTime)/u.duration,1)),xm&&xm.material&&(xm.material.uniforms.uSkyOpacity.value=d),!Uf&&a>=Y.loader.controlsUnlockTime&&(Uf=!0,Q.locked=!0,Q.targetMouse.set(0,0),Q.currentMouse.set(0,0),Q.lockBaseMouse.copy(Ph),Lh());let f=Y.loader.screenFade;a>=f.startTime&&!Wf&&(Wf=!0,Sm.runtimeEnabled=!1,Z&&(Z.element.style.transition=`opacity ${f.duration}s ease-in-out`,requestAnimationFrame(()=>{Z.element.style.opacity=`1`,setTimeout(()=>{Z&&(Z.element.style.transition=``,Sm.runtimeEnabled=!0,Sm.target=1,Im(1))},f.duration*1e3+100)}))),!t&&a>=Wp.appearAt&&(t=!0,l.tl.style.opacity=`1`,l.bl.style.opacity=`1`,l.br.style.opacity=`1`),a<Math.max(Y.loader.cameraPush.startTime+Y.loader.cameraPush.duration,o.startTime+o.duration,u.startTime+u.duration,f.startTime+f.duration,Y.loader.controlsUnlockTime)?requestAnimationFrame(i):Hf=!1}i()}}catch(e){console.error(e)}}var Ph=new B,Q={locked:!0,lockBaseMouse:new B,targetMouse:new B,currentMouse:new B,velocity:new B},Fh={w:!1,a:!1,s:!1,d:!1," ":!1,control:!1},Ih=performance.now();function Lh(){Ih=performance.now()}window.addEventListener(`pointermove`,e=>{Ph.x=e.clientX/window.innerWidth*2-1,Ph.y=-(e.clientY/window.innerHeight)*2+1,Uf&&(Lh(),!Kf&&!Gf&&Q.locked&&Ph.distanceTo(Q.lockBaseMouse)>Y.parallax.unlockThreshold&&(Q.locked=!1),Am())}),window.addEventListener(`keydown`,e=>{if(!Uf)return;Lh();let t=e.key.toLowerCase();t===` `&&e.preventDefault(),Fh[t]!==void 0&&(Fh[t]=!0),Am()},{passive:!1}),window.addEventListener(`keyup`,e=>{if(!Uf)return;Lh();let t=e.key.toLowerCase();Fh[t]!==void 0&&(Fh[t]=!1),Am()}),window.addEventListener(`wheel`,()=>{Uf&&(Lh(),Am())}),Yp.domElement.addEventListener(`contextmenu`,e=>e.preventDefault());var Rh={linear:e=>e,easeOutCubic:e=>1-(1-e)**3,easeInOutCubic:e=>e<.5?4*e*e*e:1-(-2*e+2)**3/2};function zh(e,t,n,r,i,a,o){Kf=!0;let s=performance.now(),c=Rh[a]||Rh.easeInOutCubic;Am();function l(){let a=(performance.now()-s)/i;a>1&&(a=1);let u=c(a);X.position.lerpVectors(e,n,u),fm.target.lerpVectors(t,r,u),X.lookAt(fm.target),X.updateProjectionMatrix(),Am(),a<1?requestAnimationFrame(l):(Kf=!1,$.velocity.set(0,0,0),Q.locked=!0,Q.lockBaseMouse.copy(Ph),Q.targetMouse.set(0,0),Q.currentMouse.set(0,0),Q.velocity.set(0,0),Lh(),o&&o(),Am())}l()}var Bh=new es,Vh=0;Yp.domElement.addEventListener(`pointerdown`,e=>{!Uf||Kf||(Lh(),Vh=performance.now(),Am())}),Yp.domElement.addEventListener(`pointerup`,e=>{if(!(!Uf||Kf)){if(performance.now()-Vh<300){if(Ph.x=e.clientX/window.innerWidth*2-1,Ph.y=-(e.clientY/window.innerHeight)*2+1,Gf){if(qm(e.clientX,e.clientY))return;Gf=!1,vh(),zh(X.position.clone(),fm.target.clone(),Y.unfocus.endPos,Y.unfocus.endTarget,Y.unfocus.duration,Y.unfocus.easing);return}Bh.setFromCamera(Ph,X);let t=bm?[bm]:ym;if(Bh.intersectObjects(t,!0).length>0&&Z){let e=new V(0,0,1).applyQuaternion(Z.quaternion).normalize(),t=new V().subVectors(X.position,Z.position).normalize();e.angleTo(t)*(180/Math.PI)<=Y.focus.maxTriggerAngle&&(Gf=!0,vh(),zh(X.position.clone(),fm.target.clone(),xp,Sp,Y.focus.duration,Y.focus.easing))}}Am()}});function Hh(){if(!_m||!Z)return;let e=Gf&&!Kf&&!!vm?.src;if(!Wf){Lm(e?`auto`:`none`);return}if(!Sm.runtimeEnabled){Lm(e?`auto`:`none`);return}let t=new V(0,0,1).applyQuaternion(Z.quaternion).normalize(),n=new V().subVectors(X.position,Z.position).normalize(),r=X.position.distanceTo(Z.position),i=t.dot(n)>=0,a=0,o=`none`;if(e)a=1,o=`auto`;else if(i){let e=Y.shield.maxClickDistance+Y.shield.fadeDistance;if(r<=Y.shield.maxClickDistance)a=1;else if(r>=e)a=Y.shield.dimOpacity;else{let e=1-(r-Y.shield.maxClickDistance)/Y.shield.fadeDistance;a=Nt.lerp(Y.shield.dimOpacity,1,e)}}Sm.target=a;let s=Nt.lerp(Sm.current,Sm.target,Y.shield.opacityLerp);Im(Math.abs(s-Sm.target)<.002?Sm.target:s),Lm(o)}var $={active:!1,chargeStart:0,releaseStart:0,dist:0,currentDir:new V,velocity:new V};function Uh(e){Tm.frameId=null;let t=Em(),n=Tm.renderRequested,r=Nm(e)||t,i=e-Ih>Y.parallax.idleTimeout;if(!r&&!Tm.renderRequested)return;if(xm&&t&&(xm.rotation.y+=Y.sky.rotationSpeed),!Uf){Fm(e,{skyOnly:!1,sceneAnimationActive:!0}),Tm.renderRequested=!1,r&&Am();return}if(!Gf&&!Kf){let t=new V;X.getWorldDirection(t),t.y=0,t.normalize();let n=new V().crossVectors(t,X.up).normalize(),r=new V(0,1,0),a=new V;Fh.w&&a.add(t),Fh.s&&a.sub(t),Fh.a&&a.sub(n),Fh.d&&a.add(n),Fh[` `]&&a.add(r),Fh.control&&a.sub(r),a.lengthSq()>0?($.releaseStart=0,$.active?$.currentDir.lerp(a.normalize(),Y.walk.dirLerp).normalize():($.chargeStart===0&&($.chargeStart=e),e-$.chargeStart>Y.walk.chargeTime&&($.active=!0,$.dist=0,$.currentDir.copy(a.normalize())))):($.chargeStart=0,$.active&&($.releaseStart===0&&($.releaseStart=e),e-$.releaseStart>Y.walk.releaseGrace&&($.active=!1)),i&&($.active=!1,$.releaseStart=0,$.currentDir.set(0,0,0),$.velocity.set(0,0,0))),$.active&&$.dist>=Y.walk.maxDist&&($.active=!1);let o=new V;if($.active?(o.copy($.currentDir).multiplyScalar(Y.walk.speed),$.velocity.lerp(o,Y.walk.acceleration)):($.velocity.lerp(o,Y.walk.deceleration),Om($.velocity)&&$.velocity.set(0,0,0)),$.velocity.lengthSq()>1e-6){$.dist+=$.velocity.length();let e=$.velocity.clone(),t=Y.walk.bounds,n=Y.walk.dampingZone;e.x<0&&X.position.x-t.minX<n?e.x*=Math.max(0,(X.position.x-t.minX)/n):e.x>0&&t.maxX-X.position.x<n&&(e.x*=Math.max(0,(t.maxX-X.position.x)/n)),e.y<0&&X.position.y-t.minY<n?e.y*=Math.max(0,(X.position.y-t.minY)/n):e.y>0&&t.maxY-X.position.y<n&&(e.y*=Math.max(0,(t.maxY-X.position.y)/n)),e.z<0&&X.position.z-t.minZ<n?e.z*=Math.max(0,(X.position.z-t.minZ)/n):e.z>0&&t.maxZ-X.position.z<n&&(e.z*=Math.max(0,(t.maxZ-X.position.z)/n));let r=X.position.clone().add(e);r.x<=t.minX?(r.x=t.minX,$.velocity.x=0):r.x>=t.maxX&&(r.x=t.maxX,$.velocity.x=0),r.y<=t.minY?(r.y=t.minY,$.velocity.y=0):r.y>=t.maxY&&(r.y=t.maxY,$.velocity.y=0),r.z<=t.minZ?(r.z=t.minZ,$.velocity.z=0):r.z>=t.maxZ&&(r.z=t.maxZ,$.velocity.z=0);let i=new V().subVectors(r,X.position);X.position.copy(r),fm.target.add(i)}}X.lookAt(fm.target);let a=X.quaternion.clone();Gf||Kf||i||Q.locked?Q.targetMouse.lerp(new B(0,0),Y.parallax.catchupSpeed):Q.targetMouse.lerp(Ph,Y.parallax.catchupSpeed);let o=new B().subVectors(Q.targetMouse,Q.currentMouse);Q.velocity.add(o.multiplyScalar(Y.parallax.springAccel)),Q.velocity.multiplyScalar(1-Y.parallax.springFriction),Q.currentMouse.add(Q.velocity),i&&(Dm(Q.targetMouse)&&Q.targetMouse.set(0,0),Dm(Q.velocity)&&Q.velocity.set(0,0),Dm(Q.currentMouse)&&Dm(Q.targetMouse)&&Dm(Q.velocity)&&Q.currentMouse.set(0,0));let s=Q.currentMouse.y*Nt.degToRad(Y.parallax.maxAngle),c=-Q.currentMouse.x*Nt.degToRad(Y.parallax.maxAngle);X.rotateX(s),X.rotateY(c);let l=Nm(e);Fm(e,{skyOnly:t&&!l&&!n,sceneAnimationActive:l}),X.quaternion.copy(a),Tm.renderRequested=!1,l?Am():t&&jm()}window.addEventListener(`resize`,()=>{X.aspect=window.innerWidth/window.innerHeight,X.updateProjectionMatrix(),im(),Eh(),Mm()}),Nh(),Am();