...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function As(e,t,n){let r=new Float32Array(gs),i=new H(0,1,0);return new wa({name:`SphericalGaussianBlur`,defines:{n:gs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ns(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function js(){return new wa({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ns(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ms(){return new wa({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ns(),fragmentShader:`
	...
	`}var Ps=class extends Qt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new ua([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;continue}if((u=l.match(i))&&(c.gamma=parseFloat(u[1])),(u=l.match(a))&&(c.exposure=parseFloat(u[1])),(u=l.match(o))&&(c.valid|=2,c.format=u[1]),(u=l.match(s))&&(c.valid|=4,c.height=parseInt(u[1],10),c.width=parseInt(u[2],10)),c.valid&2&&c.valid&4)break}return c.valid&2||t(3,`missing format specifier`),c.valid&4||t(3,`missing image size specifier`),c},i=function(e,n,r){let i=n;if(i<8||i>32767||e[0]!==2||e[1]!==2||e[2]&128)return new Uint8Array(e);i!==(e[2]<<8|e[3])&&t(3,`wrong scanline width`);let a=new Uint8Array(4*n*r);a.length||t(4,`unable to allocate buffer space`);let o=0,s=0,c=4*i,l=new Uint8Array(4),u=new Uint8Array(c),d=r;for(;d>0&&s<e.byteLength;){s+4>e.byteLength&&t(1),l[0]=e[s++],l[1]=e[s++],l[2]=e[s++],l[3]=e[s++],(l[0]!=2||l[1]!=2||(l[2]<<8|l[3])!=i)&&t(3,`bad rgbe scanline format`);let n=0,r;for(;n<c&&s<e.byteLength;){r=e[s++];let i=r>128;if(i&&(r-=128),(r===0||n+r>c)&&t(3,`bad scanline data`),i){let t=e[s++];for(let e=0;e<r;e++)u[n++]=t}else u.set(e.subarray(s,s+r),n),n+=r,s+=r}let f=i;for(let e=0;e<f;e++){let t=0;a[o]=u[e+t],t+=i,a[o+1]=u[e+t],t+=i,a[o+2]=u[e+t],t+=i,a[o+3]=u[e+t],o+=4}d--}return a},a=function(e,t,n,r){let i=2**(e[t+3]-128)/255;n[r+0]=e[t+0]*i,n[r+1]=e[t+1]*i,n[r+2]=e[t+2]*i,n[r+3]=1},o=function(e,t,n,r){let i=2**(e[t+3]-128)/255;n[r+0]=_r.toHalfFloat(Math.min(e[t+0]*i,65504)),n[r+1]=_r.toHalfFloat(Math.min(e[t+1]*i,65504)),n[r+2]=_r.toHalfFloat(Math.min(e[t+2]*i,65504)),n[r+3]=_r.toHalfFloat(1)},s=new Uint8Array(e);s.pos=0;let c=r(s),l=c.width,u=c.height,d=i(s.subarray(s.pos),l,u),f,p,m;switch(this.type){case v:m=d.length/4;let e=new Float32Array(m*4);for(let t=0;t<m;t++)a(d,t*4,e,t*4);f=e,p=v;break;case y:m=d.length/4;let t=new Uint16Array(m*4);for(let e=0;e<m;e++)o(d,e*4,t,e*4);f=t,p=y;break;default:throw Error(`THREE.HDRLoader: Unsupported type: `+this.type)}return{width:l,height:u,data:f,header:c.string,gamma:c.gamma,exposure:c.exposure,type:p}}setDataType(e){return this.type=e,this}load(e,t,n,r){function i(e,n){switch(e.type){case v:case y:e.colorSpace=Ue,e.minFilter=l,e.magFilter=l,e.generateMipmaps=!1,e.flipY=!0;break}t&&t(e,n)}return super.load(e,i,n,r)}},Wd=class extends Ud{constructor(e){console.warn(`RGBELoader has been deprecated. Please use HDRLoader instead.`),super(e)}},Gd={name:`CopyShader`,uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};nf.BlurDirectionX=new V(1,0),nf.BlurDirectionY=new V(0,1);var rf={name:`SMAAEdgesShader`,defines:{SMAA_THRESHOLD:`0.1`},uniforms:{tDiffuse:{value:null},resolution:{value:new V(1/1024,1/512)}},vertexShader:`
		...
		}`},af={name:`SMAAWeightsShader`,defines:{SMAA_MAX_SEARCH_STEPS:`8`,SMAA_AREATEX_MAX_DISTANCE:`16`,SMAA_AREATEX_PIXEL_SIZE:`( 1.0 / vec2( 160.0, 560.0 ) )`,SMAA_AREATEX_SUBTEX_SIZE:`( 1.0 / 7.0 )`},uniforms:{tDiffuse:{value:null},tArea:{value:null},tSearch:{value:null},resolution:{value:new V(1/1024,1/512)}},vertexShader:`
		...
		}`},of={name:`SMAABlendShader`,uniforms:{tDiffuse:{value:null},tColor:{value:null},resolution:{value:new V(1/1024,1/512)}},vertexShader:`
		...
		}`},lf=class extends Kd{constructor(){super(),this.isOutputPass=!0,this.uniforms=xa.clone(cf.uniforms),this.material=new Ta({name:cf.name,uniforms:this.uniforms,vertexShader:cf.vertexShader,fragmentShader:cf.fragmentShader}),this._fsQuad=new Yd(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},W.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},uf=!0,df=!1,ff=!1,pf=!1,mf=!1,hf=null,gf=null,_f=null,vf=null,yf=null,bf=null,xf=null,Sf=null,Cf=null,wf=null,Tf=null,Ef=null,Df=null,Of=null,kf=null,Af=!1,jf=null,Mf=!1,Nf={SET_MUTED:`outer-website:set-global-audio-muted`,SET_VOLUME:`outer-website:set-global-audio-volume`},Pf=`outer-website:postfx-settings`,Ff=2200,If=220,Lf=new H,Rf=new H,zf=[],Bf=new H(0,0,0),Vf={avgMs:0,lastUiUpdate:0};function Hf(){let e={bloomEnabled:!0,smaaEnabled:!0,msaaEnabled:!0};try{let t=window.localStorage.getItem(Pf);if(!t)return e;let n=JSON.parse(t);return{bloomEnabled:n?.bloomEnabled!==!1,smaaEnabled:n?.smaaEnabled!==!1,msaaEnabled:n?.msaaEnabled!==!1}}catch{return e}}var Uf=Hf();function Wf(){try{window.localStorage.setItem(Pf,JSON.stringify(Uf))}catch{}}var Gf={url:`/winxp/index.html#/`,width:1280,height:820,rotationX:-Math.PI*15.5/180,rotationY:Math.PI/2,rotationZ:0,flipNormal:!1,scaleMultiplier:1,scaleX:.99,scaleY:1.01,offsetX:0,offsetY:6e-4,offsetZ:0},X={loader:{bgColor:`#d9d9d9`,minLoadTime:1500,fadeTime:1,cameraPush:{startTime:1.5,duration:1,distance:.5},shockwave:{startTime:.5,duration:5.5,startRadius:0,endRadius:20,edgeWidth:.2,edgeIntensity:3,centerOffset:new H(-4,-1,0)},skyFade:{startTime:.5,duration:1},screenFade:{startTime:2.5,duration:6.5},controlsUnlockTime:2.5},intro:{startPos:new H(4.3,-1.8,0),startTarget:new H(0,-1.4,0)},focus:{duration:2e3,easing:`easeInOutCubic`,distance:.18,yOffset:0,maxTriggerAngle:60,targetOffsetX:0,targetOffsetY:0,targetOffsetZ:0,hitboxScale:1.8},unfocus:{duration:1800,easing:`easeOutCubic`,endPos:new H(4.5,-1.8,0),endTarget:new H(0,-1.4,0)},shield:{maxClickDistance:1.2,dimOpacity:.8,fadeDistance:.55,opacityLerp:.14},sky:{rotationSpeed:3e-5},parallax:{maxAngle:6,unlockThreshold:.2,springAccel:.004,springFriction:.06,catchupSpeed:.03,idleTimeout:3e3},walk:{chargeTime:80,releaseGrace:50,maxDist:1e3,speed:.011,acceleration:.6,deceleration:.6,dirLerp:1,dampingZone:.8,bounds:{minX:2,maxX:5,minY:-2,maxY:1.5,minZ:-3.5,maxZ:3.5}}};document.body.style.backgroundColor=X.loader.bgColor,document.body.style.margin=`0`,document.body.style.overflow=`hidden`;var Kf=document.createElement(`link`);Kf.rel=`stylesheet`,Kf.href=`https://db.onlinewebfonts.com/c/35ea0eae14a5c7ee380c2d62cd367fe9?family=Controller+W01+Two+Oblique`,document.head.appendChild(Kf);var qf=document.createElement(`link`);qf.rel=`stylesheet`,qf.href=`https://db.onlinewebfonts.com/c/8a7a89e31c8ccec1c446bb97e9e6cc07?family=Controller+W01+Five+Oblique`,document.head.appendChild(qf);var Jf=document.createElement(`style`);Jf.textContent=`
  #hud-loader-root {
...
`,document.head.appendChild(Jf);var Yf=document.createElement(`div`);Yf.id=`hud-loader-root`,Yf.innerHTML=`
  ...
  <div class="hud-core">
    ...
    <div class="hud-start-prompt" id="hud-start-prompt">Click anywhere to start</div>
  </div>`,document.body.appendChild(Yf);var Xf,Zf=new Promise(e=>{Xf=e});(function(){let e=Yf.querySelector(`#hud-bar`),t=Yf.querySelector(`#hud-hex`),n=Yf.querySelector(`#hud-status`);for(let t=0;t<18;t++){let t=document.createElement(`div`);t.className=`hud-block`,e.appendChild(t)}let r=e.querySelectorAll(`.hud-block`),i=0;function a(){i+=Math.random()*2+1,i>100&&(i=100);let e=Math.round(i/100*18);r.forEach((t,n)=>t.classList.toggle(`lit`,n<e)),t.textContent=`0x`+Math.floor(Math.random()*65535).toString(16).toUpperCase(),i<100?setTimeout(a,Math.random()*100+20):(n.textContent=`Boot sequence complete.`,setTimeout(Xf,800))}setTimeout(a,1e3)})();function Qf(){return new Promise(e=>{let t=Yf.querySelector(`.hud-core`);if(!t){e();return}let n=!1,r=t=>{n||(n=!0,Yf.removeEventListener(`pointerdown`,i,!0),Yf.removeEventListener(`keydown`,a,!0),typeof hm?.releaseQueuedPlayback==`function`&&hm.releaseQueuedPlayback(t),e())},i=e=>{e.preventDefault(),r(`loader-start-pointer`)},a=e=>{e.key!==`Enter`&&e.key!==` `||(e.preventDefault(),r(`loader-start-keyboard`))};t.classList.add(`is-awaiting-start`),Yf.tabIndex=0,Yf.focus({preventScroll:!0}),Yf.addEventListener(`pointerdown`,i,!0),Yf.addEventListener(`keydown`,a,!0)})}var $f=document.getElementById(`app`),ep=new Ln,tp={fov:65,near:.1,far:1e3},np={exposure:1.1,saturation:1.25,highlights:.95,repeatX:2,repeatY:1.2,offsetY:0,rotationY:-3*Math.PI/4},rp={exposure:.9,bloom:{strength:.01,radius:0,threshold:0}},ip={appearAt:3,fadeDuration:1},ap={sources:[`/audio/outer-bgm.ogg`,`/audio/outer-bgm.m4a`],loop:!0,initialVolume:.56,defaultWantsToPlay:!0},op={minVolumeRatio:.2,volumeSyncEpsilon:.003},Z=new bo(tp.fov,window.innerWidth/window.innerHeight,tp.near,tp.far),sp=new H().subVectors(X.intro.startTarget,X.intro.startPos).normalize(),cp=X.intro.startPos.clone().addScaledVector(sp,-X.loader.cameraPush.distance);Z.position.copy(cp);var lp=new _u({antialias:!0,alpha:!0});function up(){return Math.min(window.devicePixelRatio,2)}lp.setPixelRatio(up()),lp.setSize(window.innerWidth,window.innerHeight),lp.setClearColor(0,1),lp.outputColorSpace=He,lp.useLegacyLights=!1,lp.toneMapping=4,lp.toneMappingExposure=rp.exposure,$f.style.position=`relative`,$f.style.backgroundColor=`#000000`,lp.domElement.style.position=`absolute`,lp.domElement.style.top=`0`,lp.domElement.style.left=`0`,lp.domElement.style.zIndex=`1`,lp.domElement.style.pointerEvents=`auto`,$f.appendChild(lp.domElement);var dp=null,fp=null,pp=null,mp=null,hp=null,gp=null;function _p(){mp?.dispose&&mp.dispose(),hp?.dispose&&hp.dispose(),gp?.dispose&&gp.dispose(),dp&&dp.dispose()}function vp(){_p();let e=up(),t=Math.max(1,Math.floor(window.innerWidth*e)),n=Math.max(1,Math.floor(window.innerHeight*e));lp.setPixelRatio(e),lp.setSize(window.innerWidth,window.innerHeight),dp=new Qt(t,n,{samples:Uf.msaaEnabled?4:0,type:y}),fp=new $d(lp,dp),pp=new ef(ep,Z),fp.addPass(pp),mp=new nf(new V(window.innerWidth,window.innerHeight),rp.bloom.strength,rp.bloom.radius,rp.bloom.threshold),mp.enabled=Uf.bloomEnabled,fp.addPass(mp),hp=null,Uf.smaaEnabled&&(hp=new sf(t,n),fp.addPass(hp)),gp=new lf,fp.addPass(gp)}vp();var yp=new Ou(Z,lp.domElement);yp.enabled=!1,yp.target.copy(X.intro.startTarget);var bp=new oo,xp=new Wu,Sp=new Wd,Cp=null,Q=null,wp=null,Tp=[],Ep=null,Dp=null,Op={runtimeEnabled:!1,current:0,target:0},kp={quad:null},Ap={currentGain:1,fullVolumeDistance:0,minimumVolumeDistance:0,lastSyncedVolume:null},jp={frameId:null,renderRequested:!0,projectionInvalidated:!0};function Mp(){jp.renderRequested=!0,jp.frameId===null&&(jp.frameId=window.requestAnimationFrame(Gm))}function Np(){jp.projectionInvalidated=!0,Mp()}function Pp(e){return!!(uf||mf||Lm.w||Lm.a||Lm.s||Lm.d||Lm[` `]||Lm.control||$.active||$.velocity.lengthSq()>1e-6||Im.velocity.lengthSq()>1e-6||Im.currentMouse.distanceToSquared(Im.targetMouse)>1e-6||Op.runtimeEnabled&&Math.abs(Op.current-Op.target)>.002)}function Fp(){return jp.projectionInvalidated||!pf?!0:mf||uf}function Ip(){let e=performance.now();um(),fp.render(),Wm(),Fp()&&(qp(),jp.projectionInvalidated=!1),jm(performance.now()-e)}function Lp(e){if(!Q)return;let t=Mt.clamp(e,0,1),n=t.toFixed(3);Op.current=t,Q.element.style.opacity!==n&&(Q.element.style.opacity=n)}function Rp(e){Q?.element&&(Q.element.style.pointerEvents!==e&&(Q.element.style.pointerEvents=e),wp&&wp.style.pointerEvents!==e&&(wp.style.pointerEvents=e))}function zp(e,t){return[e[0]*t[0]+e[1]*t[3]+e[2]*t[6],e[0]*t[1]+e[1]*t[4]+e[2]*t[7],e[0]*t[2]+e[1]*t[5]+e[2]*t[8],e[3]*t[0]+e[4]*t[3]+e[5]*t[6],e[3]*t[1]+e[4]*t[4]+e[5]*t[7],e[3]*t[2]+e[4]*t[5]+e[5]*t[8],e[6]*t[0]+e[7]*t[3]+e[8]*t[6],e[6]*t[1]+e[7]*t[4]+e[8]*t[7],e[6]*t[2]+e[7]*t[5]+e[8]*t[8]]}function Bp(e,t){return[e[0]*t[0]+e[1]*t[1]+e[2]*t[2],e[3]*t[0]+e[4]*t[1]+e[5]*t[2],e[6]*t[0]+e[7]*t[1]+e[8]*t[2]]}function Vp(e){return[e[4]*e[8]-e[5]*e[7],e[2]*e[7]-e[1]*e[8],e[1]*e[5]-e[2]*e[4],e[5]*e[6]-e[3]*e[8],e[0]*e[8]-e[2]*e[6],e[2]*e[3]-e[0]*e[5],e[3]*e[7]-e[4]*e[6],e[1]*e[6]-e[0]*e[7],e[0]*e[4]-e[1]*e[3]]}function Hp(e,t,n,r,i,a,o,s){let c=[e,n,i,t,r,a,1,1,1],l=Bp(Vp(c),[o,s,1]);return zp(c,[l[0],0,0,0,l[1],0,0,0,l[2]])}function Up(e,t,n){let r=Hp(0,0,e,0,e,t,0,t),i=zp(Hp(n[0].x,n[0].y,n[1].x,n[1].y,n[2].x,n[2].y,n[3].x,n[3].y),Vp(r)),a=i.map(e=>e/i[8]);return`matrix3d(${[a[0],a[3],0,a[6],a[1],a[4],0,a[7],0,0,1,0,a[2],a[5],0,a[8]].map(e=>Number.isFinite(e)?e.toFixed(10):`0`).join(`,`)})`}function Wp(e){if(e.clone().applyMatrix4(Z.matrixWorldInverse).z>=-.001)return null;let t=e.clone().project(Z);return!Number.isFinite(t.x)||!Number.isFinite(t.y)?null:{x:(t.x*.5+.5)*window.innerWidth,y:(-t.y*.5+.5)*window.innerHeight}}function Gp(){if(!Q)return null;Q.updateMatrixWorld(!0);let e=[new H(-Gf.width/2,Gf.height/2,0),new H(Gf.width/2,Gf.height/2,0),new H(Gf.width/2,-Gf.height/2,0),new H(-Gf.width/2,-Gf.height/2,0)],t=[];for(let n of e){let e=Wp(n.applyMatrix4(Q.matrixWorld));if(!e)return null;t.push(e)}return t}function Kp(){Q?.element&&(Q.element.style.display=`none`,kp.quad=null)}function qp(){if(!Q?.element||!wp?.src){Kp();return}Z.updateMatrixWorld(!0),Z.updateProjectionMatrix();let e=Gp();if(!e){Kp();return}let t=Up(Gf.width,Gf.height,e),{element:n}=Q;kp.quad=e,n.style.display!==`block`&&(n.style.display=`block`),n.style.transform!==t&&(n.style.transform=t)}function Jp(e,t){if(!kp.quad||kp.quad.length!==4)return!1;let n=0;for(let r=0;r<kp.quad.length;r+=1){let i=kp.quad[r],a=kp.quad[(r+1)%kp.quad.length],o=(a.x-i.x)*(t-i.y)-(a.y-i.y)*(e-i.x);if(Math.abs(o)<=.5)continue;let s=Math.sign(o);if(n===0){n=s;continue}if(n!==s)return!1}return!0}function Yp(e){e.traverse(e=>{e.isMesh&&(e.name.toLowerCase().includes(`screen_plane`)||e.name.toLowerCase().includes(`hitbox`)||(Array.isArray(e.material)?e.material:[e.material]).forEach(e=>{zf.includes(e)||(zf.push(e),e.onBeforeCompile=t=>{e.userData.shader=t,t.uniforms.uShockwaveRadius={value:0},t.uniforms.uShockwaveCenter={value:Bf},t.uniforms.uEdgeIntensity={value:X.loader.shockwave.edgeIntensity},t.vertexShader=`
        ...
        `.replace(`#include <dithering_fragment>`,`
          ...
          `)})}))})}function Xp(e){return e.wrapS=r,e.wrapT=i,new wa({transparent:!0,uniforms:{tSky:{value:e},uExposure:{value:np.exposure},uSaturation:{value:np.saturation},uHighlights:{value:np.highlights},uRepeat:{value:new V(np.repeatX,np.repeatY)},uOffsetY:{value:np.offsetY},uSkyOpacity:{value:0}},vertexShader:`varying vec2 vUv; void main() { vUv = uv; gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0); }`,fragmentShader:`
    ...
    `,side:0,toneMapped:!1})}var Zp={computer:{path:`/textures/computer shadow.png`}},Qp={room:{path:`/textures/room baked.png`},table:{path:`/textures/table baked.png`},chairBack:{path:`/textures/chair back final.png`},chairLeft:{path:`/textures/chair left final.png`},chairRight:{path:`/textures/chair right final.png`}},$p={computer:{envMapIntensity:10.95,roughnessMin:.8}};function em(e){e.map&&(e.map.colorSpace=He),e.emissiveMap&&(e.emissiveMap.colorSpace=He)}function tm(e){let t=e.getAttribute(`uv`);if(!t)return;let n=new Float32Array(t.array.length);n.set(t.array),e.setAttribute(`uv1`,new xr(n,t.itemSize))}function nm(e){return e.includes(`room`)||e.includes(`wall`)||e.includes(`floor`)||e.includes(`ceiling`)?`room`:(e.includes(`table`)||e.includes(`desk`))&&!e.includes(`portable`)?`table`:e.includes(`chair_back`)||e.includes(`chair`)&&e.includes(`back`)?`chairBack`:e.includes(`chair_left`)||e.includes(`chair`)&&e.includes(`left`)?`chairLeft`:e.includes(`chair_right`)||e.includes(`chair`)&&e.includes(`right`)?`chairRight`:null}function rm(e){return e.includes(`computer`)||e.includes(`pc`)||e.includes(`monitor`)||e.includes(`portable`)||e.includes(`bm86`)?`computer`:null}async function im(e,t={}){let n=await bp.loadAsync(e);return n.flipY=t.flipY??!1,t.colorSpace&&(n.colorSpace=t.colorSpace),n}function am(){let e=document.createElement(`div`);e.style.width=`${Gf.width}px`,e.style.height=`${Gf.height}px`,e.style.backgroundColor=`#ffffff`,e.style.backfaceVisibility=`hidden`,e.style.position=`fixed`,e.style.left=`0`,e.style.top=`0`,e.style.overflow=`hidden`,e.style.pointerEvents=`none`,e.style.display=`none`,e.style.opacity=`0`,e.style.transformOrigin=`0 0`,e.style.willChange=`transform, opacity`,e.style.zIndex=`2`;let t=document.createElement(`iframe`);return t.style.position=`absolute`,t.style.left=`0`,t.style.top=`0`,t.style.width=`100%`,t.style.height=`100%`,t.style.border=`0`,t.style.backgroundColor=`#ffffff`,t.style.pointerEvents=`none`,t.allow=`autoplay`,e.appendChild(t),wp=t,Ap.lastSyncedVolume=null,e}function om(e){if(!e||Q)return;let t=am();Q=new On,Q.element=t,ep.add(Q),document.body.appendChild(t),e.updateWorldMatrix(!0,!1),e.geometry.computeBoundingBox();let n=e.geometry.boundingBox,r=new H;n.getCenter(r);let i=r.applyMatrix4(e.matrixWorld);Q.position.copy(i),Q.rotation.set(Gf.rotationX,Gf.rotationY,Gf.rotationZ,`YXZ`),Q.translateZ(Gf.offsetZ),Q.translateX(Gf.offsetX),Q.translateY(Gf.offsetY);let a=new H;n.getSize(a);let o=[a.x,a.y,a.z].sort((e,t)=>t-e),s=o[0]/Gf.width*Gf.scaleMultiplier*Gf.scaleX,c=o[1]/Gf.height*Gf.scaleMultiplier*Gf.scaleY;Q.scale.set(s,c,1),Q.updateMatrixWorld(!0);let l=new H(0,0,1).applyQuaternion(Q.quaternion).normalize();Lf.copy(Q.position).addScaledVector(l,X.focus.distance),Lf.y+=X.focus.yOffset,Rf.copy(Q.position),Rf.x+=X.focus.targetOffsetX,Rf.y+=X.focus.targetOffsetY,Rf.z+=X.focus.targetOffsetZ,Ap.fullVolumeDistance=Lf.distanceTo(Q.position),Ap.minimumVolumeDistance=Math.max(Ap.fullVolumeDistance+1e-4,cp.distanceTo(Q.position),X.intro.startPos.distanceTo(Q.position),X.unfocus.endPos.distanceTo(Q.position)),Ap.currentGain=cm(Z.position.distanceTo(Q.position)),Np()}function sm(e){return Mt.clamp(e,0,1)}function cm(e){let t=Ap.fullVolumeDistance,n=Math.max(Ap.minimumVolumeDistance,t+1e-4);if(!(t>0)||!(n>t)||e<=t)return 1;if(e>=n)return op.minVolumeRatio;let r=(e-t)/(n-t),i=r*r*(3-2*r);return Mt.lerp(1,op.minVolumeRatio,i)}function lm(e){return sm(e*Ap.currentGain)}function um(){if(!Q||!wp||!hm)return;let e=cm(Z.position.distanceTo(Q.position));Math.abs(e-Ap.currentGain)<.001||(Ap.currentGain=e,pm(hm.getState().volume))}function dm(){!wp||wp.getAttribute(`src`)||(wp.src=Gf.url,Np(),wp.addEventListener(`load`,()=>{fm(hm.getState().isMuted),pm(hm.getState().volume),Np()},{once:!0}))}function fm(e){wp?.contentWindow&&wp.contentWindow.postMessage({type:Nf.SET_MUTED,muted:!!e},window.location.origin)}function pm(e){if(!wp?.contentWindow)return;let t=lm(e);Ap.lastSyncedVolume!==null&&Math.abs(Ap.lastSyncedVolume-t)<op.volumeSyncEpsilon||(Ap.lastSyncedVolume=t,wp.contentWindow.postMessage({type:Nf.SET_VOLUME,volume:t},window.location.origin))}function mm(){let e=(Array.isArray(ap.sources)?ap.sources:[ap.src]).filter(Boolean),t=new Audio;t.preload=`auto`,t.loop=ap.loop,t.volume=ap.initialVolume,t.playsInline=!0;let n=!1,r=!0,i=0,a=null,o=0,s=null,c=0,l=null,u=null,d={hasSource:e.length>0,hasError:!1,isMuted:!1,isPlaying:!1,needsUserGesture:!1,unlockArmed:!1,volume:ap.initialVolume,wantsToPlay:ap.defaultWantsToPlay},f=()=>e[o]||``,p=()=>{let e=f();return e?(t.getAttribute(`src`)!==e&&(t.src=e),!0):(t.removeAttribute(`src`),!1)},m=()=>o>=e.length-1?!1:(o+=1,n=!1,p()),h=()=>{typeof l==`function`&&l({...d,currentSource:f()})},g=()=>{a!==null&&(window.clearTimeout(a),a=null)},_=()=>{i=0,g()},v=(e,n=240)=>!d.wantsToPlay||d.needsUserGesture?!1:a===null?i>=12?!1:(a=window.setTimeout(()=>{a=null,i+=1,t.readyState===0&&!d.hasError&&t.load(),k(`${e}-retry-${i}`)},n),!0):!0,y=({restoreVolume:e=!1}={})=>{c+=1,s!==null&&(window.cancelAnimationFrame(s),s=null),e&&(t.volume=sm(d.volume))},b=e=>{if(t.paused||t.muted||r||t.volume<=.001){e();return}y();let n=c,i=t.volume,a=performance.now(),o=r=>{if(n!==c)return;let l=Math.min((r-a)/If,1);if(t.volume=Mt.lerp(i,0,l),l<1){s=window.requestAnimationFrame(o);return}s=null,e()};s=window.requestAnimationFrame(o)},x=(e=!1)=>{t.muted=e||d.isMuted||r,t.volume=sm(d.volume)},S=async()=>{if(!d.hasSource||n)return!1;x(!0);try{return await t.play(),_(),n=!0,d.hasError=!1,d.isPlaying=!0,d.needsUserGesture=!1,O(),h(),!0}catch{return x(),v(`prime-muted-autoplay`),!1}},C=()=>!n||t.paused?!1:(y({restoreVolume:!0}),t.currentTime=0,x(),_(),d.hasError=!1,d.isPlaying=!0,d.needsUserGesture=!1,O(),h(),!0),w=()=>{if(!n||t.paused)return!1;t.pause();try{t.currentTime=0}catch{return!1}return d.isPlaying=!1,!0},T=(e=`timeline-sync`)=>{if(!r){d.wantsToPlay&&!d.isPlaying?k(e):(x(),h());return}if(r=!1,d.needsUserGesture=!1,d.hasError=!1,_(),O(),x(),!d.wantsToPlay){h();return}k(w()?`${e}-restart-from-zero`:e)},E=()=>{window.setTimeout(()=>{t.currentTime<.25&&(t.currentTime=0),x(),h()},80)},D=async()=>{x(!0);try{return await t.play(),_(),d.hasError=!1,d.isPlaying=!0,d.needsUserGesture=!1,O(),E(),h(),!0}catch{return x(),!1}},O=()=>{!d.unlockArmed||!u||([`pointerdown`,`keydown`,`touchstart`].forEach(e=>{window.removeEventListener(e,u,!0)}),u=null,d.unlockArmed=!1)},ee=()=>{d.unlockArmed||=(u=()=>{O(),d.wantsToPlay&&k(`user-gesture`)},[`pointerdown`,`keydown`,`touchstart`].forEach(e=>{window.addEventListener(e,u,!0)}),!0)},k=async(e=`manual`)=>{if(d.wantsToPlay=!0,y({restoreVolume:!0}),!d.hasSource)return h(),!1;if(C())return!0;d.hasError&&=(t.load(),!1),x();try{return await t.play(),_(),d.hasError=!1,d.isPlaying=!0,d.needsUserGesture=!1,O(),h(),!0}catch(n){return d.isPlaying=!t.paused,n?.name===`NotAllowedError`?await D()||(d.hasError=!1,v(`autoplay-blocked`)||(d.needsUserGesture=!0,ee())):n?.name===`AbortError`||n?.name===`NotSupportedError`?(d.hasError=!1,v(n.name===`AbortError`?`media-aborted`:`media-not-ready`)||(d.hasError=!0)):(d.hasError=!0,console.warn(`[BGM] Unable to play audio (${e}).`,n)),h(),!1}},te=()=>{d.wantsToPlay=!1,d.needsUserGesture=!1,_(),O(),b(()=>{t.pause(),y({restoreVolume:!0}),d.isPlaying=!1,h()})},A=()=>{if(d.isPlaying||d.wantsToPlay){te();return}k(`toggle`)},j=e=>{let t=()=>{d.isMuted=e,x(),fm(d.isMuted),h()};if(e!==d.isMuted){if(e){b(t);return}y({restoreVolume:!0}),t()}};return t.addEventListener(`play`,()=>{d.isPlaying=!0,h()}),t.addEventListener(`pause`,()=>{d.isPlaying=!1,h()}),t.addEventListener(`ended`,()=>{d.isPlaying=!1,h()}),t.addEventListener(`canplay`,()=>{d.wantsToPlay&&!d.isPlaying&&!d.needsUserGesture&&v(`canplay`,0)}),t.addEventListener(`error`,()=>{let e=t.error?.code??null;if(e===1||e===null){v(`media-load-aborted`);return}if(e===4){if(m()){_(),d.hasError=!1,d.isPlaying=!1,t.load(),d.wantsToPlay&&(r?S():k(`media-source-fallback`)),h();return}if(v(`media-source-error`,320))return}d.hasError=!0,d.isPlaying=!1,console.warn(`[BGM] Audio source could not be loaded: ${f()}`),h()}),x(),d.hasSource&&p()&&(t.load(),d.wantsToPlay&&S()),{getState(){return{...d,currentSource:f()}},pause:te,play:k,releaseQueuedPlayback:T,setVolume:e=>{y(),d.volume=sm(e),d.volume>0&&d.isMuted&&(d.isMuted=!1),x(),pm(d.volume),fm(d.isMuted),h()},setOnChange(e){l=e,h()},toggleMute:()=>{j(!d.isMuted)},togglePlay:A}}var hm=mm(),gm={soundOn:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M15.54 8.46a5 5 0 0 1 0 7.07"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14"/></svg>`,soundOff:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><line x1="23" y1="9" x2="17" y2="15"/><line x1="17" y1="9" x2="23" y2="15"/></svg>`,play:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round"><polygon points="8 5 19 12 8 19 8 5"/></svg>`,pause:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="9" y1="5" x2="9" y2="19"/><line x1="15" y1="5" x2="15" y2="19"/></svg>`,volumeLow:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M15 12a3 3 0 0 0 0-0.01"/></svg>`,volumeMid:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M15.5 9.5a4 4 0 0 1 0 5"/></svg>`,volumeHigh:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M15.5 8.5a5.5 5.5 0 0 1 0 7"/><path d="M18.8 6a9 9 0 0 1 0 12"/></svg>`,camUnfocused:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/><circle cx="12" cy="13" r="4"/></svg>`,camFocused:`<svg width="13" height="13" viewBox="0 0 24 24" fill="#ff7b00" stroke="#ff7b00" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/><circle cx="12" cy="13" r="4"/></svg>`,fx:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 7h8"/><path d="M4 17h14"/><path d="M14 7h6"/><path d="M10 17h4"/><circle cx="12" cy="7" r="2"/><circle cx="8" cy="17" r="2"/></svg>`},_m={wasd:`<svg width="46" height="30" viewBox="0 0 46 30" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`};function vm(){hf&&(pf?hf.innerHTML=gm.camFocused:hf.innerHTML=gm.camUnfocused)}function ym(e){return e>=.75?gm.volumeHigh:e>=.4?gm.volumeMid:gm.volumeLow}function bm(e){return e.isMuted?`Muted`:`${Math.round(e.volume*100)}%`}function xm(){jf!==null&&(window.clearTimeout(jf),jf=null)}function Sm(){xm(),Af&&(jf=window.setTimeout(()=>{Cm(!1)},Ff))}function Cm(e){e&&Mf&&Dm(!1),Af=e,yf&&yf.classList.toggle(`is-open`,Af),Af?Sm():xm()}function wm(){return`Bloom ${Uf.bloomEnabled?`On`:`Off`} | SMAA ${Uf.smaaEnabled?`On`:`Off`} | MSAA ${Uf.msaaEnabled?`4x`:`Off`}`}function Tm(e,t,n,r=`On`,i=`Off`){e&&(e.classList.toggle(`is-active`,n),e.innerHTML=`<span>${t}</span><strong>${n?r:i}</strong>`)}function Em(){if(Cf&&(Cf.classList.toggle(`is-active`,Mf),Cf.title=wm()),wf&&wf.classList.toggle(`is-open`,Mf),Tm(Ef,`Bloom`,Uf.bloomEnabled),Tm(Df,`SMAA`,Uf.smaaEnabled),Tm(Of,`MSAA`,Uf.msaaEnabled,`4x`),Tf){let e=up(),t=Math.max(1,Math.floor(window.innerWidth*e)),n=Math.max(1,Math.floor(window.innerHeight*e)),r=Vf.avgMs>0?Vf.avgMs.toFixed(1):`0.0`,i=Vf.avgMs>0?Math.round(1e3/Vf.avgMs):0,a=Uf.msaaEnabled?`4x`:`off`;Tf.textContent=`Avg ${r} ms | ~${i} fps | ${t}x${n} | MSAA ${a}`}}function Dm(e){e&&Af&&Cm(!1),Mf=e,Em(),Mp()}function Om(e){Uf.bloomEnabled=!!e.bloomEnabled,Uf.smaaEnabled=!!e.smaaEnabled,Uf.msaaEnabled=!!e.msaaEnabled,Wf(),vp(),Em(),Mp()}function km(e){Om({...Uf,[e]:!Uf[e]})}function Am(e){let t={full:{bloomEnabled:!0,smaaEnabled:!0,msaaEnabled:!0},noBloom:{bloomEnabled:!1,smaaEnabled:!0,msaaEnabled:!0},smaaOnly:{bloomEnabled:!1,smaaEnabled:!0,msaaEnabled:!1},msaaOnly:{bloomEnabled:!1,smaaEnabled:!1,msaaEnabled:!0},raw:{bloomEnabled:!1,smaaEnabled:!1,msaaEnabled:!1}}[e];t&&Om(t)}function jm(e,t=performance.now()){Vf.avgMs=Vf.avgMs===0?e:Mt.lerp(Vf.avgMs,e,.18),!(t-Vf.lastUiUpdate<250)&&(Vf.lastUiUpdate=t,Em())}function Mm(e=hm.getState()){gf&&(gf.innerHTML=e.isMuted?gm.soundOff:gm.soundOn,gf.title=e.isMuted?`Unmute all audio`:`Mute all audio`),_f&&(_f.innerHTML=e.isPlaying||e.wantsToPlay?gm.pause:gm.play,e.hasError?_f.title=`BGM unavailable (${e.currentSource||`no source`})`:e.needsUserGesture&&!e.isPlaying?_f.title=`Click to start music`:e.wantsToPlay&&!e.isPlaying?_f.title=`Music queued to start`:_f.title=e.isPlaying?`Pause music`:`Play music`),vf&&(vf.innerHTML=ym(e.volume),vf.title=`Adjust volume (${Math.round(e.volume*100)}%)`),bf&&(bf.value=`${Math.round(e.volume*100)}`),xf&&(xf.textContent=bm(e))}hm.setOnChange(Mm);function Nm(){let e=document.createElement(`style`);e.textContent=`
    #ui-tl {
      position: fixed; top: 18px; left: 18px; z-index: 100;
      display: flex; align-items: center; gap: 10px;
      opacity: 0; transition: opacity ${ip.fadeDuration}s ease;
      font-family: "Controller W01 Two Oblique", 'Courier New', Courier, monospace;
  ...
  `,document.head.appendChild(e);let t=document.createElement(`div`);t.id=`ui-tl`;let n=document.createElement(`span`);n.id=`ui-name`,n.textContent=`Hanqi Zhao`,_f=document.createElement(`button`),_f.className=`ui-btn`,_f.addEventListener(`click`,()=>{hm.togglePlay()});let r=document.createElement(`div`);Sf=r,r.className=`ui-volume-control`,vf=document.createElement(`button`),vf.className=`ui-btn`,vf.addEventListener(`click`,()=>{Cm(!Af)}),yf=document.createElement(`div`),yf.className=`ui-volume-panel`;let i=document.createElement(`div`);i.className=`ui-volume-title`,i.innerHTML=`<span>Volume</span>`,xf=document.createElement(`span`),xf.className=`ui-volume-value`,i.appendChild(xf),bf=document.createElement(`input`),bf.className=`ui-volume-slider`,bf.type=`range`,bf.min=`0`,bf.max=`100`,bf.step=`1`,bf.addEventListener(`input`,e=>{hm.setVolume(Number(e.target.value)/100),Sm()}),yf.appendChild(i),yf.appendChild(bf),r.appendChild(vf),r.appendChild(yf);let a=document.createElement(`div`);kf=a,a.className=`ui-postfx-control`,Cf=document.createElement(`button`),Cf.className=`ui-btn`,Cf.innerHTML=gm.fx,Cf.addEventListener(`click`,()=>{Dm(!Mf)}),wf=document.createElement(`div`),wf.className=`ui-postfx-panel`;let o=document.createElement(`div`);o.className=`ui-postfx-header`,o.innerHTML=`<span>Post FX A/B</span>`;let s=document.createElement(`span`);s.className=`ui-postfx-summary`,s.textContent=`Compare live`,o.appendChild(s);let c=document.createElement(`div`);c.className=`ui-postfx-toggles`,Ef=document.createElement(`button`),Ef.className=`ui-postfx-toggle`,Ef.type=`button`,Ef.addEventListener(`click`,()=>{km(`bloomEnabled`)}),Df=document.createElement(`button`),Df.className=`ui-postfx-toggle`,Df.type=`button`,Df.addEventListener(`click`,()=>{km(`smaaEnabled`)}),Of=document.createElement(`button`),Of.className=`ui-postfx-toggle`,Of.type=`button`,Of.addEventListener(`click`,()=>{km(`msaaEnabled`)}),c.appendChild(Ef),c.appendChild(Df),c.appendChild(Of);let l=document.createElement(`div`);l.className=`ui-postfx-presets`,[[`FULL`,`full`],[`NO BLM`,`noBloom`],[`SMAA`,`smaaOnly`],[`MSAA`,`msaaOnly`],[`RAW`,`raw`]].forEach(([e,t])=>{let n=document.createElement(`button`);n.className=`ui-postfx-preset`,n.type=`button`,n.textContent=e,n.addEventListener(`click`,()=>{Am(t)}),l.appendChild(n)}),Tf=document.createElement(`div`),Tf.className=`ui-postfx-stats`,wf.appendChild(o),wf.appendChild(c),wf.appendChild(l),wf.appendChild(Tf),a.appendChild(Cf),a.appendChild(wf),gf=document.createElement(`button`),gf.className=`ui-btn`,gf.addEventListener(`click`,()=>{hm.toggleMute()}),hf=document.createElement(`button`),hf.className=`ui-btn`,hf.innerHTML=gm.camUnfocused,hf.title=`Toggle focus`,hf.addEventListener(`click`,()=>{mf||!df||(pf?(pf=!1,vm(),Vm(Z.position.clone(),yp.target.clone(),X.unfocus.endPos,X.unfocus.endTarget,X.unfocus.duration,X.unfocus.easing)):(pf=!0,vm(),Vm(Z.position.clone(),yp.target.clone(),Lf,Rf,X.focus.duration,X.focus.easing)))}),t.appendChild(n),t.appendChild(_f),t.appendChild(r),t.appendChild(gf),t.appendChild(a),t.appendChild(hf),document.body.appendChild(t),document.addEventListener(`pointerdown`,e=>{let t=Sf?.contains(e.target),n=kf?.contains(e.target);Af&&t?Sm():Af&&Cm(!1),Mf&&!n&&Dm(!1)}),document.addEventListener(`pointermove`,()=>{Af&&Sm()}),document.addEventListener(`wheel`,()=>{Af&&Sm()},{passive:!0}),document.addEventListener(`keydown`,e=>{if(e.key===`Escape`){Cm(!1),Dm(!1);return}Af&&Sm()}),Mm(),Em();let u=document.createElement(`div`);u.id=`ui-bl`,u.innerHTML=`
    <div class="ui-hint">${_m.wasd}<span>: move</span></div>
    <div class="ui-hint">${_m.space}<span>: up</span></div>
    <div class="ui-hint">${_m.ctrl}<span>: down</span></div>
  `,document.body.appendChild(u);let d=document.createElement(`div`);return d.id=`ui-br`,d.innerHTML=`<div class="ui-copy">© Copyright 2026 Hanqi Zhao.</div>`,document.body.appendChild(d),{tl:t,bl:u,br:d}}async function Pm(){try{let[e,t,n,r,i]=await Promise.all([Sp.loadAsync(`/textures/new_sky.hdr`),Sp.loadAsync(`/textures/room.hdr`),xp.loadAsync(`/models/room_all.glb`),Promise.all(Object.entries(Qp).map(async([e,t])=>[e,await im(t.path,{colorSpace:He})])),Promise.all(Object.entries(Zp).map(async([e,t])=>{let n=await im(t.path,{colorSpace:``});return n.channel=1,[e,n]}))]),a=Object.fromEntries(r),o=Object.fromEntries(i),s=new ga(200,60,40);s.scale(-1,1,1),Dp=new ci(s,Xp(e)),Dp.position.y=-100,Dp.rotation.y=np.rotationY,ep.add(Dp),t.mapping=303,ep.environment=t,ep.environmentIntensity=1.2;let c=n.scene;if(c.traverse(e=>{if(!e.isMesh)return;let t=(e.name??``).toLowerCase();(t.includes(`computer`)||t.includes(`screen`)||t.includes(`monitor`))&&Tp.push(e),t.includes(`screen_plane`)&&(Cp=e,Bf.setFromMatrixPosition(e.matrixWorld),Bf.add(X.loader.shockwave.centerOffset),Cp.material=new Xr({colorWrite:!1,depthWrite:!0}),Cp.renderOrder=-1)}),Yp(c),c.traverse(e=>{if(!e.isMesh)return;let t=(e.name??``).toLowerCase();t.includes(`screen_plane`)||(Array.isArray(e.material)?e.material:[e.material]).forEach(n=>{if(!n)return;em(n);let r=nm(t),i=rm(t);if(r&&a[r]){n.map=a[r],n.needsUpdate=!0;return}n.isMeshStandardMaterial&&i&&o[i]&&(tm(e.geometry),n.lightMap=o[i],$p[i]&&(n.envMapIntensity=$p[i].envMapIntensity,n.roughness<$p[i].roughnessMin&&(n.roughness=$p[i].roughnessMin)),n.needsUpdate=!0)})}),ep.add(c),Tp.length>0){let e=new Qn;Tp.forEach(t=>{t.updateMatrixWorld(!0),e.union(new Qn().setFromObject(t))});let t=new H;e.getCenter(t);let n=new H;e.getSize(n),Ep=new ci(new ma(n.x,n.y,n.z),new Xr({colorWrite:!1,depthWrite:!1,transparent:!0,opacity:0})),Ep.position.copy(t),Ep.scale.setScalar(X.focus.hitboxScale),ep.add(Ep),Cp||(Bf.copy(t),Bf.add(X.loader.shockwave.centerOffset))}Cp&&om(Cp),await Promise.all([Zf,new Promise(e=>setTimeout(e,X.loader.minLoadTime))]),await Qf(),Yf.style.opacity=`0`,await new Promise(e=>setTimeout(e,X.loader.fadeTime*1e3)),Yf.remove(),dm();let l=Nm();{let e=performance.now(),t=!1,n=e=>e===1?1:1-2**(-10*e),r=e=>e<.5?4*e*e*e:1-(-2*e+2)**3/2;function i(){let a=(performance.now()-e)/1e3;if(!df){let e=X.loader.cameraPush,t=0;a>=e.startTime&&(t=Math.min((a-e.startTime)/e.duration,1)),Z.position.lerpVectors(cp,X.intro.startPos,r(t)),Z.lookAt(yp.target)}let o=X.loader.shockwave,s=0;a>=o.startTime&&(s=Math.min((a-o.startTime)/o.duration,1));let c=Mt.lerp(o.startRadius,o.endRadius,n(s));s>=1&&(c=9999),zf.forEach(e=>{e.userData.shader&&(e.userData.shader.uniforms.uShockwaveRadius.value=c)});let u=X.loader.skyFade,d=0;a>=u.startTime&&(d=Math.min((a-u.startTime)/u.duration,1)),Dp&&Dp.material&&(Dp.material.uniforms.uSkyOpacity.value=d),!df&&a>=X.loader.controlsUnlockTime&&(df=!0,Im.locked=!0,Im.targetMouse.set(0,0),Im.currentMouse.set(0,0),Im.lockBaseMouse.copy(Fm),zm());let f=X.loader.screenFade;a>=f.startTime&&!ff&&(ff=!0,Op.runtimeEnabled=!1,Q&&(Q.element.style.transition=`opacity ${f.duration}s ease-in-out`,requestAnimationFrame(()=>{Q.element.style.opacity=`1`,setTimeout(()=>{Q&&(Q.element.style.transition=``,Op.runtimeEnabled=!0,Op.target=1,Lp(1))},f.duration*1e3+100)}))),!t&&a>=ip.appearAt&&(t=!0,l.tl.style.opacity=`1`,l.bl.style.opacity=`1`,l.br.style.opacity=`1`),a<Math.max(X.loader.cameraPush.startTime+X.loader.cameraPush.duration,o.startTime+o.duration,u.startTime+u.duration,f.startTime+f.duration,X.loader.controlsUnlockTime)?requestAnimationFrame(i):uf=!1}i()}}catch(e){console.error(e)}}var Fm=new V,Im={locked:!0,lockBaseMouse:new V,targetMouse:new V,currentMouse:new V,velocity:new V},Lm={w:!1,a:!1,s:!1,d:!1," ":!1,control:!1},Rm=performance.now();function zm(){Rm=performance.now()}window.addEventListener(`pointermove`,e=>{Fm.x=e.clientX/window.innerWidth*2-1,Fm.y=-(e.clientY/window.innerHeight)*2+1,df&&(zm(),!mf&&!pf&&Im.locked&&Fm.distanceTo(Im.lockBaseMouse)>X.parallax.unlockThreshold&&(Im.locked=!1),Mp())}),window.addEventListener(`keydown`,e=>{if(!df)return;zm();let t=e.key.toLowerCase();t===` `&&e.preventDefault(),Lm[t]!==void 0&&(Lm[t]=!0),Mp()},{passive:!1}),window.addEventListener(`keyup`,e=>{if(!df)return;zm();let t=e.key.toLowerCase();Lm[t]!==void 0&&(Lm[t]=!1),Mp()}),window.addEventListener(`wheel`,()=>{df&&(zm(),Mp())}),lp.domElement.addEventListener(`contextmenu`,e=>e.preventDefault());var Bm={linear:e=>e,easeOutCubic:e=>1-(1-e)**3,easeInOutCubic:e=>e<.5?4*e*e*e:1-(-2*e+2)**3/2};function Vm(e,t,n,r,i,a,o){mf=!0;let s=performance.now(),c=Bm[a]||Bm.easeInOutCubic;Mp();function l(){let a=(performance.now()-s)/i;a>1&&(a=1);let u=c(a);Z.position.lerpVectors(e,n,u),yp.target.lerpVectors(t,r,u),Z.lookAt(yp.target),Z.updateProjectionMatrix(),Mp(),a<1?requestAnimationFrame(l):(mf=!1,$.velocity.set(0,0,0),Im.locked=!0,Im.lockBaseMouse.copy(Fm),Im.targetMouse.set(0,0),Im.currentMouse.set(0,0),Im.velocity.set(0,0),zm(),o&&o(),Mp())}l()}var Hm=new Xo,Um=0;lp.domElement.addEventListener(`pointerdown`,e=>{!df||mf||(zm(),Um=performance.now(),Mp())}),lp.domElement.addEventListener(`pointerup`,e=>{if(!(!df||mf)){if(performance.now()-Um<300){if(Fm.x=e.clientX/window.innerWidth*2-1,Fm.y=-(e.clientY/window.innerHeight)*2+1,pf){if(Jp(e.clientX,e.clientY))return;pf=!1,vm(),Vm(Z.position.clone(),yp.target.clone(),X.unfocus.endPos,X.unfocus.endTarget,X.unfocus.duration,X.unfocus.easing);return}Hm.setFromCamera(Fm,Z);let t=Ep?[Ep]:Tp;if(Hm.intersectObjects(t,!0).length>0&&Q){let e=new H(0,0,1).applyQuaternion(Q.quaternion).normalize(),t=new H().subVectors(Z.position,Q.position).normalize();e.angleTo(t)*(180/Math.PI)<=X.focus.maxTriggerAngle&&(pf=!0,vm(),Vm(Z.position.clone(),yp.target.clone(),Lf,Rf,X.focus.duration,X.focus.easing))}}Mp()}});function Wm(){if(!Cp||!Q)return;let e=pf&&!mf&&!!wp?.src;if(!ff){Rp(e?`auto`:`none`);return}if(!Op.runtimeEnabled){Rp(e?`auto`:`none`);return}let t=new H(0,0,1).applyQuaternion(Q.quaternion).normalize(),n=new H().subVectors(Z.position,Q.position).normalize(),r=Z.position.distanceTo(Q.position),i=t.dot(n)>=0,a=0,o=`none`;if(e)a=1,o=`auto`;else if(i){let e=X.shield.maxClickDistance+X.shield.fadeDistance;if(r<=X.shield.maxClickDistance)a=1;else if(r>=e)a=X.shield.dimOpacity;else{let e=1-(r-X.shield.maxClickDistance)/X.shield.fadeDistance;a=Mt.lerp(X.shield.dimOpacity,1,e)}}Op.target=a;let s=Mt.lerp(Op.current,Op.target,X.shield.opacityLerp);Lp(Math.abs(s-Op.target)<.002?Op.target:s),Rp(o)}var $={active:!1,chargeStart:0,releaseStart:0,dist:0,currentDir:new H,velocity:new H};function Gm(){jp.frameId=null;let e=performance.now();if(!Pp(e)&&!jp.renderRequested)return;if(Dp&&Pp(e)&&(Dp.rotation.y+=X.sky.rotationSpeed),!df){Ip(),jp.renderRequested=!1,Pp(performance.now())&&Mp();return}if(!pf&&!mf){let t=new H;Z.getWorldDirection(t),t.y=0,t.normalize();let n=new H().crossVectors(t,Z.up).normalize(),r=new H(0,1,0),i=new H;Lm.w&&i.add(t),Lm.s&&i.sub(t),Lm.a&&i.sub(n),Lm.d&&i.add(n),Lm[` `]&&i.add(r),Lm.control&&i.sub(r),i.lengthSq()>0?($.releaseStart=0,$.active?$.currentDir.lerp(i.normalize(),X.walk.dirLerp).normalize():($.chargeStart===0&&($.chargeStart=e),e-$.chargeStart>X.walk.chargeTime&&($.active=!0,$.dist=0,$.currentDir.copy(i.normalize())))):($.chargeStart=0,$.active&&($.releaseStart===0&&($.releaseStart=e),e-$.releaseStart>X.walk.releaseGrace&&($.active=!1))),$.active&&$.dist>=X.walk.maxDist&&($.active=!1);let a=new H;if($.active?(a.copy($.currentDir).multiplyScalar(X.walk.speed),$.velocity.lerp(a,X.walk.acceleration)):$.velocity.lerp(a,X.walk.deceleration),$.velocity.lengthSq()>1e-6){$.dist+=$.velocity.length();let e=$.velocity.clone(),t=X.walk.bounds,n=X.walk.dampingZone;e.x<0&&Z.position.x-t.minX<n?e.x*=Math.max(0,(Z.position.x-t.minX)/n):e.x>0&&t.maxX-Z.position.x<n&&(e.x*=Math.max(0,(t.maxX-Z.position.x)/n)),e.y<0&&Z.position.y-t.minY<n?e.y*=Math.max(0,(Z.position.y-t.minY)/n):e.y>0&&t.maxY-Z.position.y<n&&(e.y*=Math.max(0,(t.maxY-Z.position.y)/n)),e.z<0&&Z.position.z-t.minZ<n?e.z*=Math.max(0,(Z.position.z-t.minZ)/n):e.z>0&&t.maxZ-Z.position.z<n&&(e.z*=Math.max(0,(t.maxZ-Z.position.z)/n));let r=Z.position.clone().add(e);r.x<=t.minX?(r.x=t.minX,$.velocity.x=0):r.x>=t.maxX&&(r.x=t.maxX,$.velocity.x=0),r.y<=t.minY?(r.y=t.minY,$.velocity.y=0):r.y>=t.maxY&&(r.y=t.maxY,$.velocity.y=0),r.z<=t.minZ?(r.z=t.minZ,$.velocity.z=0):r.z>=t.maxZ&&(r.z=t.maxZ,$.velocity.z=0);let i=new H().subVectors(r,Z.position);Z.position.copy(r),yp.target.add(i)}}Z.lookAt(yp.target);let t=Z.quaternion.clone(),n=e-Rm>X.parallax.idleTimeout;pf||mf||n||Im.locked?Im.targetMouse.lerp(new V(0,0),X.parallax.catchupSpeed):Im.targetMouse.lerp(Fm,X.parallax.catchupSpeed);let r=new V().subVectors(Im.targetMouse,Im.currentMouse);Im.velocity.add(r.multiplyScalar(X.parallax.springAccel)),Im.velocity.multiplyScalar(1-X.parallax.springFriction),Im.currentMouse.add(Im.velocity);let i=Im.currentMouse.y*Mt.degToRad(X.parallax.maxAngle),a=-Im.currentMouse.x*Mt.degToRad(X.parallax.maxAngle);Z.rotateX(i),Z.rotateY(a),Ip(),Z.quaternion.copy(t),jp.renderRequested=!1,Pp(performance.now())&&Mp()}window.addEventListener(`resize`,()=>{Z.aspect=window.innerWidth/window.innerHeight,Z.updateProjectionMatrix(),vp(),Em(),Np()}),Pm(),Mp();