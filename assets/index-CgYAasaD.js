...
`,document.head.appendChild(Ff);var If=document.createElement(`div`);If.id=`hud-loader-root`,If.innerHTML=`
  ...
  <div class="hud-core">
    ...
    <div class="hud-start-prompt" id="hud-start-prompt">Click anywhere to start</div>
  </div>`,document.body.appendChild(If);var Lf,Rf=new Promise(e=>{Lf=e});(function(){let e=If.querySelector(`#hud-bar`),t=If.querySelector(`#hud-hex`),n=If.querySelector(`#hud-status`);for(let t=0;t<18;t++){let t=document.createElement(`div`);t.className=`hud-block`,e.appendChild(t)}let r=e.querySelectorAll(`.hud-block`),i=0;function a(){i+=Math.random()*2+1,i>100&&(i=100);let e=Math.round(i/100*18);r.forEach((t,n)=>t.classList.toggle(`lit`,n<e)),t.textContent=`0x`+Math.floor(Math.random()*65535).toString(16).toUpperCase(),i<100?setTimeout(a,Math.random()*100+20):(n.textContent=`Boot sequence complete.`,setTimeout(Lf,800))}setTimeout(a,1e3)})();function zf(){return new Promise(e=>{let t=If.querySelector(`.hud-core`);if(!t){e();return}let n=!1,r=t=>{n||(n=!0,If.removeEventListener(`pointerdown`,i,!0),If.removeEventListener(`keydown`,a,!0),typeof Qp?.releaseQueuedPlayback==`function`&&Qp.releaseQueuedPlayback(t),e())},i=e=>{e.preventDefault(),r(`loader-start-pointer`)},a=e=>{e.key!==`Enter`&&e.key!==` `||(e.preventDefault(),r(`loader-start-keyboard`))};t.classList.add(`is-awaiting-start`),If.tabIndex=0,If.focus({preventScroll:!0}),If.addEventListener(`pointerdown`,i,!0),If.addEventListener(`keydown`,a,!0)})}var Bf=document.getElementById(`app`),Vf=new Ln,Hf={fov:65,near:.1,far:1e3},Uf={exposure:1.1,saturation:1.25,highlights:.95,repeatX:2,repeatY:1.2,offsetY:0,rotationY:-3*Math.PI/4},Wf={exposure:.9,bloom:{strength:.01,radius:0,threshold:0}},Gf={appearAt:3,fadeDuration:1},Kf={sources:[`/audio/outer-bgm.ogg`,`/audio/outer-bgm.m4a`],loop:!0,initialVolume:.56,defaultWantsToPlay:!0},qf={minVolumeRatio:.2,volumeSyncEpsilon:.003},Z=new bo(Hf.fov,window.innerWidth/window.innerHeight,Hf.near,Hf.far),Jf=new H().subVectors(X.intro.startTarget,X.intro.startPos).normalize(),Yf=X.intro.startPos.clone().addScaledVector(Jf,-X.loader.cameraPush.distance);Z.position.copy(Yf);var Xf=new _u({antialias:!0,alpha:!0}),Zf=Math.min(window.devicePixelRatio,2);Xf.setPixelRatio(Zf),Xf.setSize(window.innerWidth,window.innerHeight),Xf.setClearColor(0,1),Xf.outputColorSpace=He,Xf.useLegacyLights=!1,Xf.toneMapping=4,Xf.toneMappingExposure=Wf.exposure,Bf.style.position=`relative`,Bf.style.backgroundColor=`#000000`,Xf.domElement.style.position=`absolute`,Xf.domElement.style.top=`0`,Xf.domElement.style.left=`0`,Xf.domElement.style.zIndex=`1`,Xf.domElement.style.pointerEvents=`auto`,Bf.appendChild(Xf.domElement);var Qf=window.innerWidth*Zf,$f=window.innerHeight*Zf,ep=new $d(Xf,new Qt(Qf,$f,{samples:4,type:y}));ep.addPass(new ef(Vf,Z));var tp=new nf(new V(window.innerWidth,window.innerHeight),Wf.bloom.strength,Wf.bloom.radius,Wf.bloom.threshold);ep.addPass(tp),ep.addPass(new sf(Qf,$f)),ep.addPass(new lf);var np=new Ou(Z,Xf.domElement);np.enabled=!1,np.target.copy(X.intro.startTarget);var rp=new oo,ip=new Wu,ap=new Wd,op=null,Q=null,sp=null,cp=[],lp=null,up=null,dp={runtimeEnabled:!1,current:0,target:0},fp={quad:null},pp={currentGain:1,fullVolumeDistance:0,minimumVolumeDistance:0,lastSyncedVolume:null},mp={frameId:null,renderRequested:!0,projectionInvalidated:!0};function hp(){mp.renderRequested=!0,mp.frameId===null&&(mp.frameId=window.requestAnimationFrame(bm))}function gp(){mp.projectionInvalidated=!0,hp()}function _p(e){return!!(uf||mf||fm.w||fm.a||fm.s||fm.d||fm[` `]||fm.control||$.active||$.velocity.lengthSq()>1e-6||dm.velocity.lengthSq()>1e-6||dm.currentMouse.distanceToSquared(dm.targetMouse)>1e-6||dp.runtimeEnabled&&Math.abs(dp.current-dp.target)>.002)}function vp(){return mp.projectionInvalidated||!pf?!0:mf||uf}function yp(){qp(),ep.render(),ym(),vp()&&(Ap(),mp.projectionInvalidated=!1)}function bp(e){if(!Q)return;let t=Mt.clamp(e,0,1),n=t.toFixed(3);dp.current=t,Q.element.style.opacity!==n&&(Q.element.style.opacity=n)}function xp(e){Q?.element&&(Q.element.style.pointerEvents!==e&&(Q.element.style.pointerEvents=e),sp&&sp.style.pointerEvents!==e&&(sp.style.pointerEvents=e))}function Sp(e,t){return[e[0]*t[0]+e[1]*t[3]+e[2]*t[6],e[0]*t[1]+e[1]*t[4]+e[2]*t[7],e[0]*t[2]+e[1]*t[5]+e[2]*t[8],e[3]*t[0]+e[4]*t[3]+e[5]*t[6],e[3]*t[1]+e[4]*t[4]+e[5]*t[7],e[3]*t[2]+e[4]*t[5]+e[5]*t[8],e[6]*t[0]+e[7]*t[3]+e[8]*t[6],e[6]*t[1]+e[7]*t[4]+e[8]*t[7],e[6]*t[2]+e[7]*t[5]+e[8]*t[8]]}function Cp(e,t){return[e[0]*t[0]+e[1]*t[1]+e[2]*t[2],e[3]*t[0]+e[4]*t[1]+e[5]*t[2],e[6]*t[0]+e[7]*t[1]+e[8]*t[2]]}function wp(e){return[e[4]*e[8]-e[5]*e[7],e[2]*e[7]-e[1]*e[8],e[1]*e[5]-e[2]*e[4],e[5]*e[6]-e[3]*e[8],e[0]*e[8]-e[2]*e[6],e[2]*e[3]-e[0]*e[5],e[3]*e[7]-e[4]*e[6],e[1]*e[6]-e[0]*e[7],e[0]*e[4]-e[1]*e[3]]}function Tp(e,t,n,r,i,a,o,s){let c=[e,n,i,t,r,a,1,1,1],l=Cp(wp(c),[o,s,1]);return Sp(c,[l[0],0,0,0,l[1],0,0,0,l[2]])}function Ep(e,t,n){let r=Tp(0,0,e,0,e,t,0,t),i=Sp(Tp(n[0].x,n[0].y,n[1].x,n[1].y,n[2].x,n[2].y,n[3].x,n[3].y),wp(r)),a=i.map(e=>e/i[8]);return`matrix3d(${[a[0],a[3],0,a[6],a[1],a[4],0,a[7],0,0,1,0,a[2],a[5],0,a[8]].map(e=>Number.isFinite(e)?e.toFixed(10):`0`).join(`,`)})`}function Dp(e){if(e.clone().applyMatrix4(Z.matrixWorldInverse).z>=-.001)return null;let t=e.clone().project(Z);return!Number.isFinite(t.x)||!Number.isFinite(t.y)?null:{x:(t.x*.5+.5)*window.innerWidth,y:(-t.y*.5+.5)*window.innerHeight}}function Op(){if(!Q)return null;Q.updateMatrixWorld(!0);let e=[new H(-Mf.width/2,Mf.height/2,0),new H(Mf.width/2,Mf.height/2,0),new H(Mf.width/2,-Mf.height/2,0),new H(-Mf.width/2,-Mf.height/2,0)],t=[];for(let n of e){let e=Dp(n.applyMatrix4(Q.matrixWorld));if(!e)return null;t.push(e)}return t}function kp(){Q?.element&&(Q.element.style.display=`none`,fp.quad=null)}function Ap(){if(!Q?.element||!sp?.src){kp();return}Z.updateMatrixWorld(!0),Z.updateProjectionMatrix();let e=Op();if(!e){kp();return}let t=Ep(Mf.width,Mf.height,e),{element:n}=Q;fp.quad=e,n.style.display!==`block`&&(n.style.display=`block`),n.style.transform!==t&&(n.style.transform=t)}function jp(e,t){if(!fp.quad||fp.quad.length!==4)return!1;let n=0;for(let r=0;r<fp.quad.length;r+=1){let i=fp.quad[r],a=fp.quad[(r+1)%fp.quad.length],o=(a.x-i.x)*(t-i.y)-(a.y-i.y)*(e-i.x);if(Math.abs(o)<=.5)continue;let s=Math.sign(o);if(n===0){n=s;continue}if(n!==s)return!1}return!0}function Mp(e){e.traverse(e=>{e.isMesh&&(e.name.toLowerCase().includes(`screen_plane`)||e.name.toLowerCase().includes(`hitbox`)||(Array.isArray(e.material)?e.material:[e.material]).forEach(e=>{Af.includes(e)||(Af.push(e),e.onBeforeCompile=t=>{e.userData.shader=t,t.uniforms.uShockwaveRadius={value:0},t.uniforms.uShockwaveCenter={value:jf},t.uniforms.uEdgeIntensity={value:X.loader.shockwave.edgeIntensity},t.vertexShader=`
        ...
        `.replace(`#include <dithering_fragment>`,`
          ...
          `)})}))})}function Np(e){return e.wrapS=r,e.wrapT=i,new wa({transparent:!0,uniforms:{tSky:{value:e},uExposure:{value:Uf.exposure},uSaturation:{value:Uf.saturation},uHighlights:{value:Uf.highlights},uRepeat:{value:new V(Uf.repeatX,Uf.repeatY)},uOffsetY:{value:Uf.offsetY},uSkyOpacity:{value:0}},vertexShader:`varying vec2 vUv; void main() { vUv = uv; gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0); }`,fragmentShader:`
    ...
    `,side:0,toneMapped:!1})}var Pp={computer:{path:`/textures/computer shadow.png`}},Fp={room:{path:`/textures/room baked.png`},table:{path:`/textures/table baked.png`},chairBack:{path:`/textures/chair back final.png`},chairLeft:{path:`/textures/chair left final.png`},chairRight:{path:`/textures/chair right final.png`}},Ip={computer:{envMapIntensity:10.95,roughnessMin:.8}};function Lp(e){e.map&&(e.map.colorSpace=He),e.emissiveMap&&(e.emissiveMap.colorSpace=He)}function Rp(e){let t=e.getAttribute(`uv`);if(!t)return;let n=new Float32Array(t.array.length);n.set(t.array),e.setAttribute(`uv1`,new xr(n,t.itemSize))}function zp(e){return e.includes(`room`)||e.includes(`wall`)||e.includes(`floor`)||e.includes(`ceiling`)?`room`:(e.includes(`table`)||e.includes(`desk`))&&!e.includes(`portable`)?`table`:e.includes(`chair_back`)||e.includes(`chair`)&&e.includes(`back`)?`chairBack`:e.includes(`chair_left`)||e.includes(`chair`)&&e.includes(`left`)?`chairLeft`:e.includes(`chair_right`)||e.includes(`chair`)&&e.includes(`right`)?`chairRight`:null}function Bp(e){return e.includes(`computer`)||e.includes(`pc`)||e.includes(`monitor`)||e.includes(`portable`)||e.includes(`bm86`)?`computer`:null}async function Vp(e,t={}){let n=await rp.loadAsync(e);return n.flipY=t.flipY??!1,t.colorSpace&&(n.colorSpace=t.colorSpace),n}function Hp(){let e=document.createElement(`div`);e.style.width=`${Mf.width}px`,e.style.height=`${Mf.height}px`,e.style.backgroundColor=`#ffffff`,e.style.backfaceVisibility=`hidden`,e.style.position=`fixed`,e.style.left=`0`,e.style.top=`0`,e.style.overflow=`hidden`,e.style.pointerEvents=`none`,e.style.display=`none`,e.style.opacity=`0`,e.style.transformOrigin=`0 0`,e.style.willChange=`transform, opacity`,e.style.zIndex=`2`;let t=document.createElement(`iframe`);return t.style.position=`absolute`,t.style.left=`0`,t.style.top=`0`,t.style.width=`100%`,t.style.height=`100%`,t.style.border=`0`,t.style.backgroundColor=`#ffffff`,t.style.pointerEvents=`none`,t.allow=`autoplay`,e.appendChild(t),sp=t,pp.lastSyncedVolume=null,e}function Up(e){if(!e||Q)return;let t=Hp();Q=new On,Q.element=t,Vf.add(Q),document.body.appendChild(t),e.updateWorldMatrix(!0,!1),e.geometry.computeBoundingBox();let n=e.geometry.boundingBox,r=new H;n.getCenter(r);let i=r.applyMatrix4(e.matrixWorld);Q.position.copy(i),Q.rotation.set(Mf.rotationX,Mf.rotationY,Mf.rotationZ,`YXZ`),Q.translateZ(Mf.offsetZ),Q.translateX(Mf.offsetX),Q.translateY(Mf.offsetY);let a=new H;n.getSize(a);let o=[a.x,a.y,a.z].sort((e,t)=>t-e),s=o[0]/Mf.width*Mf.scaleMultiplier*Mf.scaleX,c=o[1]/Mf.height*Mf.scaleMultiplier*Mf.scaleY;Q.scale.set(s,c,1),Q.updateMatrixWorld(!0);let l=new H(0,0,1).applyQuaternion(Q.quaternion).normalize();Of.copy(Q.position).addScaledVector(l,X.focus.distance),Of.y+=X.focus.yOffset,kf.copy(Q.position),kf.x+=X.focus.targetOffsetX,kf.y+=X.focus.targetOffsetY,kf.z+=X.focus.targetOffsetZ,pp.fullVolumeDistance=Of.distanceTo(Q.position),pp.minimumVolumeDistance=Math.max(pp.fullVolumeDistance+1e-4,Yf.distanceTo(Q.position),X.intro.startPos.distanceTo(Q.position),X.unfocus.endPos.distanceTo(Q.position)),pp.currentGain=Gp(Z.position.distanceTo(Q.position)),gp()}function Wp(e){return Mt.clamp(e,0,1)}function Gp(e){let t=pp.fullVolumeDistance,n=Math.max(pp.minimumVolumeDistance,t+1e-4);if(!(t>0)||!(n>t)||e<=t)return 1;if(e>=n)return qf.minVolumeRatio;let r=(e-t)/(n-t),i=r*r*(3-2*r);return Mt.lerp(1,qf.minVolumeRatio,i)}function Kp(e){return Wp(e*pp.currentGain)}function qp(){if(!Q||!sp||!Qp)return;let e=Gp(Z.position.distanceTo(Q.position));Math.abs(e-pp.currentGain)<.001||(pp.currentGain=e,Xp(Qp.getState().volume))}function Jp(){!sp||sp.getAttribute(`src`)||(sp.src=Mf.url,gp(),sp.addEventListener(`load`,()=>{Yp(Qp.getState().isMuted),Xp(Qp.getState().volume),gp()},{once:!0}))}function Yp(e){sp?.contentWindow&&sp.contentWindow.postMessage({type:Tf.SET_MUTED,muted:!!e},window.location.origin)}function Xp(e){if(!sp?.contentWindow)return;let t=Kp(e);pp.lastSyncedVolume!==null&&Math.abs(pp.lastSyncedVolume-t)<qf.volumeSyncEpsilon||(pp.lastSyncedVolume=t,sp.contentWindow.postMessage({type:Tf.SET_VOLUME,volume:t},window.location.origin))}function Zp(){let e=(Array.isArray(Kf.sources)?Kf.sources:[Kf.src]).filter(Boolean),t=new Audio;t.preload=`auto`,t.loop=Kf.loop,t.volume=Kf.initialVolume,t.playsInline=!0;let n=!1,r=!0,i=0,a=null,o=0,s=null,c=0,l=null,u=null,d={hasSource:e.length>0,hasError:!1,isMuted:!1,isPlaying:!1,needsUserGesture:!1,unlockArmed:!1,volume:Kf.initialVolume,wantsToPlay:Kf.defaultWantsToPlay},f=()=>e[o]||``,p=()=>{let e=f();return e?(t.getAttribute(`src`)!==e&&(t.src=e),!0):(t.removeAttribute(`src`),!1)},m=()=>o>=e.length-1?!1:(o+=1,n=!1,p()),h=()=>{typeof l==`function`&&l({...d,currentSource:f()})},g=()=>{a!==null&&(window.clearTimeout(a),a=null)},_=()=>{i=0,g()},v=(e,n=240)=>!d.wantsToPlay||d.needsUserGesture?!1:a===null?i>=12?!1:(a=window.setTimeout(()=>{a=null,i+=1,t.readyState===0&&!d.hasError&&t.load(),k(`${e}-retry-${i}`)},n),!0):!0,y=({restoreVolume:e=!1}={})=>{c+=1,s!==null&&(window.cancelAnimationFrame(s),s=null),e&&(t.volume=Wp(d.volume))},b=e=>{if(t.paused||t.muted||r||t.volume<=.001){e();return}y();let n=c,i=t.volume,a=performance.now(),o=r=>{if(n!==c)return;let l=Math.min((r-a)/Df,1);if(t.volume=Mt.lerp(i,0,l),l<1){s=window.requestAnimationFrame(o);return}s=null,e()};s=window.requestAnimationFrame(o)},x=(e=!1)=>{t.muted=e||d.isMuted||r,t.volume=Wp(d.volume)},S=async()=>{if(!d.hasSource||n)return!1;x(!0);try{return await t.play(),_(),n=!0,d.hasError=!1,d.isPlaying=!0,d.needsUserGesture=!1,O(),h(),!0}catch{return x(),v(`prime-muted-autoplay`),!1}},C=()=>!n||t.paused?!1:(y({restoreVolume:!0}),t.currentTime=0,x(),_(),d.hasError=!1,d.isPlaying=!0,d.needsUserGesture=!1,O(),h(),!0),w=()=>{if(!n||t.paused)return!1;t.pause();try{t.currentTime=0}catch{return!1}return d.isPlaying=!1,!0},T=(e=`timeline-sync`)=>{if(!r){d.wantsToPlay&&!d.isPlaying?k(e):(x(),h());return}if(r=!1,d.needsUserGesture=!1,d.hasError=!1,_(),O(),x(),!d.wantsToPlay){h();return}k(w()?`${e}-restart-from-zero`:e)},E=()=>{window.setTimeout(()=>{t.currentTime<.25&&(t.currentTime=0),x(),h()},80)},D=async()=>{x(!0);try{return await t.play(),_(),d.hasError=!1,d.isPlaying=!0,d.needsUserGesture=!1,O(),E(),h(),!0}catch{return x(),!1}},O=()=>{!d.unlockArmed||!u||([`pointerdown`,`keydown`,`touchstart`].forEach(e=>{window.removeEventListener(e,u,!0)}),u=null,d.unlockArmed=!1)},ee=()=>{d.unlockArmed||=(u=()=>{O(),d.wantsToPlay&&k(`user-gesture`)},[`pointerdown`,`keydown`,`touchstart`].forEach(e=>{window.addEventListener(e,u,!0)}),!0)},k=async(e=`manual`)=>{if(d.wantsToPlay=!0,y({restoreVolume:!0}),!d.hasSource)return h(),!1;if(C())return!0;d.hasError&&=(t.load(),!1),x();try{return await t.play(),_(),d.hasError=!1,d.isPlaying=!0,d.needsUserGesture=!1,O(),h(),!0}catch(n){return d.isPlaying=!t.paused,n?.name===`NotAllowedError`?await D()||(d.hasError=!1,v(`autoplay-blocked`)||(d.needsUserGesture=!0,ee())):n?.name===`AbortError`||n?.name===`NotSupportedError`?(d.hasError=!1,v(n.name===`AbortError`?`media-aborted`:`media-not-ready`)||(d.hasError=!0)):(d.hasError=!0,console.warn(`[BGM] Unable to play audio (${e}).`,n)),h(),!1}},te=()=>{d.wantsToPlay=!1,d.needsUserGesture=!1,_(),O(),b(()=>{t.pause(),y({restoreVolume:!0}),d.isPlaying=!1,h()})},A=()=>{if(d.isPlaying||d.wantsToPlay){te();return}k(`toggle`)},j=e=>{let t=()=>{d.isMuted=e,x(),Yp(d.isMuted),h()};if(e!==d.isMuted){if(e){b(t);return}y({restoreVolume:!0}),t()}};return t.addEventListener(`play`,()=>{d.isPlaying=!0,h()}),t.addEventListener(`pause`,()=>{d.isPlaying=!1,h()}),t.addEventListener(`ended`,()=>{d.isPlaying=!1,h()}),t.addEventListener(`canplay`,()=>{d.wantsToPlay&&!d.isPlaying&&!d.needsUserGesture&&v(`canplay`,0)}),t.addEventListener(`error`,()=>{let e=t.error?.code??null;if(e===1||e===null){v(`media-load-aborted`);return}if(e===4){if(m()){_(),d.hasError=!1,d.isPlaying=!1,t.load(),d.wantsToPlay&&(r?S():k(`media-source-fallback`)),h();return}if(v(`media-source-error`,320))return}d.hasError=!0,d.isPlaying=!1,console.warn(`[BGM] Audio source could not be loaded: ${f()}`),h()}),x(),d.hasSource&&p()&&(t.load(),d.wantsToPlay&&S()),{getState(){return{...d,currentSource:f()}},pause:te,play:k,releaseQueuedPlayback:T,setVolume:e=>{y(),d.volume=Wp(e),d.volume>0&&d.isMuted&&(d.isMuted=!1),x(),Xp(d.volume),Yp(d.isMuted),h()},setOnChange(e){l=e,h()},toggleMute:()=>{j(!d.isMuted)},togglePlay:A}}var Qp=Zp(),$p={soundOn:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M15.54 8.46a5 5 0 0 1 0 7.07"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14"/></svg>`,soundOff:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><line x1="23" y1="9" x2="17" y2="15"/><line x1="17" y1="9" x2="23" y2="15"/></svg>`,play:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round"><polygon points="8 5 19 12 8 19 8 5"/></svg>`,pause:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="9" y1="5" x2="9" y2="19"/><line x1="15" y1="5" x2="15" y2="19"/></svg>`,volumeLow:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M15 12a3 3 0 0 0 0-0.01"/></svg>`,volumeMid:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M15.5 9.5a4 4 0 0 1 0 5"/></svg>`,volumeHigh:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M15.5 8.5a5.5 5.5 0 0 1 0 7"/><path d="M18.8 6a9 9 0 0 1 0 12"/></svg>`,camUnfocused:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/><circle cx="12" cy="13" r="4"/></svg>`,camFocused:`<svg width="13" height="13" viewBox="0 0 24 24" fill="#ff7b00" stroke="#ff7b00" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/><circle cx="12" cy="13" r="4"/></svg>`},em={wasd:`<svg width="46" height="30" viewBox="0 0 46 30" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`};function tm(){hf&&(pf?hf.innerHTML=$p.camFocused:hf.innerHTML=$p.camUnfocused)}function nm(e){return e>=.75?$p.volumeHigh:e>=.4?$p.volumeMid:$p.volumeLow}function rm(e){return e.isMuted?`Muted`:`${Math.round(e.volume*100)}%`}function im(){wf!==null&&(window.clearTimeout(wf),wf=null)}function am(){im(),Cf&&(wf=window.setTimeout(()=>{om(!1)},Ef))}function om(e){Cf=e,yf&&yf.classList.toggle(`is-open`,Cf),Cf?am():im()}function sm(e=Qp.getState()){gf&&(gf.innerHTML=e.isMuted?$p.soundOff:$p.soundOn,gf.title=e.isMuted?`Unmute all audio`:`Mute all audio`),_f&&(_f.innerHTML=e.isPlaying||e.wantsToPlay?$p.pause:$p.play,e.hasError?_f.title=`BGM unavailable (${e.currentSource||`no source`})`:e.needsUserGesture&&!e.isPlaying?_f.title=`Click to start music`:e.wantsToPlay&&!e.isPlaying?_f.title=`Music queued to start`:_f.title=e.isPlaying?`Pause music`:`Play music`),vf&&(vf.innerHTML=nm(e.volume),vf.title=`Adjust volume (${Math.round(e.volume*100)}%)`),bf&&(bf.value=`${Math.round(e.volume*100)}`),xf&&(xf.textContent=rm(e))}Qp.setOnChange(sm);function cm(){let e=document.createElement(`style`);e.textContent=`
    #ui-tl {
      position: fixed; top: 18px; left: 18px; z-index: 100;
      display: flex; align-items: center; gap: 10px;
      opacity: 0; transition: opacity ${Gf.fadeDuration}s ease;
      font-family: "Controller W01 Two Oblique", 'Courier New', Courier, monospace;
  ...
  `,document.head.appendChild(e);let t=document.createElement(`div`);t.id=`ui-tl`;let n=document.createElement(`span`);n.id=`ui-name`,n.textContent=`Hanqi Zhao`,_f=document.createElement(`button`),_f.className=`ui-btn`,_f.addEventListener(`click`,()=>{Qp.togglePlay()});let r=document.createElement(`div`);Sf=r,r.className=`ui-volume-control`,vf=document.createElement(`button`),vf.className=`ui-btn`,vf.addEventListener(`click`,()=>{om(!Cf)}),yf=document.createElement(`div`),yf.className=`ui-volume-panel`;let i=document.createElement(`div`);i.className=`ui-volume-title`,i.innerHTML=`<span>Volume</span>`,xf=document.createElement(`span`),xf.className=`ui-volume-value`,i.appendChild(xf),bf=document.createElement(`input`),bf.className=`ui-volume-slider`,bf.type=`range`,bf.min=`0`,bf.max=`100`,bf.step=`1`,bf.addEventListener(`input`,e=>{Qp.setVolume(Number(e.target.value)/100),am()}),yf.appendChild(i),yf.appendChild(bf),r.appendChild(vf),r.appendChild(yf),gf=document.createElement(`button`),gf.className=`ui-btn`,gf.addEventListener(`click`,()=>{Qp.toggleMute()}),hf=document.createElement(`button`),hf.className=`ui-btn`,hf.innerHTML=$p.camUnfocused,hf.title=`Toggle focus`,hf.addEventListener(`click`,()=>{mf||!df||(pf?(pf=!1,tm(),gm(Z.position.clone(),np.target.clone(),X.unfocus.endPos,X.unfocus.endTarget,X.unfocus.duration,X.unfocus.easing)):(pf=!0,tm(),gm(Z.position.clone(),np.target.clone(),Of,kf,X.focus.duration,X.focus.easing)))}),t.appendChild(n),t.appendChild(_f),t.appendChild(r),t.appendChild(gf),t.appendChild(hf),document.body.appendChild(t),document.addEventListener(`pointerdown`,e=>{if(Cf){if(Sf?.contains(e.target)){am();return}om(!1)}}),document.addEventListener(`pointermove`,()=>{Cf&&am()}),document.addEventListener(`wheel`,()=>{Cf&&am()},{passive:!0}),document.addEventListener(`keydown`,e=>{if(e.key===`Escape`){om(!1);return}Cf&&am()}),sm();let a=document.createElement(`div`);a.id=`ui-bl`,a.innerHTML=`
    <div class="ui-hint">${em.wasd}<span>: move</span></div>
    <div class="ui-hint">${em.space}<span>: up</span></div>
    <div class="ui-hint">${em.ctrl}<span>: down</span></div>
  `,document.body.appendChild(a);let o=document.createElement(`div`);return o.id=`ui-br`,o.innerHTML=`<div class="ui-copy">© Copyright 2026 Hanqi Zhao.</div>`,document.body.appendChild(o),{tl:t,bl:a,br:o}}async function lm(){try{let[e,t,n,r,i]=await Promise.all([ap.loadAsync(`/textures/new_sky.hdr`),ap.loadAsync(`/textures/room.hdr`),ip.loadAsync(`/models/room_all.glb`),Promise.all(Object.entries(Fp).map(async([e,t])=>[e,await Vp(t.path,{colorSpace:He})])),Promise.all(Object.entries(Pp).map(async([e,t])=>{let n=await Vp(t.path,{colorSpace:``});return n.channel=1,[e,n]}))]),a=Object.fromEntries(r),o=Object.fromEntries(i),s=new ga(200,60,40);s.scale(-1,1,1),up=new ci(s,Np(e)),up.position.y=-100,up.rotation.y=Uf.rotationY,Vf.add(up),t.mapping=303,Vf.environment=t,Vf.environmentIntensity=1.2;let c=n.scene;if(c.traverse(e=>{if(!e.isMesh)return;let t=(e.name??``).toLowerCase();(t.includes(`computer`)||t.includes(`screen`)||t.includes(`monitor`))&&cp.push(e),t.includes(`screen_plane`)&&(op=e,jf.setFromMatrixPosition(e.matrixWorld),jf.add(X.loader.shockwave.centerOffset),op.material=new Xr({colorWrite:!1,depthWrite:!0}),op.renderOrder=-1)}),Mp(c),c.traverse(e=>{if(!e.isMesh)return;let t=(e.name??``).toLowerCase();t.includes(`screen_plane`)||(Array.isArray(e.material)?e.material:[e.material]).forEach(n=>{if(!n)return;Lp(n);let r=zp(t),i=Bp(t);if(r&&a[r]){n.map=a[r],n.needsUpdate=!0;return}n.isMeshStandardMaterial&&i&&o[i]&&(Rp(e.geometry),n.lightMap=o[i],Ip[i]&&(n.envMapIntensity=Ip[i].envMapIntensity,n.roughness<Ip[i].roughnessMin&&(n.roughness=Ip[i].roughnessMin)),n.needsUpdate=!0)})}),Vf.add(c),cp.length>0){let e=new Qn;cp.forEach(t=>{t.updateMatrixWorld(!0),e.union(new Qn().setFromObject(t))});let t=new H;e.getCenter(t);let n=new H;e.getSize(n),lp=new ci(new ma(n.x,n.y,n.z),new Xr({colorWrite:!1,depthWrite:!1,transparent:!0,opacity:0})),lp.position.copy(t),lp.scale.setScalar(X.focus.hitboxScale),Vf.add(lp),op||(jf.copy(t),jf.add(X.loader.shockwave.centerOffset))}op&&Up(op),await Promise.all([Rf,new Promise(e=>setTimeout(e,X.loader.minLoadTime))]),await zf(),If.style.opacity=`0`,await new Promise(e=>setTimeout(e,X.loader.fadeTime*1e3)),If.remove(),Jp();let l=cm();{let e=performance.now(),t=!1,n=e=>e===1?1:1-2**(-10*e),r=e=>e<.5?4*e*e*e:1-(-2*e+2)**3/2;function i(){let a=(performance.now()-e)/1e3;if(!df){let e=X.loader.cameraPush,t=0;a>=e.startTime&&(t=Math.min((a-e.startTime)/e.duration,1)),Z.position.lerpVectors(Yf,X.intro.startPos,r(t)),Z.lookAt(np.target)}let o=X.loader.shockwave,s=0;a>=o.startTime&&(s=Math.min((a-o.startTime)/o.duration,1));let c=Mt.lerp(o.startRadius,o.endRadius,n(s));s>=1&&(c=9999),Af.forEach(e=>{e.userData.shader&&(e.userData.shader.uniforms.uShockwaveRadius.value=c)});let u=X.loader.skyFade,d=0;a>=u.startTime&&(d=Math.min((a-u.startTime)/u.duration,1)),up&&up.material&&(up.material.uniforms.uSkyOpacity.value=d),!df&&a>=X.loader.controlsUnlockTime&&(df=!0,dm.locked=!0,dm.targetMouse.set(0,0),dm.currentMouse.set(0,0),dm.lockBaseMouse.copy(um),mm());let f=X.loader.screenFade;a>=f.startTime&&!ff&&(ff=!0,dp.runtimeEnabled=!1,Q&&(Q.element.style.transition=`opacity ${f.duration}s ease-in-out`,requestAnimationFrame(()=>{Q.element.style.opacity=`1`,setTimeout(()=>{Q&&(Q.element.style.transition=``,dp.runtimeEnabled=!0,dp.target=1,bp(1))},f.duration*1e3+100)}))),!t&&a>=Gf.appearAt&&(t=!0,l.tl.style.opacity=`1`,l.bl.style.opacity=`1`,l.br.style.opacity=`1`),a<Math.max(X.loader.cameraPush.startTime+X.loader.cameraPush.duration,o.startTime+o.duration,u.startTime+u.duration,f.startTime+f.duration,X.loader.controlsUnlockTime)?requestAnimationFrame(i):uf=!1}i()}}catch(e){console.error(e)}}var um=new V,dm={locked:!0,lockBaseMouse:new V,targetMouse:new V,currentMouse:new V,velocity:new V},fm={w:!1,a:!1,s:!1,d:!1," ":!1,control:!1},pm=performance.now();function mm(){pm=performance.now()}window.addEventListener(`pointermove`,e=>{um.x=e.clientX/window.innerWidth*2-1,um.y=-(e.clientY/window.innerHeight)*2+1,df&&(mm(),!mf&&!pf&&dm.locked&&um.distanceTo(dm.lockBaseMouse)>X.parallax.unlockThreshold&&(dm.locked=!1),hp())}),window.addEventListener(`keydown`,e=>{if(!df)return;mm();let t=e.key.toLowerCase();t===` `&&e.preventDefault(),fm[t]!==void 0&&(fm[t]=!0),hp()},{passive:!1}),window.addEventListener(`keyup`,e=>{if(!df)return;mm();let t=e.key.toLowerCase();fm[t]!==void 0&&(fm[t]=!1),hp()}),window.addEventListener(`wheel`,()=>{df&&(mm(),hp())}),Xf.domElement.addEventListener(`contextmenu`,e=>e.preventDefault());var hm={linear:e=>e,easeOutCubic:e=>1-(1-e)**3,easeInOutCubic:e=>e<.5?4*e*e*e:1-(-2*e+2)**3/2};function gm(e,t,n,r,i,a,o){mf=!0;let s=performance.now(),c=hm[a]||hm.easeInOutCubic;hp();function l(){let a=(performance.now()-s)/i;a>1&&(a=1);let u=c(a);Z.position.lerpVectors(e,n,u),np.target.lerpVectors(t,r,u),Z.lookAt(np.target),Z.updateProjectionMatrix(),hp(),a<1?requestAnimationFrame(l):(mf=!1,$.velocity.set(0,0,0),dm.locked=!0,dm.lockBaseMouse.copy(um),dm.targetMouse.set(0,0),dm.currentMouse.set(0,0),dm.velocity.set(0,0),mm(),o&&o(),hp())}l()}var _m=new Xo,vm=0;Xf.domElement.addEventListener(`pointerdown`,e=>{!df||mf||(mm(),vm=performance.now(),hp())}),Xf.domElement.addEventListener(`pointerup`,e=>{if(!(!df||mf)){if(performance.now()-vm<300){if(um.x=e.clientX/window.innerWidth*2-1,um.y=-(e.clientY/window.innerHeight)*2+1,pf){if(jp(e.clientX,e.clientY))return;pf=!1,tm(),gm(Z.position.clone(),np.target.clone(),X.unfocus.endPos,X.unfocus.endTarget,X.unfocus.duration,X.unfocus.easing);return}_m.setFromCamera(um,Z);let t=lp?[lp]:cp;if(_m.intersectObjects(t,!0).length>0&&Q){let e=new H(0,0,1).applyQuaternion(Q.quaternion).normalize(),t=new H().subVectors(Z.position,Q.position).normalize();e.angleTo(t)*(180/Math.PI)<=X.focus.maxTriggerAngle&&(pf=!0,tm(),gm(Z.position.clone(),np.target.clone(),Of,kf,X.focus.duration,X.focus.easing))}}hp()}});function ym(){if(!op||!Q)return;let e=pf&&!mf&&!!sp?.src;if(!ff){xp(e?`auto`:`none`);return}if(!dp.runtimeEnabled){xp(e?`auto`:`none`);return}let t=new H(0,0,1).applyQuaternion(Q.quaternion).normalize(),n=new H().subVectors(Z.position,Q.position).normalize(),r=Z.position.distanceTo(Q.position),i=t.dot(n)>=0,a=0,o=`none`;if(e)a=1,o=`auto`;else if(i){let e=X.shield.maxClickDistance+X.shield.fadeDistance;if(r<=X.shield.maxClickDistance)a=1;else if(r>=e)a=X.shield.dimOpacity;else{let e=1-(r-X.shield.maxClickDistance)/X.shield.fadeDistance;a=Mt.lerp(X.shield.dimOpacity,1,e)}}dp.target=a;let s=Mt.lerp(dp.current,dp.target,X.shield.opacityLerp);bp(Math.abs(s-dp.target)<.002?dp.target:s),xp(o)}var $={active:!1,chargeStart:0,releaseStart:0,dist:0,currentDir:new H,velocity:new H};function bm(){mp.frameId=null;let e=performance.now();if(!_p(e)&&!mp.renderRequested)return;if(up&&_p(e)&&(up.rotation.y+=X.sky.rotationSpeed),!df){yp(),mp.renderRequested=!1,_p(performance.now())&&hp();return}if(!pf&&!mf){let t=new H;Z.getWorldDirection(t),t.y=0,t.normalize();let n=new H().crossVectors(t,Z.up).normalize(),r=new H(0,1,0),i=new H;fm.w&&i.add(t),fm.s&&i.sub(t),fm.a&&i.sub(n),fm.d&&i.add(n),fm[` `]&&i.add(r),fm.control&&i.sub(r),i.lengthSq()>0?($.releaseStart=0,$.active?$.currentDir.lerp(i.normalize(),X.walk.dirLerp).normalize():($.chargeStart===0&&($.chargeStart=e),e-$.chargeStart>X.walk.chargeTime&&($.active=!0,$.dist=0,$.currentDir.copy(i.normalize())))):($.chargeStart=0,$.active&&($.releaseStart===0&&($.releaseStart=e),e-$.releaseStart>X.walk.releaseGrace&&($.active=!1))),$.active&&$.dist>=X.walk.maxDist&&($.active=!1);let a=new H;if($.active?(a.copy($.currentDir).multiplyScalar(X.walk.speed),$.velocity.lerp(a,X.walk.acceleration)):$.velocity.lerp(a,X.walk.deceleration),$.velocity.lengthSq()>1e-6){$.dist+=$.velocity.length();let e=$.velocity.clone(),t=X.walk.bounds,n=X.walk.dampingZone;e.x<0&&Z.position.x-t.minX<n?e.x*=Math.max(0,(Z.position.x-t.minX)/n):e.x>0&&t.maxX-Z.position.x<n&&(e.x*=Math.max(0,(t.maxX-Z.position.x)/n)),e.y<0&&Z.position.y-t.minY<n?e.y*=Math.max(0,(Z.position.y-t.minY)/n):e.y>0&&t.maxY-Z.position.y<n&&(e.y*=Math.max(0,(t.maxY-Z.position.y)/n)),e.z<0&&Z.position.z-t.minZ<n?e.z*=Math.max(0,(Z.position.z-t.minZ)/n):e.z>0&&t.maxZ-Z.position.z<n&&(e.z*=Math.max(0,(t.maxZ-Z.position.z)/n));let r=Z.position.clone().add(e);r.x<=t.minX?(r.x=t.minX,$.velocity.x=0):r.x>=t.maxX&&(r.x=t.maxX,$.velocity.x=0),r.y<=t.minY?(r.y=t.minY,$.velocity.y=0):r.y>=t.maxY&&(r.y=t.maxY,$.velocity.y=0),r.z<=t.minZ?(r.z=t.minZ,$.velocity.z=0):r.z>=t.maxZ&&(r.z=t.maxZ,$.velocity.z=0);let i=new H().subVectors(r,Z.position);Z.position.copy(r),np.target.add(i)}}Z.lookAt(np.target);let t=Z.quaternion.clone(),n=e-pm>X.parallax.idleTimeout;pf||mf||n||dm.locked?dm.targetMouse.lerp(new V(0,0),X.parallax.catchupSpeed):dm.targetMouse.lerp(um,X.parallax.catchupSpeed);let r=new V().subVectors(dm.targetMouse,dm.currentMouse);dm.velocity.add(r.multiplyScalar(X.parallax.springAccel)),dm.velocity.multiplyScalar(1-X.parallax.springFriction),dm.currentMouse.add(dm.velocity);let i=dm.currentMouse.y*Mt.degToRad(X.parallax.maxAngle),a=-dm.currentMouse.x*Mt.degToRad(X.parallax.maxAngle);Z.rotateX(i),Z.rotateY(a),yp(),Z.quaternion.copy(t),mp.renderRequested=!1,_p(performance.now())&&hp()}window.addEventListener(`resize`,()=>{Z.aspect=window.innerWidth/window.innerHeight,Z.updateProjectionMatrix(),Xf.setSize(window.innerWidth,window.innerHeight),ep.setSize(window.innerWidth,window.innerHeight),gp()}),lm(),hp();