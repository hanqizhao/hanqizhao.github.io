...
`);this.workerSourceURL=URL.createObjectURL(new Blob([i])),this.transcoderBinary=n,this.workerPool.setWorkerCreator(()=>{let e=new Worker(this.workerSourceURL),t=this.transcoderBinary.slice(0);return e.postMessage({type:`init`,config:this.workerConfig,transcoderBinary:t},[t]),e})}),vf>0&&console.warn(`THREE.KTX2Loader: Multiple active KTX2 loaders may cause performance issues. Use a single KTX2Loader instance, or call .dispose() on old instances.`),vf++}return this.transcoderPending}load(e,t,n,r){if(this.workerConfig===null)throw Error("THREE.KTX2Loader: Missing initialization with `.detectSupport( renderer )`.");let i=new oo(this.manager);i.setPath(this.path),i.setCrossOrigin(this.crossOrigin),i.setWithCredentials(this.withCredentials),i.setRequestHeader(this.requestHeader),i.setResponseType(`arraybuffer`),i.load(e,e=>{this.parse(e,t,r)},n,r)}parse(e,t,n){if(this.workerConfig===null)throw Error("THREE.KTX2Loader: Missing initialization with `.detectSupport( renderer )`.");if(_f.has(e))return _f.get(e).promise.then(t).catch(n);this._createTexture(e).then(e=>t?t(e):null).catch(n)}_createTextureFrom(e,t){let{type:n,error:r,data:{faces:i,width:a,height:o,format:s,type:c,dfdFlags:u}}=e;if(n===`error`)return Promise.reject(r);let f;if(t.faceCount===6)f=new pa(i,s,c);else{let e=i[0].mipmaps;f=t.layerCount>1?new fa(e,a,o,t.layerCount,s,c):new da(e,a,o,s,c)}return f.minFilter=i[0].mipmaps.length===1?l:d,f.magFilter=l,f.generateMipmaps=!1,f.needsUpdate=!0,f.colorSpace=Tf(t),f.premultiplyAlpha=!!(u&1),f}async _createTexture(e,t={}){let n=cf(new Uint8Array(e)),r=n.vkFormat===1000066e3&&n.dataFormatDescriptor[0].colorModel===167;if(!(n.vkFormat===0||r&&!this.workerConfig.astcHDRSupported))return wf(n);let i=t,a=this.init().then(()=>this.workerPool.postMessage({type:`transcode`,buffer:e,taskConfig:i},[e])).then(e=>this._createTextureFrom(e.data,n));return _f.set(e,{promise:a}),a}dispose(){this.workerPool.dispose(),this.workerSourceURL&&URL.revokeObjectURL(this.workerSourceURL),vf--}};bf.BasisFormat={ETC1S:0,UASTC:1,UASTC_HDR:2},bf.TranscoderFormat={ETC1:0,ETC2:1,BC1:2,BC3:3,BC4:4,BC5:5,BC7_M6_OPAQUE_ONLY:6,BC7_M5:7,PVRTC1_4_RGB:8,PVRTC1_4_RGBA:9,ASTC_4x4:10,ATC_RGB:11,ATC_RGBA_INTERPOLATED_ALPHA:12,RGBA32:13,RGB565:14,BGR565:15,RGBA4444:16,BC6H:22,RGB_HALF:24,RGBA_HALF:25},bf.EngineFormat={RGBAFormat:D,RGBA_ASTC_4x4_Format:_e,RGB_BPTC_UNSIGNED_Format:Me,RGBA_BPTC_Format:N,RGBA_ETC2_EAC_Format:fe,RGBA_PVRTC_4BPPV1_Format:ce,RGBA_S3TC_DXT5_Format:ae,RGB_ETC1_Format:ue,RGB_ETC2_Format:de,RGB_PVRTC_4BPPV1_Format:oe,RGBA_S3TC_DXT1_Format:re},bf.EngineType={UnsignedByteType:f,HalfFloatType:y,FloatType:v},bf.BasisWorker=function(){let e,t,n,r=_EngineFormat,i=_EngineType,a=_TranscoderFormat,o=_BasisFormat;self.addEventListener(`message`,function(n){let r=n.data;switch(r.type){case`init`:e=r.config,s(r.transcoderBinary);break;case`transcode`:t.then(()=>{try{let{faces:e,buffers:t,width:n,height:i,hasAlpha:a,format:o,type:s,dfdFlags:l}=c(r.buffer);self.postMessage({type:`transcode`,id:r.id,data:{faces:e,width:n,height:i,hasAlpha:a,format:o,type:s,dfdFlags:l}},t)}catch(e){console.error(e),self.postMessage({type:`error`,id:r.id,error:e.message})}});break}});function s(e){t=new Promise(t=>{n={wasmBinary:e,onRuntimeInitialized:t},BASIS(n)}).then(()=>{n.initializeBasis(),n.KTX2File===void 0&&console.warn(`THREE.KTX2Loader: Please update Basis Universal transcoder.`)})}function c(e){let t=new n.KTX2File(new Uint8Array(e));function r(){t.close(),t.delete()}if(!t.isValid())throw r(),Error(`THREE.KTX2Loader:	Invalid or unsupported .ktx2 file`);let a;if(t.isUASTC())a=o.UASTC;else if(t.isETC1S())a=o.ETC1S;else if(t.isHDR())a=o.UASTC_HDR;else throw Error(`THREE.KTX2Loader: Unknown Basis encoding`);let s=t.getWidth(),c=t.getHeight(),l=t.getLayers()||1,u=t.getLevels(),f=t.getFaces(),m=t.getHasAlpha(),h=t.getDFDFlags(),{transcoderFormat:g,engineFormat:_,engineType:v}=d(a,s,c,m);if(!s||!c||!u)throw r(),Error(`THREE.KTX2Loader:	Invalid texture`);if(!t.startTranscoding())throw r(),Error(`THREE.KTX2Loader: .startTranscoding failed`);let y=[],b=[];for(let e=0;e<f;e++){let n=[];for(let a=0;a<u;a++){let o=[],s,c;for(let n=0;n<l;n++){let l=t.getImageLevelInfo(a,n,e);e===0&&a===0&&n===0&&(l.origWidth%4!=0||l.origHeight%4!=0)&&console.warn(`THREE.KTX2Loader: ETC1S and UASTC textures should use multiple-of-four dimensions.`),u>1?(s=l.origWidth,c=l.origHeight):(s=l.width,c=l.height);let d=new Uint8Array(t.getImageTranscodedSizeInBytes(a,n,0,g)),f=t.transcodeImage(d,a,n,e,g,0,-1,-1);if(v===i.HalfFloatType&&(d=new Uint16Array(d.buffer,d.byteOffset,d.byteLength/Uint16Array.BYTES_PER_ELEMENT)),!f)throw r(),Error(`THREE.KTX2Loader: .transcodeImage failed.`);o.push(d)}let d=p(o);n.push({data:d,width:s,height:c}),b.push(d.buffer)}y.push({mipmaps:n,width:s,height:c,format:_,type:v})}return r(),{faces:y,buffers:b,width:s,height:c,hasAlpha:m,dfdFlags:h,format:_,type:v}}let l=[{if:`astcSupported`,basisFormat:[o.UASTC],transcoderFormat:[a.ASTC_4x4,a.ASTC_4x4],engineFormat:[r.RGBA_ASTC_4x4_Format,r.RGBA_ASTC_4x4_Format],engineType:[i.UnsignedByteType],priorityETC1S:1/0,priorityUASTC:1,needsPowerOfTwo:!1},{if:`bptcSupported`,basisFormat:[o.ETC1S,o.UASTC],transcoderFormat:[a.BC7_M5,a.BC7_M5],engineFormat:[r.RGBA_BPTC_Format,r.RGBA_BPTC_Format],engineType:[i.UnsignedByteType],priorityETC1S:3,priorityUASTC:2,needsPowerOfTwo:!1},{if:`dxtSupported`,basisFormat:[o.ETC1S,o.UASTC],transcoderFormat:[a.BC1,a.BC3],engineFormat:[r.RGBA_S3TC_DXT1_Format,r.RGBA_S3TC_DXT5_Format],engineType:[i.UnsignedByteType],priorityETC1S:4,priorityUASTC:5,needsPowerOfTwo:!1},{if:`etc2Supported`,basisFormat:[o.ETC1S,o.UASTC],transcoderFormat:[a.ETC1,a.ETC2],engineFormat:[r.RGB_ETC2_Format,r.RGBA_ETC2_EAC_Format],engineType:[i.UnsignedByteType],priorityETC1S:1,priorityUASTC:3,needsPowerOfTwo:!1},{if:`etc1Supported`,basisFormat:[o.ETC1S,o.UASTC],transcoderFormat:[a.ETC1],engineFormat:[r.RGB_ETC1_Format],engineType:[i.UnsignedByteType],priorityETC1S:2,priorityUASTC:4,needsPowerOfTwo:!1},{if:`pvrtcSupported`,basisFormat:[o.ETC1S,o.UASTC],transcoderFormat:[a.PVRTC1_4_RGB,a.PVRTC1_4_RGBA],engineFormat:[r.RGB_PVRTC_4BPPV1_Format,r.RGBA_PVRTC_4BPPV1_Format],engineType:[i.UnsignedByteType],priorityETC1S:5,priorityUASTC:6,needsPowerOfTwo:!0},{if:`bptcSupported`,basisFormat:[o.UASTC_HDR],transcoderFormat:[a.BC6H],engineFormat:[r.RGB_BPTC_UNSIGNED_Format],engineType:[i.HalfFloatType],priorityHDR:1,needsPowerOfTwo:!1},{basisFormat:[o.ETC1S,o.UASTC],transcoderFormat:[a.RGBA32,a.RGBA32],engineFormat:[r.RGBAFormat,r.RGBAFormat],engineType:[i.UnsignedByteType,i.UnsignedByteType],priorityETC1S:100,priorityUASTC:100,needsPowerOfTwo:!1},{basisFormat:[o.UASTC_HDR],transcoderFormat:[a.RGBA_HALF],engineFormat:[r.RGBAFormat],engineType:[i.HalfFloatType],priorityHDR:100,needsPowerOfTwo:!1}],u={[o.ETC1S]:l.filter(e=>e.basisFormat.includes(o.ETC1S)).sort((e,t)=>e.priorityETC1S-t.priorityETC1S),[o.UASTC]:l.filter(e=>e.basisFormat.includes(o.UASTC)).sort((e,t)=>e.priorityUASTC-t.priorityUASTC),[o.UASTC_HDR]:l.filter(e=>e.basisFormat.includes(o.UASTC_HDR)).sort((e,t)=>e.priorityHDR-t.priorityHDR)};function d(t,n,r,i){let a=u[t];for(let o=0;o<a.length;o++){let s=a[o];if(!(s.if&&!e[s.if])&&s.basisFormat.includes(t)&&!(i&&s.transcoderFormat.length<2)&&!(s.needsPowerOfTwo&&!(f(n)&&f(r))))return{transcoderFormat:s.transcoderFormat[i?1:0],engineFormat:s.engineFormat[i?1:0],engineType:s.engineType[0]}}throw Error(`THREE.KTX2Loader: Failed to identify transcoding target.`)}function f(e){return e<=2?!0:(e&e-1)==0&&e!==0}function p(e){if(e.length===1)return e[0];let t=0;for(let n=0;n<e.length;n++){let r=e[n];t+=r.byteLength}let n=new Uint8Array(t),r=0;for(let t=0;t<e.length;t++){let i=e[t];n.set(i,r),r+=i.byteLength}return n}};var xf=new Set([D,E,A,k]),Sf={109:D,103:A,100:k,97:D,83:A,76:k,43:D,37:D,22:A,16:A,15:k,9:k,123:E,122:E,152:fe,148:de,153:pe,154:me,155:he,156:ge,[nf]:_e,158:_e,157:_e,[rf]:xe,166:xe,165:xe,134:re,133:re,132:M,131:M,138:ae,137:ae,140:P,139:Ne,142:F,141:Pe,146:N,145:N,[tf]:ce,[$d]:ce,[ef]:le,[Qd]:le},Cf={109:v,103:v,100:v,97:y,83:y,76:y,43:f,37:f,22:f,16:f,15:f,9:f,123:C,122:w,152:f,148:f,153:f,154:f,155:f,156:f,[nf]:y,158:f,157:f,[rf]:y,166:f,165:f,134:f,133:f,132:f,131:f,138:f,137:f,140:f,139:f,142:f,141:f,146:f,145:f,[tf]:f,[$d]:f,[ef]:f,[Qd]:f};async function wf(e){let{vkFormat:t}=e;if(Sf[t]===void 0)throw Error(`THREE.KTX2Loader: Unsupported vkFormat: `+t);Cf[t]===void 0&&console.warn(`THREE.KTX2Loader: Missing ".type" for vkFormat: `+t);let n;e.supercompressionScheme===2&&(yf||=new Promise(async e=>{let t=new pf;await t.init(),e(t)}),n=await yf);let r=[];for(let i=0;i<e.levels.length;i++){let a=Math.max(1,e.pixelWidth>>i),o=Math.max(1,e.pixelHeight>>i),s=e.pixelDepth?Math.max(1,e.pixelDepth>>i):0,c=e.levels[i],l;if(e.supercompressionScheme===0)l=c.levelData;else if(e.supercompressionScheme===2)l=n.decode(c.levelData,c.uncompressedByteLength);else throw Error(`THREE.KTX2Loader: Unsupported supercompressionScheme.`);let u;u=Cf[t]===1015?new Float32Array(l.buffer,l.byteOffset,l.byteLength/Float32Array.BYTES_PER_ELEMENT):Cf[t]===1016?new Uint16Array(l.buffer,l.byteOffset,l.byteLength/Uint16Array.BYTES_PER_ELEMENT):Cf[t]===35902||Cf[t]===35899?new Uint32Array(l.buffer,l.byteOffset,l.byteLength/Uint32Array.BYTES_PER_ELEMENT):l,r.push({data:u,width:a,height:o,depth:s})}let i=e.levelCount===0||r.length>1,a;if(xf.has(Sf[t]))a=e.pixelDepth===0?new Ci(r[0].data,e.pixelWidth,e.pixelHeight):new tn(r[0].data,e.pixelWidth,e.pixelHeight,e.pixelDepth),a.minFilter=i?s:o,a.magFilter=o,a.generateMipmaps=e.levelCount===0;else{if(e.pixelDepth>0)throw Error(`THREE.KTX2Loader: Unsupported pixelDepth.`);a=new da(r,e.pixelWidth,e.pixelHeight),a.minFilter=i?d:l,a.magFilter=l}return a.mipmaps=r,a.type=Cf[t],a.format=Sf[t],a.colorSpace=Tf(e),a.needsUpdate=!0,Promise.resolve(a)}function Tf(e){let t=e.dataFormatDescriptor[0];return t.colorPrimaries===1?t.transferFunction===2?Ue:We:t.colorPrimaries===10?t.transferFunction===2?hf:gf:(t.colorPrimaries===0||console.warn(`THREE.KTX2Loader: Unsupported color primaries, "${t.colorPrimaries}"`),``)}var Ef={name:`CopyShader`,uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		}`},zf=class extends Df{constructor(){super(),this.isOutputPass=!0,this.uniforms=Ta.clone(Rf.uniforms),this.material=new ka({name:Rf.name,uniforms:this.uniforms,vertexShader:Rf.vertexShader,fragmentShader:Rf.fragmentShader}),this._fsQuad=new Af(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},U.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Bf=new URLSearchParams(window.location.search),Vf=Bf.get(`benchmark`)===`1`||Bf.get(`bench`)===`1`,Hf=`slim`,Uf={current:{visualSkyLdr:new URL(`/assets/new_sky_ldr-yZ_KpEae.jpg`,``+import.meta.url).href,lightingLdr:new URL(`/assets/room_ldr-DOcZ7og-.jpg`,``+import.meta.url).href,room:new URL(`/assets/room%20baked-KoBuYlPf.ktx2`,``+import.meta.url).href,table:new URL(`/assets/table%20baked-DFp0K4D2.ktx2`,``+import.meta.url).href,chairBack:new URL(`/assets/chair%20back%20final-sbWclMz4.ktx2`,``+import.meta.url).href,chairLeft:new URL(`/assets/chair%20left%20final-BjZ_O-yh.ktx2`,``+import.meta.url).href,chairRight:new URL(`/assets/chair%20right%20final-BtcJ8_ie.ktx2`,``+import.meta.url).href,computer:new URL(`/assets/computer%20shadow-D5HsGwbv.ktx2`,``+import.meta.url).href}},Wf={label:`Slim`,visualSky:{kind:`ldr`,path:Uf.current.visualSkyLdr,flipY:!0},lightingEnvironment:{kind:`ldr`,path:Uf.current.lightingLdr,flipY:!0,intensity:1.2},bakedSurfacePaths:{room:Uf.current.room,table:Uf.current.table,chairBack:Uf.current.chairBack,chairLeft:Uf.current.chairLeft,chairRight:Uf.current.chairRight},lightMapPaths:{computer:Uf.current.computer}},Gf=!0,Kf=!1,qf=!1,Jf=!1,Yf=!1,Xf=null,Zf=null,Qf=null,$f=null,ep=null,tp=null,np=null,rp=null,ip=null,ap=null,op=null,sp=null,cp=null,lp=null,up=!1,dp=null,fp=!1,pp=null,mp={SET_MUTED:`outer-website:set-global-audio-muted`,SET_VOLUME:`outer-website:set-global-audio-volume`},hp=`outer-website:postfx-settings`,gp=2200,_p=220,vp=2,yp=1e3/24,bp=1e3/10,xp=1e-4,Sp=.01,Cp=[4,2,0],wp=new V,Tp=new V,Ep=[],Dp=new V(0,0,0),Op={lastRenderMs:0,avgRenderMs:0,avgFrameMs:0,fps:0,lastUiUpdate:0,lastFrameNow:0};function kp(e,t=vp){if(e===!0)return vp;if(e===!1||e==null)return t;let n=Number(e);return n>=4?4:n>=2?2:0}function Ap(e){return e>=4?`4x`:e>=2?`2x`:`Off`}function jp(){let e={bloomEnabled:!0,msaaSamples:vp};try{let t=window.localStorage.getItem(hp);if(!t)return e;let n=JSON.parse(t);return{bloomEnabled:n?.bloomEnabled!==!1,msaaSamples:kp(n?.msaaSamples??n?.msaaEnabled,e.msaaSamples)}}catch{return e}}var Mp=jp();function Np(){try{window.localStorage.setItem(hp,JSON.stringify(Mp))}catch{}}var Pp={url:`/winxp/index.html#/`,width:1280,height:820,rotationX:-Math.PI*15.5/180,rotationY:Math.PI/2,rotationZ:0,flipNormal:!1,scaleMultiplier:1,scaleX:.99,scaleY:1.01,offsetX:0,offsetY:6e-4,offsetZ:0},Y={loader:{bgColor:`#d9d9d9`,minLoadTime:1500,fadeTime:1,cameraPush:{startTime:1.5,duration:1,distance:.5},shockwave:{startTime:.5,duration:5.5,startRadius:0,endRadius:20,edgeWidth:.2,edgeIntensity:3,centerOffset:new V(-4,-1,0)},skyFade:{startTime:.5,duration:1},screenFade:{startTime:2.5,duration:6.5},controlsUnlockTime:2.5},intro:{startPos:new V(4.3,-1.8,0),startTarget:new V(0,-1.4,0)},focus:{duration:2e3,easing:`easeInOutCubic`,distance:.18,yOffset:0,maxTriggerAngle:60,targetOffsetX:0,targetOffsetY:0,targetOffsetZ:0,hitboxScale:1.8},unfocus:{duration:1800,easing:`easeOutCubic`,endPos:new V(4.5,-1.8,0),endTarget:new V(0,-1.4,0)},shield:{maxClickDistance:1.2,dimOpacity:.8,fadeDistance:.55,opacityLerp:.14},sky:{rotationSpeed:3e-5},parallax:{maxAngle:6,unlockThreshold:.2,springAccel:.004,springFriction:.06,catchupSpeed:.03,idleTimeout:3e3},walk:{chargeTime:80,releaseGrace:50,maxDist:1e3,speed:.011,acceleration:.6,deceleration:.6,dirLerp:1,dampingZone:.8,bounds:{minX:2,maxX:5,minY:-2,maxY:1.5,minZ:-3.5,maxZ:3.5}}};document.body.style.backgroundColor=Y.loader.bgColor,document.body.style.margin=`0`,document.body.style.overflow=`hidden`;var Fp=document.createElement(`link`);Fp.rel=`stylesheet`,Fp.href=`https://db.onlinewebfonts.com/c/35ea0eae14a5c7ee380c2d62cd367fe9?family=Controller+W01+Two+Oblique`,document.head.appendChild(Fp);var Ip=document.createElement(`link`);Ip.rel=`stylesheet`,Ip.href=`https://db.onlinewebfonts.com/c/8a7a89e31c8ccec1c446bb97e9e6cc07?family=Controller+W01+Five+Oblique`,document.head.appendChild(Ip);var Lp=document.createElement(`style`);Lp.textContent=`
  #hud-loader-root {
    ...
    transition: opacity ${Y.loader.fadeTime}s ease-in-out;
  }
  .hud-laser {
...
`,document.head.appendChild(Lp);var Rp=document.createElement(`div`);Rp.id=`hud-loader-root`,Rp.innerHTML=`
  ...
  <div class="hud-core">
    ...
    <div class="hud-start-prompt" id="hud-start-prompt">Click anywhere to start</div>
  </div>`,document.body.appendChild(Rp);var zp,Bp=new Promise(e=>{zp=e});(function(){let e=Rp.querySelector(`#hud-bar`),t=Rp.querySelector(`#hud-hex`),n=Rp.querySelector(`#hud-status`);for(let t=0;t<18;t++){let t=document.createElement(`div`);t.className=`hud-block`,e.appendChild(t)}let r=e.querySelectorAll(`.hud-block`),i=0;function a(){i+=Math.random()*2+1,i>100&&(i=100);let e=Math.round(i/100*18);r.forEach((t,n)=>t.classList.toggle(`lit`,n<e)),t.textContent=`0x`+Math.floor(Math.random()*65535).toString(16).toUpperCase(),i<100?setTimeout(a,Math.random()*100+20):(n.textContent=`Boot sequence complete.`,setTimeout(zp,800))}setTimeout(a,1e3)})();function Vp(){return new Promise(e=>{let t=Rp.querySelector(`.hud-core`);if(!t){pp=null,e();return}let n=!1,r=t=>{n||(n=!0,pp=null,Rp.removeEventListener(`pointerdown`,i,!0),Rp.removeEventListener(`keydown`,a,!0),typeof xh?.releaseQueuedPlayback==`function`&&xh.releaseQueuedPlayback(t),e())},i=e=>{e.preventDefault(),r(`loader-start-pointer`)},a=e=>{e.key!==`Enter`&&e.key!==` `||(e.preventDefault(),r(`loader-start-keyboard`))};t.classList.add(`is-awaiting-start`),pp=()=>{r(`loader-start-debug`)},Rp.tabIndex=0,Rp.focus({preventScroll:!0}),Rp.addEventListener(`pointerdown`,i,!0),Rp.addEventListener(`keydown`,a,!0)})}var Hp=document.getElementById(`app`),Up=new Rn,Wp={fov:65,near:.1,far:1e3},Gp={exposure:1.1,saturation:1.25,highlights:.95,repeatX:2,repeatY:1.2,offsetY:0,rotationY:-3*Math.PI/4},Kp={exposure:.9,bloom:{strength:.01,radius:0,threshold:0}},qp={appearAt:3,fadeDuration:1},Jp={sources:[`/audio/outer-bgm.ogg`,`/audio/outer-bgm.m4a`],loop:!0,initialVolume:.56,defaultWantsToPlay:!0},Yp={minVolumeRatio:.2,volumeSyncEpsilon:.003},X=new wo(Wp.fov,window.innerWidth/window.innerHeight,Wp.near,Wp.far),Xp=new V().subVectors(Y.intro.startTarget,Y.intro.startPos).normalize(),Zp=Y.intro.startPos.clone().addScaledVector(Xp,-Y.loader.cameraPush.distance);X.position.copy(Zp);var Qp=new xu({antialias:!0,alpha:!0});function $p(){return Math.min(window.devicePixelRatio,2)}Qp.setPixelRatio($p()),Qp.setSize(window.innerWidth,window.innerHeight),Qp.setClearColor(0,1),Qp.outputColorSpace=Ue,Qp.useLegacyLights=!1,Qp.toneMapping=4,Qp.toneMappingExposure=Kp.exposure,Hp.style.position=`relative`,Hp.style.backgroundColor=`#000000`,Qp.domElement.style.position=`absolute`,Qp.domElement.style.top=`0`,Qp.domElement.style.left=`0`,Qp.domElement.style.zIndex=`1`,Qp.domElement.style.pointerEvents=`auto`,Hp.appendChild(Qp.domElement);var em=null,tm=null,nm=null,rm=null,im=null;function am(e=Mp.msaaSamples){let t=kp(e,0);if(t<=0)return 0;let n=Qp.capabilities.maxSamples??0;return n>=t?t:n>=4?4:n>=2?2:0}function om(){tm?.dispose&&tm.dispose(),rm?.dispose&&rm.dispose(),im?.dispose&&im.dispose(),em&&em.dispose(),tm=null,nm=null,rm=null,im=null,em=null}function sm(){om();let e=$p(),t=Math.max(1,Math.floor(window.innerWidth*e)),n=Math.max(1,Math.floor(window.innerHeight*e)),r=am();Qp.setPixelRatio(e),Qp.setSize(window.innerWidth,window.innerHeight),em=new $t(t,n,{samples:r,type:y}),tm=new Pf(Qp,em),nm=new Ff(Up,X),tm.addPass(nm),rm=new Lf(new B(window.innerWidth,window.innerHeight),Kp.bloom.strength,Kp.bloom.radius,Kp.bloom.threshold),rm.enabled=Mp.bloomEnabled,tm.addPass(rm),im=new zf,tm.addPass(im)}sm();function cm(){let e=$p();return{pixelRatio:e,width:Math.max(1,Math.floor(window.innerWidth*e)),height:Math.max(1,Math.floor(window.innerHeight*e))}}function lm(){let e=performance.memory;if(!e)return null;let t=e=>Number((e/(1024*1024)).toFixed(2));return{usedMB:t(e.usedJSHeapSize),totalMB:t(e.totalJSHeapSize),limitMB:t(e.jsHeapSizeLimit)}}function um(){let e=cm(),t=kp(Mp.msaaSamples,0),n=am(t),r=$?.velocity?.lengthSq?.()??0,i=Q?.velocity?.lengthSq?.()??0,a=Q?.currentMouse?.distanceToSquared?.(Q.targetMouse)??0,o=Math.abs((Em?.current??0)-(Em?.target??0)),s=Dm?.lastUpdateAt?performance.now()-Dm.lastUpdateAt:null;return{ready:!Gf,isAnimating:Yf,physicsUnlocked:Kf,focused:Jf,benchmarkMode:Vf,assetProfile:Hf,assetProfileLabel:Wf.label,bloomEnabled:Mp.bloomEnabled,requestedMsaaSamples:t,effectiveMsaaSamples:n,msaaLabel:Ap(n),avgRenderMs:Number(Op.avgRenderMs.toFixed(3)),avgFrameMs:Number(Op.avgFrameMs.toFixed(3)),fps:Number(Op.fps.toFixed(2)),resolution:e,rendererInfo:{calls:Qp.info.render.calls,triangles:Qp.info.render.triangles,lines:Qp.info.render.lines,points:Qp.info.render.points,frame:Qp.info.render.frame,geometries:Qp.info.memory.geometries,textures:Qp.info.memory.textures},jsHeap:lm(),internals:{renderRequested:km.renderRequested,projectionInvalidated:km.projectionInvalidated,hasActiveSceneAnimation:Lm(performance.now()),hasSkyAnimation:Am(),walkVelocitySq:Number(r.toFixed(8)),parallaxVelocitySq:Number(i.toFixed(8)),parallaxDeltaSq:Number(a.toFixed(8)),screenOpacityDelta:Number(o.toFixed(8)),screenProjectionAgeMs:s==null?null:Number(s.toFixed(3))}}}function dm(e=2e4){return new Promise((t,n)=>{let r=performance.now();function i(){if(!Gf){t(um());return}if(performance.now()-r>=e){n(Error(`Timed out waiting for outer scene readiness`));return}window.requestAnimationFrame(i)}i()})}function fm(e=3e4){return new Promise((t,n)=>{let r=performance.now();function i(){if(!Gf&&!Yf&&Kf){t(um());return}if(performance.now()-r>=e){n(Error(`Timed out waiting for benchmark-stable scene state`));return}window.requestAnimationFrame(i)}i()})}function pm(e=2e4){return new Promise((t,n)=>{let r=performance.now();function i(){if(typeof pp==`function`){t(!0);return}if(performance.now()-r>=e){n(Error(`Timed out waiting for loader start prompt`));return}window.requestAnimationFrame(i)}i()})}function mm(e=3e3){return new Promise((t,n)=>{let r=Math.max(250,Number(e)||3e3),i=performance.now(),a=[],o=[],s=[],c=0;function l(){let e=um(),n=e=>e.length?Number((e.reduce((e,t)=>e+t,0)/e.length).toFixed(3)):0,i=o.map(e=>e>0?1e3/e:0);t({...e,sampleDurationMs:r,sampleCount:a.length,windowAvgRenderMs:n(a),windowAvgFrameMs:n(o),windowAvgFps:n(i),windowMinFps:i.length?Number(Math.min(...i).toFixed(3)):0,windowMaxFps:i.length?Number(Math.max(...i).toFixed(3)):0,windowAvgHeapMB:n(s)})}function u(e){let t=um();if(a.push(Op.lastRenderMs||t.avgRenderMs),t.jsHeap?.usedMB!=null&&s.push(t.jsHeap.usedMB),c>0){let t=e-c;t>0&&t<250&&o.push(t)}if(c=e,performance.now()-i>=r){l();return}window.requestAnimationFrame(u)}dm().then(()=>u()).catch(n)})}window.__outerWebsiteDebug={getMetrics:um,waitForReady:dm,waitForBenchmarkStable:fm,waitForStartPrompt:pm,startExperience:()=>typeof pp==`function`?(pp(),!0):!1,sampleMetrics:mm};var hm=new Mu(X,Qp.domElement);hm.enabled=!1,hm.target.copy(Y.intro.startTarget);var gm=new uo,_m=new Zu,vm=new Xd,ym=new bf,bm=new Ku;ym.setTranscoderPath(`/basis/`),ym.detectSupport(Qp),bm.setDecoderPath(`/draco/`),bm.preload(),_m.setKTX2Loader(ym),_m.setDRACOLoader(bm);var xm=null,Z=null,Sm=null,Cm=[],wm=null,Tm=null,Em={runtimeEnabled:!1,current:0,target:0},Dm={quad:null,lastUpdateAt:0},Om={currentGain:1,fullVolumeDistance:0,minimumVolumeDistance:0,lastSyncedVolume:null},km={frameId:null,renderRequested:!0,projectionInvalidated:!0,skyFrameTimeoutId:null};function Am(){return!!Tm}function jm(e,t=Sp){return e.lengthSq()<=t*t}function Mm(e,t=xp){return e.lengthSq()<=t*t}function Nm(){km.skyFrameTimeoutId!==null&&(window.clearTimeout(km.skyFrameTimeoutId),km.skyFrameTimeoutId=null)}function Pm(){km.renderRequested=!0,Nm(),km.frameId===null&&(km.frameId=window.requestAnimationFrame(Yh))}function Fm(e=yp){km.renderRequested||km.frameId!==null||km.skyFrameTimeoutId!==null||(km.skyFrameTimeoutId=window.setTimeout(()=>{km.skyFrameTimeoutId=null,km.frameId===null&&(km.frameId=window.requestAnimationFrame(Yh))},Math.max(0,e)))}function Im(){km.projectionInvalidated=!0,Pm()}function Lm(e){return!!(Vf||Gf||Yf||Vh.w||Vh.a||Vh.s||Vh.d||Vh[` `]||Vh.control||$.active||$.velocity.lengthSq()>1e-6||Q.velocity.lengthSq()>1e-6||Q.currentMouse.distanceToSquared(Q.targetMouse)>1e-6||Em.runtimeEnabled&&Math.abs(Em.current-Em.target)>.002)}function Rm(e=performance.now(),t=!1,n=!1){return km.projectionInvalidated?!0:t?!1:Jf?!!(Yf||Gf):Yf||Gf||n||km.renderRequested?!0:e-Dm.lastUpdateAt>=bp}function zm(e=performance.now(),{skyOnly:t=!1,sceneAnimationActive:n=!1}={}){let r=performance.now();t||gh(),tm.render(),t||Jh(),Rm(e,t,n)&&(Xm(),km.projectionInvalidated=!1,Dm.lastUpdateAt=e),Ih(performance.now()-r,e)}function Bm(e){if(!Z)return;let t=Nt.clamp(e,0,1),n=t.toFixed(3);Em.current=t,Z.element.style.opacity!==n&&(Z.element.style.opacity=n)}function Vm(e){Z?.element&&(Z.element.style.pointerEvents!==e&&(Z.element.style.pointerEvents=e),Sm&&Sm.style.pointerEvents!==e&&(Sm.style.pointerEvents=e))}function Hm(e,t){return[e[0]*t[0]+e[1]*t[3]+e[2]*t[6],e[0]*t[1]+e[1]*t[4]+e[2]*t[7],e[0]*t[2]+e[1]*t[5]+e[2]*t[8],e[3]*t[0]+e[4]*t[3]+e[5]*t[6],e[3]*t[1]+e[4]*t[4]+e[5]*t[7],e[3]*t[2]+e[4]*t[5]+e[5]*t[8],e[6]*t[0]+e[7]*t[3]+e[8]*t[6],e[6]*t[1]+e[7]*t[4]+e[8]*t[7],e[6]*t[2]+e[7]*t[5]+e[8]*t[8]]}function Um(e,t){return[e[0]*t[0]+e[1]*t[1]+e[2]*t[2],e[3]*t[0]+e[4]*t[1]+e[5]*t[2],e[6]*t[0]+e[7]*t[1]+e[8]*t[2]]}function Wm(e){return[e[4]*e[8]-e[5]*e[7],e[2]*e[7]-e[1]*e[8],e[1]*e[5]-e[2]*e[4],e[5]*e[6]-e[3]*e[8],e[0]*e[8]-e[2]*e[6],e[2]*e[3]-e[0]*e[5],e[3]*e[7]-e[4]*e[6],e[1]*e[6]-e[0]*e[7],e[0]*e[4]-e[1]*e[3]]}function Gm(e,t,n,r,i,a,o,s){let c=[e,n,i,t,r,a,1,1,1],l=Um(Wm(c),[o,s,1]);return Hm(c,[l[0],0,0,0,l[1],0,0,0,l[2]])}function Km(e,t,n){let r=Gm(0,0,e,0,e,t,0,t),i=Hm(Gm(n[0].x,n[0].y,n[1].x,n[1].y,n[2].x,n[2].y,n[3].x,n[3].y),Wm(r)),a=i.map(e=>e/i[8]);return`matrix3d(${[a[0],a[3],0,a[6],a[1],a[4],0,a[7],0,0,1,0,a[2],a[5],0,a[8]].map(e=>Number.isFinite(e)?e.toFixed(10):`0`).join(`,`)})`}function qm(e){if(e.clone().applyMatrix4(X.matrixWorldInverse).z>=-.001)return null;let t=e.clone().project(X);return!Number.isFinite(t.x)||!Number.isFinite(t.y)?null:{x:(t.x*.5+.5)*window.innerWidth,y:(-t.y*.5+.5)*window.innerHeight}}function Jm(){if(!Z)return null;Z.updateMatrixWorld(!0);let e=[new V(-Pp.width/2,Pp.height/2,0),new V(Pp.width/2,Pp.height/2,0),new V(Pp.width/2,-Pp.height/2,0),new V(-Pp.width/2,-Pp.height/2,0)],t=[];for(let n of e){let e=qm(n.applyMatrix4(Z.matrixWorld));if(!e)return null;t.push(e)}return t}function Ym(){Z?.element&&(Z.element.style.display=`none`,Dm.quad=null)}function Xm(){if(!Z?.element||!Sm?.src){Ym();return}X.updateMatrixWorld(!0),X.updateProjectionMatrix();let e=Jm();if(!e){Ym();return}let t=Km(Pp.width,Pp.height,e),{element:n}=Z;Dm.quad=e,n.style.display!==`block`&&(n.style.display=`block`),n.style.transform!==t&&(n.style.transform=t)}function Zm(e,t){if(!Dm.quad||Dm.quad.length!==4)return!1;let n=0;for(let r=0;r<Dm.quad.length;r+=1){let i=Dm.quad[r],a=Dm.quad[(r+1)%Dm.quad.length],o=(a.x-i.x)*(t-i.y)-(a.y-i.y)*(e-i.x);if(Math.abs(o)<=.5)continue;let s=Math.sign(o);if(n===0){n=s;continue}if(n!==s)return!1}return!0}function Qm(e){e.traverse(e=>{e.isMesh&&(e.name.toLowerCase().includes(`screen_plane`)||e.name.toLowerCase().includes(`hitbox`)||(Array.isArray(e.material)?e.material:[e.material]).forEach(e=>{Ep.includes(e)||(Ep.push(e),e.onBeforeCompile=t=>{e.userData.shader=t,t.uniforms.uShockwaveRadius={value:0},t.uniforms.uShockwaveCenter={value:Dp},t.uniforms.uEdgeIntensity={value:Y.loader.shockwave.edgeIntensity},t.vertexShader=`
        ...
        `.replace(`#include <dithering_fragment>`,`
          ...
          float edgeWidth = ${Y.loader.shockwave.edgeWidth.toFixed(2)};
          ...
          `)})}))})}function $m(e,t={}){return e.wrapS=r,e.wrapT=i,new Oa({transparent:!0,uniforms:{tSky:{value:e},uExposure:{value:Gp.exposure},uSaturation:{value:Gp.saturation},uHighlights:{value:Gp.highlights},uRepeat:{value:new B(t.repeatX??Gp.repeatX,t.repeatY??Gp.repeatY)},uOffsetY:{value:t.offsetY??Gp.offsetY},uSkyOpacity:{value:0}},vertexShader:`varying vec2 vUv; void main() { vUv = uv; gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0); }`,fragmentShader:`
    ...
    `,side:0,toneMapped:!1})}var eh={computer:{path:Wf.lightMapPaths.computer}},th={room:{path:Wf.bakedSurfacePaths.room},table:{path:Wf.bakedSurfacePaths.table},chairBack:{path:Wf.bakedSurfacePaths.chairBack},chairLeft:{path:Wf.bakedSurfacePaths.chairLeft},chairRight:{path:Wf.bakedSurfacePaths.chairRight}},nh=new Set([`room`,`table`]),rh={computer:{envMapIntensity:10.95,roughnessMin:.8}};function ih(e){e.map&&(e.map.colorSpace=Ue),e.emissiveMap&&(e.emissiveMap.colorSpace=Ue)}function ah(e){let t=e.getAttribute(`uv`);if(!t)return;let n=new Float32Array(t.array.length);n.set(t.array),e.setAttribute(`uv1`,new Sr(n,t.itemSize))}function oh(e){return e.includes(`room`)||e.includes(`wall`)||e.includes(`floor`)||e.includes(`ceiling`)?`room`:(e.includes(`table`)||e.includes(`desk`))&&!e.includes(`portable`)?`table`:e.includes(`chair_back`)||e.includes(`chair`)&&e.includes(`back`)?`chairBack`:e.includes(`chair_left`)||e.includes(`chair`)&&e.includes(`left`)?`chairLeft`:e.includes(`chair_right`)||e.includes(`chair`)&&e.includes(`right`)?`chairRight`:null}function sh(e){return e.includes(`computer`)||e.includes(`pc`)||e.includes(`monitor`)||e.includes(`portable`)||e.includes(`bm86`)?`computer`:null}function ch(e){return nh.has(e)}async function lh(e,t={}){let n=await gm.loadAsync(e);return n.flipY=t.flipY??!1,t.colorSpace&&(n.colorSpace=t.colorSpace),n}async function uh(e,t={}){if(e.toLowerCase().endsWith(`.ktx2`)){let n=await ym.loadAsync(e);return t.colorSpace&&(n.colorSpace=t.colorSpace),n}return lh(e,t)}function dh(){let e=document.createElement(`div`);e.style.width=`${Pp.width}px`,e.style.height=`${Pp.height}px`,e.style.backgroundColor=`#ffffff`,e.style.backfaceVisibility=`hidden`,e.style.position=`fixed`,e.style.left=`0`,e.style.top=`0`,e.style.overflow=`hidden`,e.style.pointerEvents=`none`,e.style.display=`none`,e.style.opacity=`0`,e.style.transformOrigin=`0 0`,e.style.willChange=`transform, opacity`,e.style.zIndex=`2`;let t=document.createElement(`iframe`);return t.style.position=`absolute`,t.style.left=`0`,t.style.top=`0`,t.style.width=`100%`,t.style.height=`100%`,t.style.border=`0`,t.style.backgroundColor=`#ffffff`,t.style.pointerEvents=`none`,t.allow=`autoplay`,e.appendChild(t),Sm=t,Om.lastSyncedVolume=null,e}function fh(e){if(!e||Z)return;let t=dh();Z=new kn,Z.element=t,Up.add(Z),document.body.appendChild(t),e.updateWorldMatrix(!0,!1),e.geometry.computeBoundingBox();let n=e.geometry.boundingBox,r=new V;n.getCenter(r);let i=r.applyMatrix4(e.matrixWorld);Z.position.copy(i),Z.rotation.set(Pp.rotationX,Pp.rotationY,Pp.rotationZ,`YXZ`),Z.translateZ(Pp.offsetZ),Z.translateX(Pp.offsetX),Z.translateY(Pp.offsetY);let a=new V;n.getSize(a);let o=[a.x,a.y,a.z].sort((e,t)=>t-e),s=o[0]/Pp.width*Pp.scaleMultiplier*Pp.scaleX,c=o[1]/Pp.height*Pp.scaleMultiplier*Pp.scaleY;Z.scale.set(s,c,1),Z.updateMatrixWorld(!0);let l=new V(0,0,1).applyQuaternion(Z.quaternion).normalize();wp.copy(Z.position).addScaledVector(l,Y.focus.distance),wp.y+=Y.focus.yOffset,Tp.copy(Z.position),Tp.x+=Y.focus.targetOffsetX,Tp.y+=Y.focus.targetOffsetY,Tp.z+=Y.focus.targetOffsetZ,Om.fullVolumeDistance=wp.distanceTo(Z.position),Om.minimumVolumeDistance=Math.max(Om.fullVolumeDistance+1e-4,Zp.distanceTo(Z.position),Y.intro.startPos.distanceTo(Z.position),Y.unfocus.endPos.distanceTo(Z.position)),Om.currentGain=mh(X.position.distanceTo(Z.position)),Im()}function ph(e){return Nt.clamp(e,0,1)}function mh(e){let t=Om.fullVolumeDistance,n=Math.max(Om.minimumVolumeDistance,t+1e-4);if(!(t>0)||!(n>t)||e<=t)return 1;if(e>=n)return Yp.minVolumeRatio;let r=(e-t)/(n-t),i=r*r*(3-2*r);return Nt.lerp(1,Yp.minVolumeRatio,i)}function hh(e){return ph(e*Om.currentGain)}function gh(){if(!Z||!Sm||!xh)return;let e=mh(X.position.distanceTo(Z.position));Math.abs(e-Om.currentGain)<.001||(Om.currentGain=e,yh(xh.getState().volume))}function _h(){!Sm||Sm.getAttribute(`src`)||(Sm.src=Pp.url,Im(),Sm.addEventListener(`load`,()=>{vh(xh.getState().isMuted),yh(xh.getState().volume),Im()},{once:!0}))}function vh(e){Sm?.contentWindow&&Sm.contentWindow.postMessage({type:mp.SET_MUTED,muted:!!e},window.location.origin)}function yh(e){if(!Sm?.contentWindow)return;let t=hh(e);Om.lastSyncedVolume!==null&&Math.abs(Om.lastSyncedVolume-t)<Yp.volumeSyncEpsilon||(Om.lastSyncedVolume=t,Sm.contentWindow.postMessage({type:mp.SET_VOLUME,volume:t},window.location.origin))}function bh(){let e=(Array.isArray(Jp.sources)?Jp.sources:[Jp.src]).filter(Boolean),t=new Audio;t.preload=`auto`,t.loop=Jp.loop,t.volume=Jp.initialVolume,t.playsInline=!0;let n=!1,r=!0,i=0,a=null,o=0,s=null,c=0,l=null,u=null,d={hasSource:e.length>0,hasError:!1,isMuted:!1,isPlaying:!1,needsUserGesture:!1,unlockArmed:!1,volume:Jp.initialVolume,wantsToPlay:Jp.defaultWantsToPlay},f=()=>e[o]||``,p=()=>{let e=f();return e?(t.getAttribute(`src`)!==e&&(t.src=e),!0):(t.removeAttribute(`src`),!1)},m=()=>o>=e.length-1?!1:(o+=1,n=!1,p()),h=()=>{typeof l==`function`&&l({...d,currentSource:f()})},g=()=>{a!==null&&(window.clearTimeout(a),a=null)},_=()=>{i=0,g()},v=(e,n=240)=>!d.wantsToPlay||d.needsUserGesture?!1:a===null?i>=12?!1:(a=window.setTimeout(()=>{a=null,i+=1,t.readyState===0&&!d.hasError&&t.load(),k(`${e}-retry-${i}`)},n),!0):!0,y=({restoreVolume:e=!1}={})=>{c+=1,s!==null&&(window.cancelAnimationFrame(s),s=null),e&&(t.volume=ph(d.volume))},b=e=>{if(t.paused||t.muted||r||t.volume<=.001){e();return}y();let n=c,i=t.volume,a=performance.now(),o=r=>{if(n!==c)return;let l=Math.min((r-a)/_p,1);if(t.volume=Nt.lerp(i,0,l),l<1){s=window.requestAnimationFrame(o);return}s=null,e()};s=window.requestAnimationFrame(o)},x=(e=!1)=>{t.muted=e||d.isMuted||r,t.volume=ph(d.volume)},S=async()=>{if(!d.hasSource||n)return!1;x(!0);try{return await t.play(),_(),n=!0,d.hasError=!1,d.isPlaying=!0,d.needsUserGesture=!1,O(),h(),!0}catch{return x(),v(`prime-muted-autoplay`),!1}},C=()=>!n||t.paused?!1:(y({restoreVolume:!0}),t.currentTime=0,x(),_(),d.hasError=!1,d.isPlaying=!0,d.needsUserGesture=!1,O(),h(),!0),w=()=>{if(!n||t.paused)return!1;t.pause();try{t.currentTime=0}catch{return!1}return d.isPlaying=!1,!0},T=(e=`timeline-sync`)=>{if(!r){d.wantsToPlay&&!d.isPlaying?k(e):(x(),h());return}if(r=!1,d.needsUserGesture=!1,d.hasError=!1,_(),O(),x(),!d.wantsToPlay){h();return}k(w()?`${e}-restart-from-zero`:e)},E=()=>{window.setTimeout(()=>{t.currentTime<.25&&(t.currentTime=0),x(),h()},80)},D=async()=>{x(!0);try{return await t.play(),_(),d.hasError=!1,d.isPlaying=!0,d.needsUserGesture=!1,O(),E(),h(),!0}catch{return x(),!1}},O=()=>{!d.unlockArmed||!u||([`pointerdown`,`keydown`,`touchstart`].forEach(e=>{window.removeEventListener(e,u,!0)}),u=null,d.unlockArmed=!1)},ee=()=>{d.unlockArmed||=(u=()=>{O(),d.wantsToPlay&&k(`user-gesture`)},[`pointerdown`,`keydown`,`touchstart`].forEach(e=>{window.addEventListener(e,u,!0)}),!0)},k=async(e=`manual`)=>{if(d.wantsToPlay=!0,y({restoreVolume:!0}),!d.hasSource)return h(),!1;if(C())return!0;d.hasError&&=(t.load(),!1),x();try{return await t.play(),_(),d.hasError=!1,d.isPlaying=!0,d.needsUserGesture=!1,O(),h(),!0}catch(n){return d.isPlaying=!t.paused,n?.name===`NotAllowedError`?await D()||(d.hasError=!1,v(`autoplay-blocked`)||(d.needsUserGesture=!0,ee())):n?.name===`AbortError`||n?.name===`NotSupportedError`?(d.hasError=!1,v(n.name===`AbortError`?`media-aborted`:`media-not-ready`)||(d.hasError=!0)):(d.hasError=!0,console.warn(`[BGM] Unable to play audio (${e}).`,n)),h(),!1}},te=()=>{d.wantsToPlay=!1,d.needsUserGesture=!1,_(),O(),b(()=>{t.pause(),y({restoreVolume:!0}),d.isPlaying=!1,h()})},A=()=>{if(d.isPlaying||d.wantsToPlay){te();return}k(`toggle`)},j=e=>{let t=()=>{d.isMuted=e,x(),vh(d.isMuted),h()};if(e!==d.isMuted){if(e){b(t);return}y({restoreVolume:!0}),t()}};return t.addEventListener(`play`,()=>{d.isPlaying=!0,h()}),t.addEventListener(`pause`,()=>{d.isPlaying=!1,h()}),t.addEventListener(`ended`,()=>{d.isPlaying=!1,h()}),t.addEventListener(`canplay`,()=>{d.wantsToPlay&&!d.isPlaying&&!d.needsUserGesture&&v(`canplay`,0)}),t.addEventListener(`error`,()=>{let e=t.error?.code??null;if(e===1||e===null){v(`media-load-aborted`);return}if(e===4){if(m()){_(),d.hasError=!1,d.isPlaying=!1,t.load(),d.wantsToPlay&&(r?S():k(`media-source-fallback`)),h();return}if(v(`media-source-error`,320))return}d.hasError=!0,d.isPlaying=!1,console.warn(`[BGM] Audio source could not be loaded: ${f()}`),h()}),x(),d.hasSource&&p()&&(t.load(),d.wantsToPlay&&S()),{getState(){return{...d,currentSource:f()}},pause:te,play:k,releaseQueuedPlayback:T,setVolume:e=>{y(),d.volume=ph(e),d.volume>0&&d.isMuted&&(d.isMuted=!1),x(),yh(d.volume),vh(d.isMuted),h()},setOnChange(e){l=e,h()},toggleMute:()=>{j(!d.isMuted)},togglePlay:A}}var xh=bh(),Sh={soundOn:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M15.54 8.46a5 5 0 0 1 0 7.07"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14"/></svg>`,soundOff:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><line x1="23" y1="9" x2="17" y2="15"/><line x1="17" y1="9" x2="23" y2="15"/></svg>`,play:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round"><polygon points="8 5 19 12 8 19 8 5"/></svg>`,pause:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="9" y1="5" x2="9" y2="19"/><line x1="15" y1="5" x2="15" y2="19"/></svg>`,volumeLow:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M15 12a3 3 0 0 0 0-0.01"/></svg>`,volumeMid:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M15.5 9.5a4 4 0 0 1 0 5"/></svg>`,volumeHigh:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M15.5 8.5a5.5 5.5 0 0 1 0 7"/><path d="M18.8 6a9 9 0 0 1 0 12"/></svg>`,camUnfocused:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/><circle cx="12" cy="13" r="4"/></svg>`,camFocused:`<svg width="13" height="13" viewBox="0 0 24 24" fill="#ff7b00" stroke="#ff7b00" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/><circle cx="12" cy="13" r="4"/></svg>`,fx:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 7h8"/><path d="M4 17h14"/><path d="M14 7h6"/><path d="M10 17h4"/><circle cx="12" cy="7" r="2"/><circle cx="8" cy="17" r="2"/></svg>`},Ch={wasd:`<svg width="46" height="30" viewBox="0 0 46 30" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="16.5" y="0.5"  width="13" height="13" rx="2" stroke="#ff7b00" stroke-width="1.3"/>
    <text x="23"   y="7"  text-anchor="middle" dominant-baseline="central" font-size="12" fill="#ff7b00" font-family="Courier New,monospace">W</text>
    <rect x="0.5"  y="16.5" width="13" height="13" rx="2" stroke="#ff7b00" stroke-width="1.3"/>
    <text x="7"    y="23" text-anchor="middle" dominant-baseline="central" font-size="12" fill="#ff7b00" font-family="Courier New,monospace">A</text>
    <rect x="16.5" y="16.5" width="13" height="13" rx="2" stroke="#ff7b00" stroke-width="1.3"/>
    <text x="23"   y="23" text-anchor="middle" dominant-baseline="central" font-size="12" fill="#ff7b00" font-family="Courier New,monospace">S</text>
    <rect x="32.5" y="16.5" width="13" height="13" rx="2" stroke="#ff7b00" stroke-width="1.3"/>
    <text x="39"   y="23" text-anchor="middle" dominant-baseline="central" font-size="12" fill="#ff7b00" font-family="Courier New,monospace">D</text>
    ...
    <text x="25" y="7" text-anchor="middle" dominant-baseline="central" font-size="12" fill="#ff7b00" font-family="Courier New,monospace">CTRL</text>
  </svg>`};function wh(){Xf&&(Jf?Xf.innerHTML=Sh.camFocused:Xf.innerHTML=Sh.camUnfocused)}function Th(e){return e>=.75?Sh.volumeHigh:e>=.4?Sh.volumeMid:Sh.volumeLow}function Eh(e){return e.isMuted?`Muted`:`${Math.round(e.volume*100)}%`}function Dh(){dp!==null&&(window.clearTimeout(dp),dp=null)}function Oh(){Dh(),up&&(dp=window.setTimeout(()=>{kh(!1)},gp))}function kh(e){e&&fp&&Nh(!1),up=e,ep&&ep.classList.toggle(`is-open`,up),up?Oh():Dh()}function Ah(){return`Bloom ${Mp.bloomEnabled?`On`:`Off`} | MSAA ${Ap(Mp.msaaSamples)}`}function jh(e,t,n,r=`On`,i=`Off`){e&&(e.classList.toggle(`is-active`,n),e.innerHTML=`<span>${t}</span><strong>${n?r:i}</strong>`)}function Mh(){if(ip&&(ip.classList.toggle(`is-active`,fp),ip.title=Ah()),ap&&ap.classList.toggle(`is-open`,fp),jh(sp,`Bloom`,Mp.bloomEnabled),jh(cp,`MSAA`,kp(Mp.msaaSamples,0)>0,Ap(Mp.msaaSamples)),cp&&(cp.title=`Cycle MSAA: 4x, 2x, Off`),op){let e=$p(),t=Math.max(1,Math.floor(window.innerWidth*e)),n=Math.max(1,Math.floor(window.innerHeight*e)),r=Op.avgRenderMs>0?Op.avgRenderMs.toFixed(1):`0.0`,i=performance.now()-Op.lastFrameNow>500?0:Math.round(Op.fps);op.textContent=`Avg ${r} ms | FPS ${i} | ${t}x${n}`}}function Nh(e){e&&up&&kh(!1),fp=e,Mh(),Pm()}function Ph(e){Mp.bloomEnabled=!!e.bloomEnabled,Mp.msaaSamples=kp(e.msaaSamples,Mp.msaaSamples),Np(),sm(),Mh(),Pm()}function Fh(e){if(e===`msaaSamples`){let e=kp(Mp.msaaSamples,0),t=Cp.indexOf(e),n=Cp[t===-1?0:(t+1)%Cp.length];Ph({...Mp,msaaSamples:n});return}Ph({...Mp,[e]:!Mp[e]})}function Ih(e,t=performance.now()){if(Op.lastRenderMs=e,Op.avgRenderMs=Op.avgRenderMs===0?e:Nt.lerp(Op.avgRenderMs,e,.18),Op.lastFrameNow>0){let e=t-Op.lastFrameNow;e>0&&e<250&&(Op.avgFrameMs=Op.avgFrameMs===0?e:Nt.lerp(Op.avgFrameMs,e,.2),Op.fps=Op.avgFrameMs>0?1e3/Op.avgFrameMs:0)}Op.lastFrameNow=t,!(t-Op.lastUiUpdate<250)&&(Op.lastUiUpdate=t,Mh())}function Lh(e=xh.getState()){Zf&&(Zf.innerHTML=e.isMuted?Sh.soundOff:Sh.soundOn,Zf.title=e.isMuted?`Unmute all audio`:`Mute all audio`),Qf&&(Qf.innerHTML=e.isPlaying||e.wantsToPlay?Sh.pause:Sh.play,e.hasError?Qf.title=`BGM unavailable (${e.currentSource||`no source`})`:e.needsUserGesture&&!e.isPlaying?Qf.title=`Click to start music`:e.wantsToPlay&&!e.isPlaying?Qf.title=`Music queued to start`:Qf.title=e.isPlaying?`Pause music`:`Play music`),$f&&($f.innerHTML=Th(e.volume),$f.title=`Adjust volume (${Math.round(e.volume*100)}%)`),tp&&(tp.value=`${Math.round(e.volume*100)}`),np&&(np.textContent=Eh(e))}xh.setOnChange(Lh);function Rh(){let e=document.createElement(`style`);e.textContent=`
    #ui-tl {
      position: fixed; top: 18px; left: 18px; z-index: 100;
      display: flex; align-items: center; gap: 10px;
      opacity: 0; transition: opacity ${qp.fadeDuration}s ease;
      font-family: "Controller W01 Two Oblique", 'Courier New', Courier, monospace;
    ...
    #ui-name {
      ...
      font-family: "Controller W01 Five Oblique", 'Courier New', Courier, monospace;
    }
    .ui-btn {
  ...
  `,document.head.appendChild(e);let t=document.createElement(`div`);t.id=`ui-tl`;let n=document.createElement(`span`);n.id=`ui-name`,n.textContent=`Hanqi Zhao`,Qf=document.createElement(`button`),Qf.className=`ui-btn`,Qf.addEventListener(`click`,()=>{xh.togglePlay()});let r=document.createElement(`div`);rp=r,r.className=`ui-volume-control`,$f=document.createElement(`button`),$f.className=`ui-btn`,$f.addEventListener(`click`,()=>{kh(!up)}),ep=document.createElement(`div`),ep.className=`ui-volume-panel`;let i=document.createElement(`div`);i.className=`ui-volume-title`,i.innerHTML=`<span>Volume</span>`,np=document.createElement(`span`),np.className=`ui-volume-value`,i.appendChild(np),tp=document.createElement(`input`),tp.className=`ui-volume-slider`,tp.type=`range`,tp.min=`0`,tp.max=`100`,tp.step=`1`,tp.addEventListener(`input`,e=>{xh.setVolume(Number(e.target.value)/100),Oh()}),ep.appendChild(i),ep.appendChild(tp),r.appendChild($f),r.appendChild(ep);let a=document.createElement(`div`);lp=a,a.className=`ui-postfx-control`,ip=document.createElement(`button`),ip.className=`ui-btn`,ip.innerHTML=Sh.fx,ip.addEventListener(`click`,()=>{Nh(!fp)}),ap=document.createElement(`div`),ap.className=`ui-postfx-panel`;let o=document.createElement(`div`);o.className=`ui-postfx-header`,o.innerHTML=`<span>Render FX</span>`;let s=document.createElement(`span`);s.className=`ui-postfx-summary`,s.textContent=Wf.label,o.appendChild(s);let c=document.createElement(`div`);c.className=`ui-postfx-toggles`,sp=document.createElement(`button`),sp.className=`ui-postfx-toggle`,sp.type=`button`,sp.addEventListener(`click`,()=>{Fh(`bloomEnabled`)}),cp=document.createElement(`button`),cp.className=`ui-postfx-toggle`,cp.type=`button`,cp.addEventListener(`click`,()=>{Fh(`msaaSamples`)}),c.appendChild(sp),c.appendChild(cp),op=document.createElement(`div`),op.className=`ui-postfx-stats`,ap.appendChild(o),ap.appendChild(c),ap.appendChild(op),a.appendChild(ip),a.appendChild(ap),Zf=document.createElement(`button`),Zf.className=`ui-btn`,Zf.addEventListener(`click`,()=>{xh.toggleMute()}),Xf=document.createElement(`button`),Xf.className=`ui-btn`,Xf.innerHTML=Sh.camUnfocused,Xf.title=`Toggle focus`,Xf.addEventListener(`click`,()=>{Yf||!Kf||(Jf?(Jf=!1,wh(),Gh(X.position.clone(),hm.target.clone(),Y.unfocus.endPos,Y.unfocus.endTarget,Y.unfocus.duration,Y.unfocus.easing)):(Jf=!0,wh(),Gh(X.position.clone(),hm.target.clone(),wp,Tp,Y.focus.duration,Y.focus.easing)))}),t.appendChild(n),t.appendChild(Qf),t.appendChild(r),t.appendChild(Zf),t.appendChild(a),t.appendChild(Xf),document.body.appendChild(t),document.addEventListener(`pointerdown`,e=>{let t=rp?.contains(e.target),n=lp?.contains(e.target);up&&t?Oh():up&&kh(!1),fp&&!n&&Nh(!1)}),document.addEventListener(`pointermove`,()=>{up&&Oh()}),document.addEventListener(`wheel`,()=>{up&&Oh()},{passive:!0}),document.addEventListener(`keydown`,e=>{if(e.key===`Escape`){kh(!1),Nh(!1);return}up&&Oh()}),Lh(),Mh();let l=document.createElement(`div`);l.id=`ui-bl`,l.innerHTML=`
    <div class="ui-hint">${Ch.wasd}<span>: move</span></div>
    <div class="ui-hint">${Ch.space}<span>: up</span></div>
    <div class="ui-hint">${Ch.ctrl}<span>: down</span></div>
  `,document.body.appendChild(l);let u=document.createElement(`div`);return u.id=`ui-br`,u.innerHTML=`<div class="ui-copy">© Copyright 2026 Hanqi Zhao.</div>`,document.body.appendChild(u),{tl:t,bl:l,br:u}}async function zh(){try{let[e,t,n,r,i]=await Promise.all([Wf.visualSky.kind===`hdr`?vm.loadAsync(Wf.visualSky.path):lh(Wf.visualSky.path,{colorSpace:Ue,flipY:Wf.visualSky.flipY??!1}),Wf.lightingEnvironment.kind===`hdr`?vm.loadAsync(Wf.lightingEnvironment.path):lh(Wf.lightingEnvironment.path,{colorSpace:Ue,flipY:Wf.lightingEnvironment.flipY??!1}),_m.loadAsync(`/models/room_all.glb`),Promise.all(Object.entries(th).map(async([e,t])=>[e,await uh(t.path,{colorSpace:Ue})])),Promise.all(Object.entries(eh).map(async([e,t])=>{let n=await uh(t.path,{colorSpace:``});return n.channel=1,[e,n]}))]),a=Object.fromEntries(r),o=Object.fromEntries(i),s=new ba(200,32,20);s.scale(-1,1,1),Tm=new li(s,$m(e,Wf.visualSky)),Tm.position.y=-100,Tm.rotation.y=Gp.rotationY,Up.add(Tm),t.mapping=303,Up.environment=t,Up.environmentIntensity=Wf.lightingEnvironment.intensity??1.2;let c=n.scene;if(c.traverse(e=>{if(!e.isMesh)return;let t=(e.name??``).toLowerCase();(t.includes(`computer`)||t.includes(`screen`)||t.includes(`monitor`))&&Cm.push(e),t.includes(`screen_plane`)&&(xm=e,Dp.setFromMatrixPosition(e.matrixWorld),Dp.add(Y.loader.shockwave.centerOffset),xm.material=new Zr({colorWrite:!1,depthWrite:!0}),xm.renderOrder=-1)}),Qm(c),c.traverse(e=>{if(!e.isMesh)return;let t=(e.name??``).toLowerCase();t.includes(`screen_plane`)||(Array.isArray(e.material)?e.material:[e.material]).forEach(n=>{if(!n)return;ih(n);let r=oh(t),i=sh(t);if(r&&a[r]){n.map=a[r],n.dithering=ch(r),n.needsUpdate=!0;return}n.isMeshStandardMaterial&&i&&o[i]&&(ah(e.geometry),n.lightMap=o[i],rh[i]&&(n.envMapIntensity=rh[i].envMapIntensity,n.roughness<rh[i].roughnessMin&&(n.roughness=rh[i].roughnessMin)),n.needsUpdate=!0)})}),Up.add(c),Cm.length>0){let e=new $n;Cm.forEach(t=>{t.updateMatrixWorld(!0),e.union(new $n().setFromObject(t))});let t=new V;e.getCenter(t);let n=new V;e.getSize(n),wm=new li(new va(n.x,n.y,n.z),new Zr({colorWrite:!1,depthWrite:!1,transparent:!0,opacity:0})),wm.position.copy(t),wm.scale.setScalar(Y.focus.hitboxScale),Up.add(wm),xm||(Dp.copy(t),Dp.add(Y.loader.shockwave.centerOffset))}xm&&fh(xm),await Promise.all([Bp,new Promise(e=>setTimeout(e,Y.loader.minLoadTime))]),await Vp(),Rp.style.opacity=`0`,await new Promise(e=>setTimeout(e,Y.loader.fadeTime*1e3)),Rp.remove(),_h();let l=Rh();{let e=performance.now(),t=!1,n=e=>e===1?1:1-2**(-10*e),r=e=>e<.5?4*e*e*e:1-(-2*e+2)**3/2;function i(){let a=(performance.now()-e)/1e3;if(!Kf){let e=Y.loader.cameraPush,t=0;a>=e.startTime&&(t=Math.min((a-e.startTime)/e.duration,1)),X.position.lerpVectors(Zp,Y.intro.startPos,r(t)),X.lookAt(hm.target)}let o=Y.loader.shockwave,s=0;a>=o.startTime&&(s=Math.min((a-o.startTime)/o.duration,1));let c=Nt.lerp(o.startRadius,o.endRadius,n(s));s>=1&&(c=9999),Ep.forEach(e=>{e.userData.shader&&(e.userData.shader.uniforms.uShockwaveRadius.value=c)});let u=Y.loader.skyFade,d=0;a>=u.startTime&&(d=Math.min((a-u.startTime)/u.duration,1)),Tm&&Tm.material&&(Tm.material.uniforms.uSkyOpacity.value=d),!Kf&&a>=Y.loader.controlsUnlockTime&&(Kf=!0,Q.locked=!0,Q.targetMouse.set(0,0),Q.currentMouse.set(0,0),Q.lockBaseMouse.copy(Bh),Uh());let f=Y.loader.screenFade;a>=f.startTime&&!qf&&(qf=!0,Em.runtimeEnabled=!1,Z&&(Z.element.style.transition=`opacity ${f.duration}s ease-in-out`,requestAnimationFrame(()=>{Z.element.style.opacity=`1`,setTimeout(()=>{Z&&(Z.element.style.transition=``,Em.runtimeEnabled=!0,Em.target=1,Bm(1))},f.duration*1e3+100)}))),!t&&a>=qp.appearAt&&(t=!0,l.tl.style.opacity=`1`,l.bl.style.opacity=`1`,l.br.style.opacity=`1`),a<Math.max(Y.loader.cameraPush.startTime+Y.loader.cameraPush.duration,o.startTime+o.duration,u.startTime+u.duration,f.startTime+f.duration,Y.loader.controlsUnlockTime)?requestAnimationFrame(i):Gf=!1}i()}}catch(e){console.error(e)}}var Bh=new B,Q={locked:!0,lockBaseMouse:new B,targetMouse:new B,currentMouse:new B,velocity:new B},Vh={w:!1,a:!1,s:!1,d:!1," ":!1,control:!1},Hh=performance.now();function Uh(){Hh=performance.now()}window.addEventListener(`pointermove`,e=>{Bh.x=e.clientX/window.innerWidth*2-1,Bh.y=-(e.clientY/window.innerHeight)*2+1,Kf&&(Uh(),!Yf&&!Jf&&Q.locked&&Bh.distanceTo(Q.lockBaseMouse)>Y.parallax.unlockThreshold&&(Q.locked=!1),Pm())}),window.addEventListener(`keydown`,e=>{if(!Kf)return;Uh();let t=e.key.toLowerCase();t===` `&&e.preventDefault(),Vh[t]!==void 0&&(Vh[t]=!0),Pm()},{passive:!1}),window.addEventListener(`keyup`,e=>{if(!Kf)return;Uh();let t=e.key.toLowerCase();Vh[t]!==void 0&&(Vh[t]=!1),Pm()}),window.addEventListener(`wheel`,()=>{Kf&&(Uh(),Pm())}),Qp.domElement.addEventListener(`contextmenu`,e=>e.preventDefault());var Wh={linear:e=>e,easeOutCubic:e=>1-(1-e)**3,easeInOutCubic:e=>e<.5?4*e*e*e:1-(-2*e+2)**3/2};function Gh(e,t,n,r,i,a,o){Yf=!0;let s=performance.now(),c=Wh[a]||Wh.easeInOutCubic;Pm();function l(){let a=(performance.now()-s)/i;a>1&&(a=1);let u=c(a);X.position.lerpVectors(e,n,u),hm.target.lerpVectors(t,r,u),X.lookAt(hm.target),X.updateProjectionMatrix(),Pm(),a<1?requestAnimationFrame(l):(Yf=!1,$.velocity.set(0,0,0),Q.locked=!0,Q.lockBaseMouse.copy(Bh),Q.targetMouse.set(0,0),Q.currentMouse.set(0,0),Q.velocity.set(0,0),Uh(),o&&o(),Pm())}l()}var Kh=new es,qh=0;Qp.domElement.addEventListener(`pointerdown`,e=>{!Kf||Yf||(Uh(),qh=performance.now(),Pm())}),Qp.domElement.addEventListener(`pointerup`,e=>{if(!(!Kf||Yf)){if(performance.now()-qh<300){if(Bh.x=e.clientX/window.innerWidth*2-1,Bh.y=-(e.clientY/window.innerHeight)*2+1,Jf){if(Zm(e.clientX,e.clientY))return;Jf=!1,wh(),Gh(X.position.clone(),hm.target.clone(),Y.unfocus.endPos,Y.unfocus.endTarget,Y.unfocus.duration,Y.unfocus.easing);return}Kh.setFromCamera(Bh,X);let t=wm?[wm]:Cm;if(Kh.intersectObjects(t,!0).length>0&&Z){let e=new V(0,0,1).applyQuaternion(Z.quaternion).normalize(),t=new V().subVectors(X.position,Z.position).normalize();e.angleTo(t)*(180/Math.PI)<=Y.focus.maxTriggerAngle&&(Jf=!0,wh(),Gh(X.position.clone(),hm.target.clone(),wp,Tp,Y.focus.duration,Y.focus.easing))}}Pm()}});function Jh(){if(!xm||!Z)return;let e=Jf&&!Yf&&!!Sm?.src;if(!qf){Vm(e?`auto`:`none`);return}if(!Em.runtimeEnabled){Vm(e?`auto`:`none`);return}let t=new V(0,0,1).applyQuaternion(Z.quaternion).normalize(),n=new V().subVectors(X.position,Z.position).normalize(),r=X.position.distanceTo(Z.position),i=t.dot(n)>=0,a=0,o=`none`;if(e)a=1,o=`auto`;else if(i){let e=Y.shield.maxClickDistance+Y.shield.fadeDistance;if(r<=Y.shield.maxClickDistance)a=1;else if(r>=e)a=Y.shield.dimOpacity;else{let e=1-(r-Y.shield.maxClickDistance)/Y.shield.fadeDistance;a=Nt.lerp(Y.shield.dimOpacity,1,e)}}Em.target=a;let s=Nt.lerp(Em.current,Em.target,Y.shield.opacityLerp);Bm(Math.abs(s-Em.target)<.002?Em.target:s),Vm(o)}var $={active:!1,chargeStart:0,releaseStart:0,dist:0,currentDir:new V,velocity:new V};function Yh(e){km.frameId=null;let t=Am(),n=km.renderRequested,r=Lm(e)||t,i=e-Hh>Y.parallax.idleTimeout;if(!r&&!km.renderRequested)return;if(Tm&&t&&(Tm.rotation.y+=Y.sky.rotationSpeed),!Kf){zm(e,{skyOnly:!1,sceneAnimationActive:!0}),km.renderRequested=!1,r&&Pm();return}if(!Jf&&!Yf){let t=new V;X.getWorldDirection(t),t.y=0,t.normalize();let n=new V().crossVectors(t,X.up).normalize(),r=new V(0,1,0),a=new V;Vh.w&&a.add(t),Vh.s&&a.sub(t),Vh.a&&a.sub(n),Vh.d&&a.add(n),Vh[` `]&&a.add(r),Vh.control&&a.sub(r),a.lengthSq()>0?($.releaseStart=0,$.active?$.currentDir.lerp(a.normalize(),Y.walk.dirLerp).normalize():($.chargeStart===0&&($.chargeStart=e),e-$.chargeStart>Y.walk.chargeTime&&($.active=!0,$.dist=0,$.currentDir.copy(a.normalize())))):($.chargeStart=0,$.active&&($.releaseStart===0&&($.releaseStart=e),e-$.releaseStart>Y.walk.releaseGrace&&($.active=!1)),i&&($.active=!1,$.releaseStart=0,$.currentDir.set(0,0,0),$.velocity.set(0,0,0))),$.active&&$.dist>=Y.walk.maxDist&&($.active=!1);let o=new V;if($.active?(o.copy($.currentDir).multiplyScalar(Y.walk.speed),$.velocity.lerp(o,Y.walk.acceleration)):($.velocity.lerp(o,Y.walk.deceleration),Mm($.velocity)&&$.velocity.set(0,0,0)),$.velocity.lengthSq()>1e-6){$.dist+=$.velocity.length();let e=$.velocity.clone(),t=Y.walk.bounds,n=Y.walk.dampingZone;e.x<0&&X.position.x-t.minX<n?e.x*=Math.max(0,(X.position.x-t.minX)/n):e.x>0&&t.maxX-X.position.x<n&&(e.x*=Math.max(0,(t.maxX-X.position.x)/n)),e.y<0&&X.position.y-t.minY<n?e.y*=Math.max(0,(X.position.y-t.minY)/n):e.y>0&&t.maxY-X.position.y<n&&(e.y*=Math.max(0,(t.maxY-X.position.y)/n)),e.z<0&&X.position.z-t.minZ<n?e.z*=Math.max(0,(X.position.z-t.minZ)/n):e.z>0&&t.maxZ-X.position.z<n&&(e.z*=Math.max(0,(t.maxZ-X.position.z)/n));let r=X.position.clone().add(e);r.x<=t.minX?(r.x=t.minX,$.velocity.x=0):r.x>=t.maxX&&(r.x=t.maxX,$.velocity.x=0),r.y<=t.minY?(r.y=t.minY,$.velocity.y=0):r.y>=t.maxY&&(r.y=t.maxY,$.velocity.y=0),r.z<=t.minZ?(r.z=t.minZ,$.velocity.z=0):r.z>=t.maxZ&&(r.z=t.maxZ,$.velocity.z=0);let i=new V().subVectors(r,X.position);X.position.copy(r),hm.target.add(i)}}X.lookAt(hm.target);let a=X.quaternion.clone();Jf||Yf||i||Q.locked?Q.targetMouse.lerp(new B(0,0),Y.parallax.catchupSpeed):Q.targetMouse.lerp(Bh,Y.parallax.catchupSpeed);let o=new B().subVectors(Q.targetMouse,Q.currentMouse);Q.velocity.add(o.multiplyScalar(Y.parallax.springAccel)),Q.velocity.multiplyScalar(1-Y.parallax.springFriction),Q.currentMouse.add(Q.velocity),i&&(jm(Q.targetMouse)&&Q.targetMouse.set(0,0),jm(Q.velocity)&&Q.velocity.set(0,0),jm(Q.currentMouse)&&jm(Q.targetMouse)&&jm(Q.velocity)&&Q.currentMouse.set(0,0));let s=Q.currentMouse.y*Nt.degToRad(Y.parallax.maxAngle),c=-Q.currentMouse.x*Nt.degToRad(Y.parallax.maxAngle);X.rotateX(s),X.rotateY(c);let l=Lm(e);zm(e,{skyOnly:t&&!l&&!n,sceneAnimationActive:l}),X.quaternion.copy(a),km.renderRequested=!1,l?Pm():t&&Fm()}window.addEventListener(`resize`,()=>{X.aspect=window.innerWidth/window.innerHeight,X.updateProjectionMatrix(),sm(),Mh(),Im()}),zh(),Pm();