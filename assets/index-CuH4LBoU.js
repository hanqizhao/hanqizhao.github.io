...
`);this.workerSourceURL=URL.createObjectURL(new Blob([i])),this.transcoderBinary=n,this.workerPool.setWorkerCreator(()=>{let e=new Worker(this.workerSourceURL),t=this.transcoderBinary.slice(0);return e.postMessage({type:`init`,config:this.workerConfig,transcoderBinary:t},[t]),e})}),hf>0&&console.warn(`THREE.KTX2Loader: Multiple active KTX2 loaders may cause performance issues. Use a single KTX2Loader instance, or call .dispose() on old instances.`),hf++}return this.transcoderPending}load(e,t,n,r){if(this.workerConfig===null)throw Error("THREE.KTX2Loader: Missing initialization with `.detectSupport( renderer )`.");let i=new oo(this.manager);i.setPath(this.path),i.setCrossOrigin(this.crossOrigin),i.setWithCredentials(this.withCredentials),i.setRequestHeader(this.requestHeader),i.setResponseType(`arraybuffer`),i.load(e,e=>{this.parse(e,t,r)},n,r)}parse(e,t,n){if(this.workerConfig===null)throw Error("THREE.KTX2Loader: Missing initialization with `.detectSupport( renderer )`.");if(mf.has(e))return mf.get(e).promise.then(t).catch(n);this._createTexture(e).then(e=>t?t(e):null).catch(n)}_createTextureFrom(e,t){let{type:n,error:r,data:{faces:i,width:a,height:o,format:s,type:c,dfdFlags:u}}=e;if(n===`error`)return Promise.reject(r);let f;if(t.faceCount===6)f=new pa(i,s,c);else{let e=i[0].mipmaps;f=t.layerCount>1?new fa(e,a,o,t.layerCount,s,c):new da(e,a,o,s,c)}return f.minFilter=i[0].mipmaps.length===1?l:d,f.magFilter=l,f.generateMipmaps=!1,f.needsUpdate=!0,f.colorSpace=Sf(t),f.premultiplyAlpha=!!(u&1),f}async _createTexture(e,t={}){let n=af(new Uint8Array(e)),r=n.vkFormat===1000066e3&&n.dataFormatDescriptor[0].colorModel===167;if(!(n.vkFormat===0||r&&!this.workerConfig.astcHDRSupported))return xf(n);let i=t,a=this.init().then(()=>this.workerPool.postMessage({type:`transcode`,buffer:e,taskConfig:i},[e])).then(e=>this._createTextureFrom(e.data,n));return mf.set(e,{promise:a}),a}dispose(){this.workerPool.dispose(),this.workerSourceURL&&URL.revokeObjectURL(this.workerSourceURL),hf--}};_f.BasisFormat={ETC1S:0,UASTC:1,UASTC_HDR:2},_f.TranscoderFormat={ETC1:0,ETC2:1,BC1:2,BC3:3,BC4:4,BC5:5,BC7_M6_OPAQUE_ONLY:6,BC7_M5:7,PVRTC1_4_RGB:8,PVRTC1_4_RGBA:9,ASTC_4x4:10,ATC_RGB:11,ATC_RGBA_INTERPOLATED_ALPHA:12,RGBA32:13,RGB565:14,BGR565:15,RGBA4444:16,BC6H:22,RGB_HALF:24,RGBA_HALF:25},_f.EngineFormat={RGBAFormat:D,RGBA_ASTC_4x4_Format:_e,RGB_BPTC_UNSIGNED_Format:Me,RGBA_BPTC_Format:N,RGBA_ETC2_EAC_Format:fe,RGBA_PVRTC_4BPPV1_Format:ce,RGBA_S3TC_DXT5_Format:ae,RGB_ETC1_Format:ue,RGB_ETC2_Format:de,RGB_PVRTC_4BPPV1_Format:oe,RGBA_S3TC_DXT1_Format:re},_f.EngineType={UnsignedByteType:f,HalfFloatType:y,FloatType:v},_f.BasisWorker=function(){let e,t,n,r=_EngineFormat,i=_EngineType,a=_TranscoderFormat,o=_BasisFormat;self.addEventListener(`message`,function(n){let r=n.data;switch(r.type){case`init`:e=r.config,s(r.transcoderBinary);break;case`transcode`:t.then(()=>{try{let{faces:e,buffers:t,width:n,height:i,hasAlpha:a,format:o,type:s,dfdFlags:l}=c(r.buffer);self.postMessage({type:`transcode`,id:r.id,data:{faces:e,width:n,height:i,hasAlpha:a,format:o,type:s,dfdFlags:l}},t)}catch(e){console.error(e),self.postMessage({type:`error`,id:r.id,error:e.message})}});break}});function s(e){t=new Promise(t=>{n={wasmBinary:e,onRuntimeInitialized:t},BASIS(n)}).then(()=>{n.initializeBasis(),n.KTX2File===void 0&&console.warn(`THREE.KTX2Loader: Please update Basis Universal transcoder.`)})}function c(e){let t=new n.KTX2File(new Uint8Array(e));function r(){t.close(),t.delete()}if(!t.isValid())throw r(),Error(`THREE.KTX2Loader:	Invalid or unsupported .ktx2 file`);let a;if(t.isUASTC())a=o.UASTC;else if(t.isETC1S())a=o.ETC1S;else if(t.isHDR())a=o.UASTC_HDR;else throw Error(`THREE.KTX2Loader: Unknown Basis encoding`);let s=t.getWidth(),c=t.getHeight(),l=t.getLayers()||1,u=t.getLevels(),f=t.getFaces(),m=t.getHasAlpha(),h=t.getDFDFlags(),{transcoderFormat:g,engineFormat:_,engineType:v}=d(a,s,c,m);if(!s||!c||!u)throw r(),Error(`THREE.KTX2Loader:	Invalid texture`);if(!t.startTranscoding())throw r(),Error(`THREE.KTX2Loader: .startTranscoding failed`);let y=[],b=[];for(let e=0;e<f;e++){let n=[];for(let a=0;a<u;a++){let o=[],s,c;for(let n=0;n<l;n++){let l=t.getImageLevelInfo(a,n,e);e===0&&a===0&&n===0&&(l.origWidth%4!=0||l.origHeight%4!=0)&&console.warn(`THREE.KTX2Loader: ETC1S and UASTC textures should use multiple-of-four dimensions.`),u>1?(s=l.origWidth,c=l.origHeight):(s=l.width,c=l.height);let d=new Uint8Array(t.getImageTranscodedSizeInBytes(a,n,0,g)),f=t.transcodeImage(d,a,n,e,g,0,-1,-1);if(v===i.HalfFloatType&&(d=new Uint16Array(d.buffer,d.byteOffset,d.byteLength/Uint16Array.BYTES_PER_ELEMENT)),!f)throw r(),Error(`THREE.KTX2Loader: .transcodeImage failed.`);o.push(d)}let d=p(o);n.push({data:d,width:s,height:c}),b.push(d.buffer)}y.push({mipmaps:n,width:s,height:c,format:_,type:v})}return r(),{faces:y,buffers:b,width:s,height:c,hasAlpha:m,dfdFlags:h,format:_,type:v}}let l=[{if:`astcSupported`,basisFormat:[o.UASTC],transcoderFormat:[a.ASTC_4x4,a.ASTC_4x4],engineFormat:[r.RGBA_ASTC_4x4_Format,r.RGBA_ASTC_4x4_Format],engineType:[i.UnsignedByteType],priorityETC1S:1/0,priorityUASTC:1,needsPowerOfTwo:!1},{if:`bptcSupported`,basisFormat:[o.ETC1S,o.UASTC],transcoderFormat:[a.BC7_M5,a.BC7_M5],engineFormat:[r.RGBA_BPTC_Format,r.RGBA_BPTC_Format],engineType:[i.UnsignedByteType],priorityETC1S:3,priorityUASTC:2,needsPowerOfTwo:!1},{if:`dxtSupported`,basisFormat:[o.ETC1S,o.UASTC],transcoderFormat:[a.BC1,a.BC3],engineFormat:[r.RGBA_S3TC_DXT1_Format,r.RGBA_S3TC_DXT5_Format],engineType:[i.UnsignedByteType],priorityETC1S:4,priorityUASTC:5,needsPowerOfTwo:!1},{if:`etc2Supported`,basisFormat:[o.ETC1S,o.UASTC],transcoderFormat:[a.ETC1,a.ETC2],engineFormat:[r.RGB_ETC2_Format,r.RGBA_ETC2_EAC_Format],engineType:[i.UnsignedByteType],priorityETC1S:1,priorityUASTC:3,needsPowerOfTwo:!1},{if:`etc1Supported`,basisFormat:[o.ETC1S,o.UASTC],transcoderFormat:[a.ETC1],engineFormat:[r.RGB_ETC1_Format],engineType:[i.UnsignedByteType],priorityETC1S:2,priorityUASTC:4,needsPowerOfTwo:!1},{if:`pvrtcSupported`,basisFormat:[o.ETC1S,o.UASTC],transcoderFormat:[a.PVRTC1_4_RGB,a.PVRTC1_4_RGBA],engineFormat:[r.RGB_PVRTC_4BPPV1_Format,r.RGBA_PVRTC_4BPPV1_Format],engineType:[i.UnsignedByteType],priorityETC1S:5,priorityUASTC:6,needsPowerOfTwo:!0},{if:`bptcSupported`,basisFormat:[o.UASTC_HDR],transcoderFormat:[a.BC6H],engineFormat:[r.RGB_BPTC_UNSIGNED_Format],engineType:[i.HalfFloatType],priorityHDR:1,needsPowerOfTwo:!1},{basisFormat:[o.ETC1S,o.UASTC],transcoderFormat:[a.RGBA32,a.RGBA32],engineFormat:[r.RGBAFormat,r.RGBAFormat],engineType:[i.UnsignedByteType,i.UnsignedByteType],priorityETC1S:100,priorityUASTC:100,needsPowerOfTwo:!1},{basisFormat:[o.UASTC_HDR],transcoderFormat:[a.RGBA_HALF],engineFormat:[r.RGBAFormat],engineType:[i.HalfFloatType],priorityHDR:100,needsPowerOfTwo:!1}],u={[o.ETC1S]:l.filter(e=>e.basisFormat.includes(o.ETC1S)).sort((e,t)=>e.priorityETC1S-t.priorityETC1S),[o.UASTC]:l.filter(e=>e.basisFormat.includes(o.UASTC)).sort((e,t)=>e.priorityUASTC-t.priorityUASTC),[o.UASTC_HDR]:l.filter(e=>e.basisFormat.includes(o.UASTC_HDR)).sort((e,t)=>e.priorityHDR-t.priorityHDR)};function d(t,n,r,i){let a=u[t];for(let o=0;o<a.length;o++){let s=a[o];if(!(s.if&&!e[s.if])&&s.basisFormat.includes(t)&&!(i&&s.transcoderFormat.length<2)&&!(s.needsPowerOfTwo&&!(f(n)&&f(r))))return{transcoderFormat:s.transcoderFormat[i?1:0],engineFormat:s.engineFormat[i?1:0],engineType:s.engineType[0]}}throw Error(`THREE.KTX2Loader: Failed to identify transcoding target.`)}function f(e){return e<=2?!0:(e&e-1)==0&&e!==0}function p(e){if(e.length===1)return e[0];let t=0;for(let n=0;n<e.length;n++){let r=e[n];t+=r.byteLength}let n=new Uint8Array(t),r=0;for(let t=0;t<e.length;t++){let i=e[t];n.set(i,r),r+=i.byteLength}return n}};var vf=new Set([D,E,A,k]),yf={109:D,103:A,100:k,97:D,83:A,76:k,43:D,37:D,22:A,16:A,15:k,9:k,123:E,122:E,152:fe,148:de,153:pe,154:me,155:he,156:ge,[$d]:_e,158:_e,157:_e,[ef]:xe,166:xe,165:xe,134:re,133:re,132:M,131:M,138:ae,137:ae,140:P,139:Ne,142:F,141:Pe,146:N,145:N,[Qd]:ce,[Xd]:ce,[Zd]:le,[Yd]:le},bf={109:v,103:v,100:v,97:y,83:y,76:y,43:f,37:f,22:f,16:f,15:f,9:f,123:C,122:w,152:f,148:f,153:f,154:f,155:f,156:f,[$d]:y,158:f,157:f,[ef]:y,166:f,165:f,134:f,133:f,132:f,131:f,138:f,137:f,140:f,139:f,142:f,141:f,146:f,145:f,[Qd]:f,[Xd]:f,[Zd]:f,[Yd]:f};async function xf(e){let{vkFormat:t}=e;if(yf[t]===void 0)throw Error(`THREE.KTX2Loader: Unsupported vkFormat: `+t);bf[t]===void 0&&console.warn(`THREE.KTX2Loader: Missing ".type" for vkFormat: `+t);let n;e.supercompressionScheme===2&&(gf||=new Promise(async e=>{let t=new uf;await t.init(),e(t)}),n=await gf);let r=[];for(let i=0;i<e.levels.length;i++){let a=Math.max(1,e.pixelWidth>>i),o=Math.max(1,e.pixelHeight>>i),s=e.pixelDepth?Math.max(1,e.pixelDepth>>i):0,c=e.levels[i],l;if(e.supercompressionScheme===0)l=c.levelData;else if(e.supercompressionScheme===2)l=n.decode(c.levelData,c.uncompressedByteLength);else throw Error(`THREE.KTX2Loader: Unsupported supercompressionScheme.`);let u;u=bf[t]===1015?new Float32Array(l.buffer,l.byteOffset,l.byteLength/Float32Array.BYTES_PER_ELEMENT):bf[t]===1016?new Uint16Array(l.buffer,l.byteOffset,l.byteLength/Uint16Array.BYTES_PER_ELEMENT):bf[t]===35902||bf[t]===35899?new Uint32Array(l.buffer,l.byteOffset,l.byteLength/Uint32Array.BYTES_PER_ELEMENT):l,r.push({data:u,width:a,height:o,depth:s})}let i=e.levelCount===0||r.length>1,a;if(vf.has(yf[t]))a=e.pixelDepth===0?new Ci(r[0].data,e.pixelWidth,e.pixelHeight):new tn(r[0].data,e.pixelWidth,e.pixelHeight,e.pixelDepth),a.minFilter=i?s:o,a.magFilter=o,a.generateMipmaps=e.levelCount===0;else{if(e.pixelDepth>0)throw Error(`THREE.KTX2Loader: Unsupported pixelDepth.`);a=new da(r,e.pixelWidth,e.pixelHeight),a.minFilter=i?d:l,a.magFilter=l}return a.mipmaps=r,a.type=bf[t],a.format=yf[t],a.colorSpace=Sf(e),a.needsUpdate=!0,Promise.resolve(a)}function Sf(e){let t=e.dataFormatDescriptor[0];return t.colorPrimaries===1?t.transferFunction===2?Ue:We:t.colorPrimaries===10?t.transferFunction===2?ff:pf:(t.colorPrimaries===0||console.warn(`THREE.KTX2Loader: Unsupported color primaries, "${t.colorPrimaries}"`),``)}var Cf={name:`CopyShader`,uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Pf.BlurDirectionX=new B(1,0),Pf.BlurDirectionY=new B(0,1);var Ff={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},If=class extends wf{constructor(){super(),this.isOutputPass=!0,this.uniforms=Ta.clone(Ff.uniforms),this.material=new ka({name:Ff.name,uniforms:this.uniforms,vertexShader:Ff.vertexShader,fragmentShader:Ff.fragmentShader}),this._fsQuad=new Df(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},U.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Lf=new URLSearchParams(window.location.search),Rf=Lf.get(`benchmark`)===`1`||Lf.get(`bench`)===`1`,zf=`slim`,Bf={current:{visualSkyLdr:new URL(`/assets/new_sky_ldr-yZ_KpEae.jpg`,``+import.meta.url).href,lightingLdr:new URL(`/assets/room_ldr-DOcZ7og-.jpg`,``+import.meta.url).href,room:new URL(`/assets/room%20baked-KoBuYlPf.ktx2`,``+import.meta.url).href,table:new URL(`/assets/table%20baked-DFp0K4D2.ktx2`,``+import.meta.url).href,chairBack:new URL(`/assets/chair%20back%20final-sbWclMz4.ktx2`,``+import.meta.url).href,chairLeft:new URL(`/assets/chair%20left%20final-BjZ_O-yh.ktx2`,``+import.meta.url).href,chairRight:new URL(`/assets/chair%20right%20final-BtcJ8_ie.ktx2`,``+import.meta.url).href,computer:new URL(`/assets/computer%20shadow-D5HsGwbv.ktx2`,``+import.meta.url).href}},Vf={label:`Slim`,visualSky:{kind:`ldr`,path:Bf.current.visualSkyLdr,flipY:!0},lightingEnvironment:{kind:`ldr`,path:Bf.current.lightingLdr,flipY:!0,intensity:1.2},bakedSurfacePaths:{room:Bf.current.room,table:Bf.current.table,chairBack:Bf.current.chairBack,chairLeft:Bf.current.chairLeft,chairRight:Bf.current.chairRight},lightMapPaths:{computer:Bf.current.computer}},Hf=!0,Uf=!1,Wf=!1,Gf=!1,Kf=!1,qf=null,Jf=null,Yf=null,Xf=null,Zf=null,Qf=null,$f=null,ep=null,tp=null,np=null,rp=null,ip=null,ap=null,op=null,sp=!1,cp=null,lp=!1,up=null,dp={SET_MUTED:`outer-website:set-global-audio-muted`,SET_VOLUME:`outer-website:set-global-audio-volume`},fp=`outer-website:postfx-settings`,pp=2200,mp=220,hp=2,gp=1e3/24,_p=1e3/10,vp=1e-4,yp=.01,bp=[4,2,0],xp=new V,Sp=new V,Cp=[],wp=new V(0,0,0),Tp={lastRenderMs:0,avgRenderMs:0,avgFrameMs:0,fps:0,lastUiUpdate:0,lastFrameNow:0};function Ep(e,t=hp){if(e===!0)return hp;if(e===!1||e==null)return t;let n=Number(e);return n>=4?4:n>=2?2:0}function Dp(e){return e>=4?`4x`:e>=2?`2x`:`Off`}function Op(){let e={bloomEnabled:!0,msaaSamples:hp};try{let t=window.localStorage.getItem(fp);if(!t)return e;let n=JSON.parse(t);return{bloomEnabled:n?.bloomEnabled!==!1,msaaSamples:Ep(n?.msaaSamples??n?.msaaEnabled,e.msaaSamples)}}catch{return e}}var kp=Op();function Ap(){try{window.localStorage.setItem(fp,JSON.stringify(kp))}catch{}}var jp={url:`/winxp/index.html#/`,width:1280,height:820,rotationX:-Math.PI*15.5/180,rotationY:Math.PI/2,rotationZ:0,flipNormal:!1,scaleMultiplier:1,scaleX:.99,scaleY:1.01,offsetX:0,offsetY:6e-4,offsetZ:0},Y={loader:{bgColor:`#d9d9d9`,minLoadTime:1500,fadeTime:1,cameraPush:{startTime:1.5,duration:1,distance:.5},shockwave:{startTime:.5,duration:5.5,startRadius:0,endRadius:20,edgeWidth:.2,edgeIntensity:3,centerOffset:new V(-4,-1,0)},skyFade:{startTime:.5,duration:1},screenFade:{startTime:2.5,duration:6.5},controlsUnlockTime:2.5},intro:{startPos:new V(4.3,-1.8,0),startTarget:new V(0,-1.4,0)},focus:{duration:2e3,easing:`easeInOutCubic`,distance:.18,yOffset:0,maxTriggerAngle:60,targetOffsetX:0,targetOffsetY:0,targetOffsetZ:0,hitboxScale:1.8},unfocus:{duration:1800,easing:`easeOutCubic`,endPos:new V(4.5,-1.8,0),endTarget:new V(0,-1.4,0)},shield:{maxClickDistance:1.2,dimOpacity:.8,fadeDistance:.55,opacityLerp:.14},sky:{rotationSpeed:3e-5},parallax:{maxAngle:6,unlockThreshold:.2,springAccel:.004,springFriction:.06,catchupSpeed:.03,idleTimeout:3e3},walk:{chargeTime:80,releaseGrace:50,maxDist:1e3,speed:.011,acceleration:.6,deceleration:.6,dirLerp:1,dampingZone:.8,bounds:{minX:2,maxX:5,minY:-2,maxY:1.5,minZ:-3.5,maxZ:3.5}}};document.body.style.backgroundColor=Y.loader.bgColor,document.body.style.margin=`0`,document.body.style.overflow=`hidden`;var Mp=document.createElement(`link`);Mp.rel=`stylesheet`,Mp.href=`https://db.onlinewebfonts.com/c/35ea0eae14a5c7ee380c2d62cd367fe9?family=Controller+W01+Two+Oblique`,document.head.appendChild(Mp);var Np=document.createElement(`link`);Np.rel=`stylesheet`,Np.href=`https://db.onlinewebfonts.com/c/8a7a89e31c8ccec1c446bb97e9e6cc07?family=Controller+W01+Five+Oblique`,document.head.appendChild(Np);var Pp=document.createElement(`style`);Pp.textContent=`
  #hud-loader-root {
...
`,document.head.appendChild(Pp);var Fp=document.createElement(`div`);Fp.id=`hud-loader-root`,Fp.innerHTML=`
  ...
  <div class="hud-core">
    ...
    <div class="hud-start-prompt" id="hud-start-prompt">Click anywhere to start</div>
  </div>`,document.body.appendChild(Fp);var Ip,Lp=new Promise(e=>{Ip=e});(function(){let e=Fp.querySelector(`#hud-bar`),t=Fp.querySelector(`#hud-hex`),n=Fp.querySelector(`#hud-status`);for(let t=0;t<18;t++){let t=document.createElement(`div`);t.className=`hud-block`,e.appendChild(t)}let r=e.querySelectorAll(`.hud-block`),i=0;function a(){i+=Math.random()*2+1,i>100&&(i=100);let e=Math.round(i/100*18);r.forEach((t,n)=>t.classList.toggle(`lit`,n<e)),t.textContent=`0x`+Math.floor(Math.random()*65535).toString(16).toUpperCase(),i<100?setTimeout(a,Math.random()*100+20):(n.textContent=`Boot sequence complete.`,setTimeout(Ip,800))}setTimeout(a,1e3)})();function Rp(){return new Promise(e=>{let t=Fp.querySelector(`.hud-core`);if(!t){up=null,e();return}let n=!1,r=t=>{n||(n=!0,up=null,Fp.removeEventListener(`pointerdown`,i,!0),Fp.removeEventListener(`keydown`,a,!0),typeof _h?.releaseQueuedPlayback==`function`&&_h.releaseQueuedPlayback(t),e())},i=e=>{e.preventDefault(),r(`loader-start-pointer`)},a=e=>{e.key!==`Enter`&&e.key!==` `||(e.preventDefault(),r(`loader-start-keyboard`))};t.classList.add(`is-awaiting-start`),up=()=>{r(`loader-start-debug`)},Fp.tabIndex=0,Fp.focus({preventScroll:!0}),Fp.addEventListener(`pointerdown`,i,!0),Fp.addEventListener(`keydown`,a,!0)})}var zp=document.getElementById(`app`),Bp=new Rn,Vp={fov:65,near:.1,far:1e3},Hp={exposure:1.1,saturation:1.25,highlights:.95,repeatX:2,repeatY:1.2,offsetY:0,rotationY:-3*Math.PI/4},Up={exposure:.9,bloom:{strength:.01,radius:0,threshold:0}},Wp={appearAt:3,fadeDuration:1},Gp={sources:[`/audio/outer-bgm.ogg`,`/audio/outer-bgm.m4a`],loop:!0,initialVolume:.56,defaultWantsToPlay:!0},Kp={minVolumeRatio:.2,volumeSyncEpsilon:.003},X=new wo(Vp.fov,window.innerWidth/window.innerHeight,Vp.near,Vp.far),qp=new V().subVectors(Y.intro.startTarget,Y.intro.startPos).normalize(),Jp=Y.intro.startPos.clone().addScaledVector(qp,-Y.loader.cameraPush.distance);X.position.copy(Jp);var Yp=new xu({antialias:!0,alpha:!0});function Xp(){return Math.min(window.devicePixelRatio,2)}Yp.setPixelRatio(Xp()),Yp.setSize(window.innerWidth,window.innerHeight),Yp.setClearColor(0,1),Yp.outputColorSpace=Ue,Yp.useLegacyLights=!1,Yp.toneMapping=4,Yp.toneMappingExposure=Up.exposure,zp.style.position=`relative`,zp.style.backgroundColor=`#000000`,Yp.domElement.style.position=`absolute`,Yp.domElement.style.top=`0`,Yp.domElement.style.left=`0`,Yp.domElement.style.zIndex=`1`,Yp.domElement.style.pointerEvents=`auto`,zp.appendChild(Yp.domElement);var Zp=null,Qp=null,$p=null,em=null,tm=null;function nm(e=kp.msaaSamples){let t=Ep(e,0);if(t<=0)return 0;let n=Yp.capabilities.maxSamples??0;return n>=t?t:n>=4?4:n>=2?2:0}function rm(){Qp?.dispose&&Qp.dispose(),em?.dispose&&em.dispose(),tm?.dispose&&tm.dispose(),Zp&&Zp.dispose(),Qp=null,$p=null,em=null,tm=null,Zp=null}function im(){rm();let e=Xp(),t=Math.max(1,Math.floor(window.innerWidth*e)),n=Math.max(1,Math.floor(window.innerHeight*e)),r=nm();Yp.setPixelRatio(e),Yp.setSize(window.innerWidth,window.innerHeight),Zp=new $t(t,n,{samples:r,type:y}),Qp=new jf(Yp,Zp),$p=new Mf(Bp,X),Qp.addPass($p),em=new Pf(new B(window.innerWidth,window.innerHeight),Up.bloom.strength,Up.bloom.radius,Up.bloom.threshold),em.enabled=kp.bloomEnabled,Qp.addPass(em),tm=new If,Qp.addPass(tm)}im();function am(){let e=Xp();return{pixelRatio:e,width:Math.max(1,Math.floor(window.innerWidth*e)),height:Math.max(1,Math.floor(window.innerHeight*e))}}function om(){let e=performance.memory;if(!e)return null;let t=e=>Number((e/(1024*1024)).toFixed(2));return{usedMB:t(e.usedJSHeapSize),totalMB:t(e.totalJSHeapSize),limitMB:t(e.jsHeapSizeLimit)}}function sm(){let e=am(),t=Ep(kp.msaaSamples,0),n=nm(t),r=$?.velocity?.lengthSq?.()??0,i=Q?.velocity?.lengthSq?.()??0,a=Q?.currentMouse?.distanceToSquared?.(Q.targetMouse)??0,o=Math.abs((Sm?.current??0)-(Sm?.target??0)),s=Cm?.lastUpdateAt?performance.now()-Cm.lastUpdateAt:null;return{ready:!Hf,isAnimating:Kf,physicsUnlocked:Uf,focused:Gf,benchmarkMode:Rf,assetProfile:zf,assetProfileLabel:Vf.label,bloomEnabled:kp.bloomEnabled,requestedMsaaSamples:t,effectiveMsaaSamples:n,msaaLabel:Dp(n),avgRenderMs:Number(Tp.avgRenderMs.toFixed(3)),avgFrameMs:Number(Tp.avgFrameMs.toFixed(3)),fps:Number(Tp.fps.toFixed(2)),resolution:e,rendererInfo:{calls:Yp.info.render.calls,triangles:Yp.info.render.triangles,lines:Yp.info.render.lines,points:Yp.info.render.points,frame:Yp.info.render.frame,geometries:Yp.info.memory.geometries,textures:Yp.info.memory.textures},jsHeap:om(),internals:{renderRequested:Tm.renderRequested,projectionInvalidated:Tm.projectionInvalidated,hasActiveSceneAnimation:Nm(performance.now()),hasSkyAnimation:Em(),walkVelocitySq:Number(r.toFixed(8)),parallaxVelocitySq:Number(i.toFixed(8)),parallaxDeltaSq:Number(a.toFixed(8)),screenOpacityDelta:Number(o.toFixed(8)),screenProjectionAgeMs:s==null?null:Number(s.toFixed(3))}}}function cm(e=2e4){return new Promise((t,n)=>{let r=performance.now();function i(){if(!Hf){t(sm());return}if(performance.now()-r>=e){n(Error(`Timed out waiting for outer scene readiness`));return}window.requestAnimationFrame(i)}i()})}function lm(e=3e4){return new Promise((t,n)=>{let r=performance.now();function i(){if(!Hf&&!Kf&&Uf){t(sm());return}if(performance.now()-r>=e){n(Error(`Timed out waiting for benchmark-stable scene state`));return}window.requestAnimationFrame(i)}i()})}function um(e=2e4){return new Promise((t,n)=>{let r=performance.now();function i(){if(typeof up==`function`){t(!0);return}if(performance.now()-r>=e){n(Error(`Timed out waiting for loader start prompt`));return}window.requestAnimationFrame(i)}i()})}function dm(e=3e3){return new Promise((t,n)=>{let r=Math.max(250,Number(e)||3e3),i=performance.now(),a=[],o=[],s=[],c=0;function l(){let e=sm(),n=e=>e.length?Number((e.reduce((e,t)=>e+t,0)/e.length).toFixed(3)):0,i=o.map(e=>e>0?1e3/e:0);t({...e,sampleDurationMs:r,sampleCount:a.length,windowAvgRenderMs:n(a),windowAvgFrameMs:n(o),windowAvgFps:n(i),windowMinFps:i.length?Number(Math.min(...i).toFixed(3)):0,windowMaxFps:i.length?Number(Math.max(...i).toFixed(3)):0,windowAvgHeapMB:n(s)})}function u(e){let t=sm();if(a.push(Tp.lastRenderMs||t.avgRenderMs),t.jsHeap?.usedMB!=null&&s.push(t.jsHeap.usedMB),c>0){let t=e-c;t>0&&t<250&&o.push(t)}if(c=e,performance.now()-i>=r){l();return}window.requestAnimationFrame(u)}cm().then(()=>u()).catch(n)})}window.__outerWebsiteDebug={getMetrics:sm,waitForReady:cm,waitForBenchmarkStable:lm,waitForStartPrompt:um,startExperience:()=>typeof up==`function`?(up(),!0):!1,sampleMetrics:dm};var fm=new Mu(X,Yp.domElement);fm.enabled=!1,fm.target.copy(Y.intro.startTarget);var pm=new uo,mm=new Ju,hm=new qd,gm=new _f;gm.setTranscoderPath(`/basis/`),gm.detectSupport(Yp);var _m=null,Z=null,vm=null,ym=[],bm=null,xm=null,Sm={runtimeEnabled:!1,current:0,target:0},Cm={quad:null,lastUpdateAt:0},wm={currentGain:1,fullVolumeDistance:0,minimumVolumeDistance:0,lastSyncedVolume:null},Tm={frameId:null,renderRequested:!0,projectionInvalidated:!0,skyFrameTimeoutId:null};function Em(){return!!xm}function Dm(e,t=yp){return e.lengthSq()<=t*t}function Om(e,t=vp){return e.lengthSq()<=t*t}function km(){Tm.skyFrameTimeoutId!==null&&(window.clearTimeout(Tm.skyFrameTimeoutId),Tm.skyFrameTimeoutId=null)}function Am(){Tm.renderRequested=!0,km(),Tm.frameId===null&&(Tm.frameId=window.requestAnimationFrame(Gh))}function jm(e=gp){Tm.renderRequested||Tm.frameId!==null||Tm.skyFrameTimeoutId!==null||(Tm.skyFrameTimeoutId=window.setTimeout(()=>{Tm.skyFrameTimeoutId=null,Tm.frameId===null&&(Tm.frameId=window.requestAnimationFrame(Gh))},Math.max(0,e)))}function Mm(){Tm.projectionInvalidated=!0,Am()}function Nm(e){return!!(Rf||Hf||Kf||Lh.w||Lh.a||Lh.s||Lh.d||Lh[` `]||Lh.control||$.active||$.velocity.lengthSq()>1e-6||Q.velocity.lengthSq()>1e-6||Q.currentMouse.distanceToSquared(Q.targetMouse)>1e-6||Sm.runtimeEnabled&&Math.abs(Sm.current-Sm.target)>.002)}function Pm(e=performance.now(),t=!1,n=!1){return Tm.projectionInvalidated?!0:t?!1:Gf?!!(Kf||Hf):Kf||Hf||n||Tm.renderRequested?!0:e-Cm.lastUpdateAt>=_p}function Fm(e=performance.now(),{skyOnly:t=!1,sceneAnimationActive:n=!1}={}){let r=performance.now();t||fh(),Qp.render(),t||Wh(),Pm(e,t,n)&&(Km(),Tm.projectionInvalidated=!1,Cm.lastUpdateAt=e),Mh(performance.now()-r,e)}function Im(e){if(!Z)return;let t=Nt.clamp(e,0,1),n=t.toFixed(3);Sm.current=t,Z.element.style.opacity!==n&&(Z.element.style.opacity=n)}function Lm(e){Z?.element&&(Z.element.style.pointerEvents!==e&&(Z.element.style.pointerEvents=e),vm&&vm.style.pointerEvents!==e&&(vm.style.pointerEvents=e))}function Rm(e,t){return[e[0]*t[0]+e[1]*t[3]+e[2]*t[6],e[0]*t[1]+e[1]*t[4]+e[2]*t[7],e[0]*t[2]+e[1]*t[5]+e[2]*t[8],e[3]*t[0]+e[4]*t[3]+e[5]*t[6],e[3]*t[1]+e[4]*t[4]+e[5]*t[7],e[3]*t[2]+e[4]*t[5]+e[5]*t[8],e[6]*t[0]+e[7]*t[3]+e[8]*t[6],e[6]*t[1]+e[7]*t[4]+e[8]*t[7],e[6]*t[2]+e[7]*t[5]+e[8]*t[8]]}function zm(e,t){return[e[0]*t[0]+e[1]*t[1]+e[2]*t[2],e[3]*t[0]+e[4]*t[1]+e[5]*t[2],e[6]*t[0]+e[7]*t[1]+e[8]*t[2]]}function Bm(e){return[e[4]*e[8]-e[5]*e[7],e[2]*e[7]-e[1]*e[8],e[1]*e[5]-e[2]*e[4],e[5]*e[6]-e[3]*e[8],e[0]*e[8]-e[2]*e[6],e[2]*e[3]-e[0]*e[5],e[3]*e[7]-e[4]*e[6],e[1]*e[6]-e[0]*e[7],e[0]*e[4]-e[1]*e[3]]}function Vm(e,t,n,r,i,a,o,s){let c=[e,n,i,t,r,a,1,1,1],l=zm(Bm(c),[o,s,1]);return Rm(c,[l[0],0,0,0,l[1],0,0,0,l[2]])}function Hm(e,t,n){let r=Vm(0,0,e,0,e,t,0,t),i=Rm(Vm(n[0].x,n[0].y,n[1].x,n[1].y,n[2].x,n[2].y,n[3].x,n[3].y),Bm(r)),a=i.map(e=>e/i[8]);return`matrix3d(${[a[0],a[3],0,a[6],a[1],a[4],0,a[7],0,0,1,0,a[2],a[5],0,a[8]].map(e=>Number.isFinite(e)?e.toFixed(10):`0`).join(`,`)})`}function Um(e){if(e.clone().applyMatrix4(X.matrixWorldInverse).z>=-.001)return null;let t=e.clone().project(X);return!Number.isFinite(t.x)||!Number.isFinite(t.y)?null:{x:(t.x*.5+.5)*window.innerWidth,y:(-t.y*.5+.5)*window.innerHeight}}function Wm(){if(!Z)return null;Z.updateMatrixWorld(!0);let e=[new V(-jp.width/2,jp.height/2,0),new V(jp.width/2,jp.height/2,0),new V(jp.width/2,-jp.height/2,0),new V(-jp.width/2,-jp.height/2,0)],t=[];for(let n of e){let e=Um(n.applyMatrix4(Z.matrixWorld));if(!e)return null;t.push(e)}return t}function Gm(){Z?.element&&(Z.element.style.display=`none`,Cm.quad=null)}function Km(){if(!Z?.element||!vm?.src){Gm();return}X.updateMatrixWorld(!0),X.updateProjectionMatrix();let e=Wm();if(!e){Gm();return}let t=Hm(jp.width,jp.height,e),{element:n}=Z;Cm.quad=e,n.style.display!==`block`&&(n.style.display=`block`),n.style.transform!==t&&(n.style.transform=t)}function qm(e,t){if(!Cm.quad||Cm.quad.length!==4)return!1;let n=0;for(let r=0;r<Cm.quad.length;r+=1){let i=Cm.quad[r],a=Cm.quad[(r+1)%Cm.quad.length],o=(a.x-i.x)*(t-i.y)-(a.y-i.y)*(e-i.x);if(Math.abs(o)<=.5)continue;let s=Math.sign(o);if(n===0){n=s;continue}if(n!==s)return!1}return!0}function Jm(e){e.traverse(e=>{e.isMesh&&(e.name.toLowerCase().includes(`screen_plane`)||e.name.toLowerCase().includes(`hitbox`)||(Array.isArray(e.material)?e.material:[e.material]).forEach(e=>{Cp.includes(e)||(Cp.push(e),e.onBeforeCompile=t=>{e.userData.shader=t,t.uniforms.uShockwaveRadius={value:0},t.uniforms.uShockwaveCenter={value:wp},t.uniforms.uEdgeIntensity={value:Y.loader.shockwave.edgeIntensity},t.vertexShader=`
        ...
        `.replace(`#include <dithering_fragment>`,`
          ...
          `)})}))})}function Ym(e,t={}){return e.wrapS=r,e.wrapT=i,new Oa({transparent:!0,uniforms:{tSky:{value:e},uExposure:{value:Hp.exposure},uSaturation:{value:Hp.saturation},uHighlights:{value:Hp.highlights},uRepeat:{value:new B(t.repeatX??Hp.repeatX,t.repeatY??Hp.repeatY)},uOffsetY:{value:t.offsetY??Hp.offsetY},uSkyOpacity:{value:0}},vertexShader:`varying vec2 vUv; void main() { vUv = uv; gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0); }`,fragmentShader:`
    ...
    `,side:0,toneMapped:!1})}var Xm={computer:{path:Vf.lightMapPaths.computer}},Zm={room:{path:Vf.bakedSurfacePaths.room},table:{path:Vf.bakedSurfacePaths.table},chairBack:{path:Vf.bakedSurfacePaths.chairBack},chairLeft:{path:Vf.bakedSurfacePaths.chairLeft},chairRight:{path:Vf.bakedSurfacePaths.chairRight}},Qm=new Set([`room`,`table`]),$m={computer:{envMapIntensity:10.95,roughnessMin:.8}};function eh(e){e.map&&(e.map.colorSpace=Ue),e.emissiveMap&&(e.emissiveMap.colorSpace=Ue)}function th(e){let t=e.getAttribute(`uv`);if(!t)return;let n=new Float32Array(t.array.length);n.set(t.array),e.setAttribute(`uv1`,new Sr(n,t.itemSize))}function nh(e){return e.includes(`room`)||e.includes(`wall`)||e.includes(`floor`)||e.includes(`ceiling`)?`room`:(e.includes(`table`)||e.includes(`desk`))&&!e.includes(`portable`)?`table`:e.includes(`chair_back`)||e.includes(`chair`)&&e.includes(`back`)?`chairBack`:e.includes(`chair_left`)||e.includes(`chair`)&&e.includes(`left`)?`chairLeft`:e.includes(`chair_right`)||e.includes(`chair`)&&e.includes(`right`)?`chairRight`:null}function rh(e){return e.includes(`computer`)||e.includes(`pc`)||e.includes(`monitor`)||e.includes(`portable`)||e.includes(`bm86`)?`computer`:null}function ih(e){return Qm.has(e)}async function ah(e,t={}){let n=await pm.loadAsync(e);return n.flipY=t.flipY??!1,t.colorSpace&&(n.colorSpace=t.colorSpace),n}async function oh(e,t={}){if(e.toLowerCase().endsWith(`.ktx2`)){let n=await gm.loadAsync(e);return t.colorSpace&&(n.colorSpace=t.colorSpace),n}return ah(e,t)}function sh(){let e=document.createElement(`div`);e.style.width=`${jp.width}px`,e.style.height=`${jp.height}px`,e.style.backgroundColor=`#ffffff`,e.style.backfaceVisibility=`hidden`,e.style.position=`fixed`,e.style.left=`0`,e.style.top=`0`,e.style.overflow=`hidden`,e.style.pointerEvents=`none`,e.style.display=`none`,e.style.opacity=`0`,e.style.transformOrigin=`0 0`,e.style.willChange=`transform, opacity`,e.style.zIndex=`2`;let t=document.createElement(`iframe`);return t.style.position=`absolute`,t.style.left=`0`,t.style.top=`0`,t.style.width=`100%`,t.style.height=`100%`,t.style.border=`0`,t.style.backgroundColor=`#ffffff`,t.style.pointerEvents=`none`,t.allow=`autoplay`,e.appendChild(t),vm=t,wm.lastSyncedVolume=null,e}function ch(e){if(!e||Z)return;let t=sh();Z=new kn,Z.element=t,Bp.add(Z),document.body.appendChild(t),e.updateWorldMatrix(!0,!1),e.geometry.computeBoundingBox();let n=e.geometry.boundingBox,r=new V;n.getCenter(r);let i=r.applyMatrix4(e.matrixWorld);Z.position.copy(i),Z.rotation.set(jp.rotationX,jp.rotationY,jp.rotationZ,`YXZ`),Z.translateZ(jp.offsetZ),Z.translateX(jp.offsetX),Z.translateY(jp.offsetY);let a=new V;n.getSize(a);let o=[a.x,a.y,a.z].sort((e,t)=>t-e),s=o[0]/jp.width*jp.scaleMultiplier*jp.scaleX,c=o[1]/jp.height*jp.scaleMultiplier*jp.scaleY;Z.scale.set(s,c,1),Z.updateMatrixWorld(!0);let l=new V(0,0,1).applyQuaternion(Z.quaternion).normalize();xp.copy(Z.position).addScaledVector(l,Y.focus.distance),xp.y+=Y.focus.yOffset,Sp.copy(Z.position),Sp.x+=Y.focus.targetOffsetX,Sp.y+=Y.focus.targetOffsetY,Sp.z+=Y.focus.targetOffsetZ,wm.fullVolumeDistance=xp.distanceTo(Z.position),wm.minimumVolumeDistance=Math.max(wm.fullVolumeDistance+1e-4,Jp.distanceTo(Z.position),Y.intro.startPos.distanceTo(Z.position),Y.unfocus.endPos.distanceTo(Z.position)),wm.currentGain=uh(X.position.distanceTo(Z.position)),Mm()}function lh(e){return Nt.clamp(e,0,1)}function uh(e){let t=wm.fullVolumeDistance,n=Math.max(wm.minimumVolumeDistance,t+1e-4);if(!(t>0)||!(n>t)||e<=t)return 1;if(e>=n)return Kp.minVolumeRatio;let r=(e-t)/(n-t),i=r*r*(3-2*r);return Nt.lerp(1,Kp.minVolumeRatio,i)}function dh(e){return lh(e*wm.currentGain)}function fh(){if(!Z||!vm||!_h)return;let e=uh(X.position.distanceTo(Z.position));Math.abs(e-wm.currentGain)<.001||(wm.currentGain=e,hh(_h.getState().volume))}function ph(){!vm||vm.getAttribute(`src`)||(vm.src=jp.url,Mm(),vm.addEventListener(`load`,()=>{mh(_h.getState().isMuted),hh(_h.getState().volume),Mm()},{once:!0}))}function mh(e){vm?.contentWindow&&vm.contentWindow.postMessage({type:dp.SET_MUTED,muted:!!e},window.location.origin)}function hh(e){if(!vm?.contentWindow)return;let t=dh(e);wm.lastSyncedVolume!==null&&Math.abs(wm.lastSyncedVolume-t)<Kp.volumeSyncEpsilon||(wm.lastSyncedVolume=t,vm.contentWindow.postMessage({type:dp.SET_VOLUME,volume:t},window.location.origin))}function gh(){let e=(Array.isArray(Gp.sources)?Gp.sources:[Gp.src]).filter(Boolean),t=new Audio;t.preload=`auto`,t.loop=Gp.loop,t.volume=Gp.initialVolume,t.playsInline=!0;let n=!1,r=!0,i=0,a=null,o=0,s=null,c=0,l=null,u=null,d={hasSource:e.length>0,hasError:!1,isMuted:!1,isPlaying:!1,needsUserGesture:!1,unlockArmed:!1,volume:Gp.initialVolume,wantsToPlay:Gp.defaultWantsToPlay},f=()=>e[o]||``,p=()=>{let e=f();return e?(t.getAttribute(`src`)!==e&&(t.src=e),!0):(t.removeAttribute(`src`),!1)},m=()=>o>=e.length-1?!1:(o+=1,n=!1,p()),h=()=>{typeof l==`function`&&l({...d,currentSource:f()})},g=()=>{a!==null&&(window.clearTimeout(a),a=null)},_=()=>{i=0,g()},v=(e,n=240)=>!d.wantsToPlay||d.needsUserGesture?!1:a===null?i>=12?!1:(a=window.setTimeout(()=>{a=null,i+=1,t.readyState===0&&!d.hasError&&t.load(),k(`${e}-retry-${i}`)},n),!0):!0,y=({restoreVolume:e=!1}={})=>{c+=1,s!==null&&(window.cancelAnimationFrame(s),s=null),e&&(t.volume=lh(d.volume))},b=e=>{if(t.paused||t.muted||r||t.volume<=.001){e();return}y();let n=c,i=t.volume,a=performance.now(),o=r=>{if(n!==c)return;let l=Math.min((r-a)/mp,1);if(t.volume=Nt.lerp(i,0,l),l<1){s=window.requestAnimationFrame(o);return}s=null,e()};s=window.requestAnimationFrame(o)},x=(e=!1)=>{t.muted=e||d.isMuted||r,t.volume=lh(d.volume)},S=async()=>{if(!d.hasSource||n)return!1;x(!0);try{return await t.play(),_(),n=!0,d.hasError=!1,d.isPlaying=!0,d.needsUserGesture=!1,O(),h(),!0}catch{return x(),v(`prime-muted-autoplay`),!1}},C=()=>!n||t.paused?!1:(y({restoreVolume:!0}),t.currentTime=0,x(),_(),d.hasError=!1,d.isPlaying=!0,d.needsUserGesture=!1,O(),h(),!0),w=()=>{if(!n||t.paused)return!1;t.pause();try{t.currentTime=0}catch{return!1}return d.isPlaying=!1,!0},T=(e=`timeline-sync`)=>{if(!r){d.wantsToPlay&&!d.isPlaying?k(e):(x(),h());return}if(r=!1,d.needsUserGesture=!1,d.hasError=!1,_(),O(),x(),!d.wantsToPlay){h();return}k(w()?`${e}-restart-from-zero`:e)},E=()=>{window.setTimeout(()=>{t.currentTime<.25&&(t.currentTime=0),x(),h()},80)},D=async()=>{x(!0);try{return await t.play(),_(),d.hasError=!1,d.isPlaying=!0,d.needsUserGesture=!1,O(),E(),h(),!0}catch{return x(),!1}},O=()=>{!d.unlockArmed||!u||([`pointerdown`,`keydown`,`touchstart`].forEach(e=>{window.removeEventListener(e,u,!0)}),u=null,d.unlockArmed=!1)},ee=()=>{d.unlockArmed||=(u=()=>{O(),d.wantsToPlay&&k(`user-gesture`)},[`pointerdown`,`keydown`,`touchstart`].forEach(e=>{window.addEventListener(e,u,!0)}),!0)},k=async(e=`manual`)=>{if(d.wantsToPlay=!0,y({restoreVolume:!0}),!d.hasSource)return h(),!1;if(C())return!0;d.hasError&&=(t.load(),!1),x();try{return await t.play(),_(),d.hasError=!1,d.isPlaying=!0,d.needsUserGesture=!1,O(),h(),!0}catch(n){return d.isPlaying=!t.paused,n?.name===`NotAllowedError`?await D()||(d.hasError=!1,v(`autoplay-blocked`)||(d.needsUserGesture=!0,ee())):n?.name===`AbortError`||n?.name===`NotSupportedError`?(d.hasError=!1,v(n.name===`AbortError`?`media-aborted`:`media-not-ready`)||(d.hasError=!0)):(d.hasError=!0,console.warn(`[BGM] Unable to play audio (${e}).`,n)),h(),!1}},te=()=>{d.wantsToPlay=!1,d.needsUserGesture=!1,_(),O(),b(()=>{t.pause(),y({restoreVolume:!0}),d.isPlaying=!1,h()})},A=()=>{if(d.isPlaying||d.wantsToPlay){te();return}k(`toggle`)},j=e=>{let t=()=>{d.isMuted=e,x(),mh(d.isMuted),h()};if(e!==d.isMuted){if(e){b(t);return}y({restoreVolume:!0}),t()}};return t.addEventListener(`play`,()=>{d.isPlaying=!0,h()}),t.addEventListener(`pause`,()=>{d.isPlaying=!1,h()}),t.addEventListener(`ended`,()=>{d.isPlaying=!1,h()}),t.addEventListener(`canplay`,()=>{d.wantsToPlay&&!d.isPlaying&&!d.needsUserGesture&&v(`canplay`,0)}),t.addEventListener(`error`,()=>{let e=t.error?.code??null;if(e===1||e===null){v(`media-load-aborted`);return}if(e===4){if(m()){_(),d.hasError=!1,d.isPlaying=!1,t.load(),d.wantsToPlay&&(r?S():k(`media-source-fallback`)),h();return}if(v(`media-source-error`,320))return}d.hasError=!0,d.isPlaying=!1,console.warn(`[BGM] Audio source could not be loaded: ${f()}`),h()}),x(),d.hasSource&&p()&&(t.load(),d.wantsToPlay&&S()),{getState(){return{...d,currentSource:f()}},pause:te,play:k,releaseQueuedPlayback:T,setVolume:e=>{y(),d.volume=lh(e),d.volume>0&&d.isMuted&&(d.isMuted=!1),x(),hh(d.volume),mh(d.isMuted),h()},setOnChange(e){l=e,h()},toggleMute:()=>{j(!d.isMuted)},togglePlay:A}}var _h=gh(),vh={soundOn:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M15.54 8.46a5 5 0 0 1 0 7.07"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14"/></svg>`,soundOff:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><line x1="23" y1="9" x2="17" y2="15"/><line x1="17" y1="9" x2="23" y2="15"/></svg>`,play:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round"><polygon points="8 5 19 12 8 19 8 5"/></svg>`,pause:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="9" y1="5" x2="9" y2="19"/><line x1="15" y1="5" x2="15" y2="19"/></svg>`,volumeLow:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M15 12a3 3 0 0 0 0-0.01"/></svg>`,volumeMid:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M15.5 9.5a4 4 0 0 1 0 5"/></svg>`,volumeHigh:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M15.5 8.5a5.5 5.5 0 0 1 0 7"/><path d="M18.8 6a9 9 0 0 1 0 12"/></svg>`,camUnfocused:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/><circle cx="12" cy="13" r="4"/></svg>`,camFocused:`<svg width="13" height="13" viewBox="0 0 24 24" fill="#ff7b00" stroke="#ff7b00" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/><circle cx="12" cy="13" r="4"/></svg>`,fx:`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#ff7b00" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 7h8"/><path d="M4 17h14"/><path d="M14 7h6"/><path d="M10 17h4"/><circle cx="12" cy="7" r="2"/><circle cx="8" cy="17" r="2"/></svg>`},yh={wasd:`<svg width="46" height="30" viewBox="0 0 46 30" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`};function bh(){qf&&(Gf?qf.innerHTML=vh.camFocused:qf.innerHTML=vh.camUnfocused)}function xh(e){return e>=.75?vh.volumeHigh:e>=.4?vh.volumeMid:vh.volumeLow}function Sh(e){return e.isMuted?`Muted`:`${Math.round(e.volume*100)}%`}function Ch(){cp!==null&&(window.clearTimeout(cp),cp=null)}function wh(){Ch(),sp&&(cp=window.setTimeout(()=>{Th(!1)},pp))}function Th(e){e&&lp&&kh(!1),sp=e,Zf&&Zf.classList.toggle(`is-open`,sp),sp?wh():Ch()}function Eh(){return`Bloom ${kp.bloomEnabled?`On`:`Off`} | MSAA ${Dp(kp.msaaSamples)}`}function Dh(e,t,n,r=`On`,i=`Off`){e&&(e.classList.toggle(`is-active`,n),e.innerHTML=`<span>${t}</span><strong>${n?r:i}</strong>`)}function Oh(){if(tp&&(tp.classList.toggle(`is-active`,lp),tp.title=Eh()),np&&np.classList.toggle(`is-open`,lp),Dh(ip,`Bloom`,kp.bloomEnabled),Dh(ap,`MSAA`,Ep(kp.msaaSamples,0)>0,Dp(kp.msaaSamples)),ap&&(ap.title=`Cycle MSAA: 4x, 2x, Off`),rp){let e=Xp(),t=Math.max(1,Math.floor(window.innerWidth*e)),n=Math.max(1,Math.floor(window.innerHeight*e)),r=Tp.avgRenderMs>0?Tp.avgRenderMs.toFixed(1):`0.0`,i=performance.now()-Tp.lastFrameNow>500?0:Math.round(Tp.fps);rp.textContent=`Avg ${r} ms | FPS ${i} | ${t}x${n}`}}function kh(e){e&&sp&&Th(!1),lp=e,Oh(),Am()}function Ah(e){kp.bloomEnabled=!!e.bloomEnabled,kp.msaaSamples=Ep(e.msaaSamples,kp.msaaSamples),Ap(),im(),Oh(),Am()}function jh(e){if(e===`msaaSamples`){let e=Ep(kp.msaaSamples,0),t=bp.indexOf(e),n=bp[t===-1?0:(t+1)%bp.length];Ah({...kp,msaaSamples:n});return}Ah({...kp,[e]:!kp[e]})}function Mh(e,t=performance.now()){if(Tp.lastRenderMs=e,Tp.avgRenderMs=Tp.avgRenderMs===0?e:Nt.lerp(Tp.avgRenderMs,e,.18),Tp.lastFrameNow>0){let e=t-Tp.lastFrameNow;e>0&&e<250&&(Tp.avgFrameMs=Tp.avgFrameMs===0?e:Nt.lerp(Tp.avgFrameMs,e,.2),Tp.fps=Tp.avgFrameMs>0?1e3/Tp.avgFrameMs:0)}Tp.lastFrameNow=t,!(t-Tp.lastUiUpdate<250)&&(Tp.lastUiUpdate=t,Oh())}function Nh(e=_h.getState()){Jf&&(Jf.innerHTML=e.isMuted?vh.soundOff:vh.soundOn,Jf.title=e.isMuted?`Unmute all audio`:`Mute all audio`),Yf&&(Yf.innerHTML=e.isPlaying||e.wantsToPlay?vh.pause:vh.play,e.hasError?Yf.title=`BGM unavailable (${e.currentSource||`no source`})`:e.needsUserGesture&&!e.isPlaying?Yf.title=`Click to start music`:e.wantsToPlay&&!e.isPlaying?Yf.title=`Music queued to start`:Yf.title=e.isPlaying?`Pause music`:`Play music`),Xf&&(Xf.innerHTML=xh(e.volume),Xf.title=`Adjust volume (${Math.round(e.volume*100)}%)`),Qf&&(Qf.value=`${Math.round(e.volume*100)}`),$f&&($f.textContent=Sh(e))}_h.setOnChange(Nh);function Ph(){let e=document.createElement(`style`);e.textContent=`
    #ui-tl {
      position: fixed; top: 18px; left: 18px; z-index: 100;
      display: flex; align-items: center; gap: 10px;
      opacity: 0; transition: opacity ${Wp.fadeDuration}s ease;
      font-family: "Controller W01 Two Oblique", 'Courier New', Courier, monospace;
  ...
  `,document.head.appendChild(e);let t=document.createElement(`div`);t.id=`ui-tl`;let n=document.createElement(`span`);n.id=`ui-name`,n.textContent=`Hanqi Zhao`,Yf=document.createElement(`button`),Yf.className=`ui-btn`,Yf.addEventListener(`click`,()=>{_h.togglePlay()});let r=document.createElement(`div`);ep=r,r.className=`ui-volume-control`,Xf=document.createElement(`button`),Xf.className=`ui-btn`,Xf.addEventListener(`click`,()=>{Th(!sp)}),Zf=document.createElement(`div`),Zf.className=`ui-volume-panel`;let i=document.createElement(`div`);i.className=`ui-volume-title`,i.innerHTML=`<span>Volume</span>`,$f=document.createElement(`span`),$f.className=`ui-volume-value`,i.appendChild($f),Qf=document.createElement(`input`),Qf.className=`ui-volume-slider`,Qf.type=`range`,Qf.min=`0`,Qf.max=`100`,Qf.step=`1`,Qf.addEventListener(`input`,e=>{_h.setVolume(Number(e.target.value)/100),wh()}),Zf.appendChild(i),Zf.appendChild(Qf),r.appendChild(Xf),r.appendChild(Zf);let a=document.createElement(`div`);op=a,a.className=`ui-postfx-control`,tp=document.createElement(`button`),tp.className=`ui-btn`,tp.innerHTML=vh.fx,tp.addEventListener(`click`,()=>{kh(!lp)}),np=document.createElement(`div`),np.className=`ui-postfx-panel`;let o=document.createElement(`div`);o.className=`ui-postfx-header`,o.innerHTML=`<span>Render FX</span>`;let s=document.createElement(`span`);s.className=`ui-postfx-summary`,s.textContent=Vf.label,o.appendChild(s);let c=document.createElement(`div`);c.className=`ui-postfx-toggles`,ip=document.createElement(`button`),ip.className=`ui-postfx-toggle`,ip.type=`button`,ip.addEventListener(`click`,()=>{jh(`bloomEnabled`)}),ap=document.createElement(`button`),ap.className=`ui-postfx-toggle`,ap.type=`button`,ap.addEventListener(`click`,()=>{jh(`msaaSamples`)}),c.appendChild(ip),c.appendChild(ap),rp=document.createElement(`div`),rp.className=`ui-postfx-stats`,np.appendChild(o),np.appendChild(c),np.appendChild(rp),a.appendChild(tp),a.appendChild(np),Jf=document.createElement(`button`),Jf.className=`ui-btn`,Jf.addEventListener(`click`,()=>{_h.toggleMute()}),qf=document.createElement(`button`),qf.className=`ui-btn`,qf.innerHTML=vh.camUnfocused,qf.title=`Toggle focus`,qf.addEventListener(`click`,()=>{Kf||!Uf||(Gf?(Gf=!1,bh(),Vh(X.position.clone(),fm.target.clone(),Y.unfocus.endPos,Y.unfocus.endTarget,Y.unfocus.duration,Y.unfocus.easing)):(Gf=!0,bh(),Vh(X.position.clone(),fm.target.clone(),xp,Sp,Y.focus.duration,Y.focus.easing)))}),t.appendChild(n),t.appendChild(Yf),t.appendChild(r),t.appendChild(Jf),t.appendChild(a),t.appendChild(qf),document.body.appendChild(t),document.addEventListener(`pointerdown`,e=>{let t=ep?.contains(e.target),n=op?.contains(e.target);sp&&t?wh():sp&&Th(!1),lp&&!n&&kh(!1)}),document.addEventListener(`pointermove`,()=>{sp&&wh()}),document.addEventListener(`wheel`,()=>{sp&&wh()},{passive:!0}),document.addEventListener(`keydown`,e=>{if(e.key===`Escape`){Th(!1),kh(!1);return}sp&&wh()}),Nh(),Oh();let l=document.createElement(`div`);l.id=`ui-bl`,l.innerHTML=`
    <div class="ui-hint">${yh.wasd}<span>: move</span></div>
    <div class="ui-hint">${yh.space}<span>: up</span></div>
    <div class="ui-hint">${yh.ctrl}<span>: down</span></div>
  `,document.body.appendChild(l);let u=document.createElement(`div`);return u.id=`ui-br`,u.innerHTML=`<div class="ui-copy">© Copyright 2026 Hanqi Zhao.</div>`,document.body.appendChild(u),{tl:t,bl:l,br:u}}async function Fh(){try{let[e,t,n,r,i]=await Promise.all([Vf.visualSky.kind===`hdr`?hm.loadAsync(Vf.visualSky.path):ah(Vf.visualSky.path,{colorSpace:Ue,flipY:Vf.visualSky.flipY??!1}),Vf.lightingEnvironment.kind===`hdr`?hm.loadAsync(Vf.lightingEnvironment.path):ah(Vf.lightingEnvironment.path,{colorSpace:Ue,flipY:Vf.lightingEnvironment.flipY??!1}),mm.loadAsync(`/models/room_all.glb`),Promise.all(Object.entries(Zm).map(async([e,t])=>[e,await oh(t.path,{colorSpace:Ue})])),Promise.all(Object.entries(Xm).map(async([e,t])=>{let n=await oh(t.path,{colorSpace:``});return n.channel=1,[e,n]}))]),a=Object.fromEntries(r),o=Object.fromEntries(i),s=new ba(200,32,20);s.scale(-1,1,1),xm=new li(s,Ym(e,Vf.visualSky)),xm.position.y=-100,xm.rotation.y=Hp.rotationY,Bp.add(xm),t.mapping=303,Bp.environment=t,Bp.environmentIntensity=Vf.lightingEnvironment.intensity??1.2;let c=n.scene;if(c.traverse(e=>{if(!e.isMesh)return;let t=(e.name??``).toLowerCase();(t.includes(`computer`)||t.includes(`screen`)||t.includes(`monitor`))&&ym.push(e),t.includes(`screen_plane`)&&(_m=e,wp.setFromMatrixPosition(e.matrixWorld),wp.add(Y.loader.shockwave.centerOffset),_m.material=new Zr({colorWrite:!1,depthWrite:!0}),_m.renderOrder=-1)}),Jm(c),c.traverse(e=>{if(!e.isMesh)return;let t=(e.name??``).toLowerCase();t.includes(`screen_plane`)||(Array.isArray(e.material)?e.material:[e.material]).forEach(n=>{if(!n)return;eh(n);let r=nh(t),i=rh(t);if(r&&a[r]){n.map=a[r],n.dithering=ih(r),n.needsUpdate=!0;return}n.isMeshStandardMaterial&&i&&o[i]&&(th(e.geometry),n.lightMap=o[i],$m[i]&&(n.envMapIntensity=$m[i].envMapIntensity,n.roughness<$m[i].roughnessMin&&(n.roughness=$m[i].roughnessMin)),n.needsUpdate=!0)})}),Bp.add(c),ym.length>0){let e=new $n;ym.forEach(t=>{t.updateMatrixWorld(!0),e.union(new $n().setFromObject(t))});let t=new V;e.getCenter(t);let n=new V;e.getSize(n),bm=new li(new va(n.x,n.y,n.z),new Zr({colorWrite:!1,depthWrite:!1,transparent:!0,opacity:0})),bm.position.copy(t),bm.scale.setScalar(Y.focus.hitboxScale),Bp.add(bm),_m||(wp.copy(t),wp.add(Y.loader.shockwave.centerOffset))}_m&&ch(_m),await Promise.all([Lp,new Promise(e=>setTimeout(e,Y.loader.minLoadTime))]),await Rp(),Fp.style.opacity=`0`,await new Promise(e=>setTimeout(e,Y.loader.fadeTime*1e3)),Fp.remove(),ph();let l=Ph();{let e=performance.now(),t=!1,n=e=>e===1?1:1-2**(-10*e),r=e=>e<.5?4*e*e*e:1-(-2*e+2)**3/2;function i(){let a=(performance.now()-e)/1e3;if(!Uf){let e=Y.loader.cameraPush,t=0;a>=e.startTime&&(t=Math.min((a-e.startTime)/e.duration,1)),X.position.lerpVectors(Jp,Y.intro.startPos,r(t)),X.lookAt(fm.target)}let o=Y.loader.shockwave,s=0;a>=o.startTime&&(s=Math.min((a-o.startTime)/o.duration,1));let c=Nt.lerp(o.startRadius,o.endRadius,n(s));s>=1&&(c=9999),Cp.forEach(e=>{e.userData.shader&&(e.userData.shader.uniforms.uShockwaveRadius.value=c)});let u=Y.loader.skyFade,d=0;a>=u.startTime&&(d=Math.min((a-u.startTime)/u.duration,1)),xm&&xm.material&&(xm.material.uniforms.uSkyOpacity.value=d),!Uf&&a>=Y.loader.controlsUnlockTime&&(Uf=!0,Q.locked=!0,Q.targetMouse.set(0,0),Q.currentMouse.set(0,0),Q.lockBaseMouse.copy(Ih),zh());let f=Y.loader.screenFade;a>=f.startTime&&!Wf&&(Wf=!0,Sm.runtimeEnabled=!1,Z&&(Z.element.style.transition=`opacity ${f.duration}s ease-in-out`,requestAnimationFrame(()=>{Z.element.style.opacity=`1`,setTimeout(()=>{Z&&(Z.element.style.transition=``,Sm.runtimeEnabled=!0,Sm.target=1,Im(1))},f.duration*1e3+100)}))),!t&&a>=Wp.appearAt&&(t=!0,l.tl.style.opacity=`1`,l.bl.style.opacity=`1`,l.br.style.opacity=`1`),a<Math.max(Y.loader.cameraPush.startTime+Y.loader.cameraPush.duration,o.startTime+o.duration,u.startTime+u.duration,f.startTime+f.duration,Y.loader.controlsUnlockTime)?requestAnimationFrame(i):Hf=!1}i()}}catch(e){console.error(e)}}var Ih=new B,Q={locked:!0,lockBaseMouse:new B,targetMouse:new B,currentMouse:new B,velocity:new B},Lh={w:!1,a:!1,s:!1,d:!1," ":!1,control:!1},Rh=performance.now();function zh(){Rh=performance.now()}window.addEventListener(`pointermove`,e=>{Ih.x=e.clientX/window.innerWidth*2-1,Ih.y=-(e.clientY/window.innerHeight)*2+1,Uf&&(zh(),!Kf&&!Gf&&Q.locked&&Ih.distanceTo(Q.lockBaseMouse)>Y.parallax.unlockThreshold&&(Q.locked=!1),Am())}),window.addEventListener(`keydown`,e=>{if(!Uf)return;zh();let t=e.key.toLowerCase();t===` `&&e.preventDefault(),Lh[t]!==void 0&&(Lh[t]=!0),Am()},{passive:!1}),window.addEventListener(`keyup`,e=>{if(!Uf)return;zh();let t=e.key.toLowerCase();Lh[t]!==void 0&&(Lh[t]=!1),Am()}),window.addEventListener(`wheel`,()=>{Uf&&(zh(),Am())}),Yp.domElement.addEventListener(`contextmenu`,e=>e.preventDefault());var Bh={linear:e=>e,easeOutCubic:e=>1-(1-e)**3,easeInOutCubic:e=>e<.5?4*e*e*e:1-(-2*e+2)**3/2};function Vh(e,t,n,r,i,a,o){Kf=!0;let s=performance.now(),c=Bh[a]||Bh.easeInOutCubic;Am();function l(){let a=(performance.now()-s)/i;a>1&&(a=1);let u=c(a);X.position.lerpVectors(e,n,u),fm.target.lerpVectors(t,r,u),X.lookAt(fm.target),X.updateProjectionMatrix(),Am(),a<1?requestAnimationFrame(l):(Kf=!1,$.velocity.set(0,0,0),Q.locked=!0,Q.lockBaseMouse.copy(Ih),Q.targetMouse.set(0,0),Q.currentMouse.set(0,0),Q.velocity.set(0,0),zh(),o&&o(),Am())}l()}var Hh=new es,Uh=0;Yp.domElement.addEventListener(`pointerdown`,e=>{!Uf||Kf||(zh(),Uh=performance.now(),Am())}),Yp.domElement.addEventListener(`pointerup`,e=>{if(!(!Uf||Kf)){if(performance.now()-Uh<300){if(Ih.x=e.clientX/window.innerWidth*2-1,Ih.y=-(e.clientY/window.innerHeight)*2+1,Gf){if(qm(e.clientX,e.clientY))return;Gf=!1,bh(),Vh(X.position.clone(),fm.target.clone(),Y.unfocus.endPos,Y.unfocus.endTarget,Y.unfocus.duration,Y.unfocus.easing);return}Hh.setFromCamera(Ih,X);let t=bm?[bm]:ym;if(Hh.intersectObjects(t,!0).length>0&&Z){let e=new V(0,0,1).applyQuaternion(Z.quaternion).normalize(),t=new V().subVectors(X.position,Z.position).normalize();e.angleTo(t)*(180/Math.PI)<=Y.focus.maxTriggerAngle&&(Gf=!0,bh(),Vh(X.position.clone(),fm.target.clone(),xp,Sp,Y.focus.duration,Y.focus.easing))}}Am()}});function Wh(){if(!_m||!Z)return;let e=Gf&&!Kf&&!!vm?.src;if(!Wf){Lm(e?`auto`:`none`);return}if(!Sm.runtimeEnabled){Lm(e?`auto`:`none`);return}let t=new V(0,0,1).applyQuaternion(Z.quaternion).normalize(),n=new V().subVectors(X.position,Z.position).normalize(),r=X.position.distanceTo(Z.position),i=t.dot(n)>=0,a=0,o=`none`;if(e)a=1,o=`auto`;else if(i){let e=Y.shield.maxClickDistance+Y.shield.fadeDistance;if(r<=Y.shield.maxClickDistance)a=1;else if(r>=e)a=Y.shield.dimOpacity;else{let e=1-(r-Y.shield.maxClickDistance)/Y.shield.fadeDistance;a=Nt.lerp(Y.shield.dimOpacity,1,e)}}Sm.target=a;let s=Nt.lerp(Sm.current,Sm.target,Y.shield.opacityLerp);Im(Math.abs(s-Sm.target)<.002?Sm.target:s),Lm(o)}var $={active:!1,chargeStart:0,releaseStart:0,dist:0,currentDir:new V,velocity:new V};function Gh(e){Tm.frameId=null;let t=Em(),n=Tm.renderRequested,r=Nm(e)||t,i=e-Rh>Y.parallax.idleTimeout;if(!r&&!Tm.renderRequested)return;if(xm&&t&&(xm.rotation.y+=Y.sky.rotationSpeed),!Uf){Fm(e,{skyOnly:!1,sceneAnimationActive:!0}),Tm.renderRequested=!1,r&&Am();return}if(!Gf&&!Kf){let t=new V;X.getWorldDirection(t),t.y=0,t.normalize();let n=new V().crossVectors(t,X.up).normalize(),r=new V(0,1,0),a=new V;Lh.w&&a.add(t),Lh.s&&a.sub(t),Lh.a&&a.sub(n),Lh.d&&a.add(n),Lh[` `]&&a.add(r),Lh.control&&a.sub(r),a.lengthSq()>0?($.releaseStart=0,$.active?$.currentDir.lerp(a.normalize(),Y.walk.dirLerp).normalize():($.chargeStart===0&&($.chargeStart=e),e-$.chargeStart>Y.walk.chargeTime&&($.active=!0,$.dist=0,$.currentDir.copy(a.normalize())))):($.chargeStart=0,$.active&&($.releaseStart===0&&($.releaseStart=e),e-$.releaseStart>Y.walk.releaseGrace&&($.active=!1)),i&&($.active=!1,$.releaseStart=0,$.currentDir.set(0,0,0),$.velocity.set(0,0,0))),$.active&&$.dist>=Y.walk.maxDist&&($.active=!1);let o=new V;if($.active?(o.copy($.currentDir).multiplyScalar(Y.walk.speed),$.velocity.lerp(o,Y.walk.acceleration)):($.velocity.lerp(o,Y.walk.deceleration),Om($.velocity)&&$.velocity.set(0,0,0)),$.velocity.lengthSq()>1e-6){$.dist+=$.velocity.length();let e=$.velocity.clone(),t=Y.walk.bounds,n=Y.walk.dampingZone;e.x<0&&X.position.x-t.minX<n?e.x*=Math.max(0,(X.position.x-t.minX)/n):e.x>0&&t.maxX-X.position.x<n&&(e.x*=Math.max(0,(t.maxX-X.position.x)/n)),e.y<0&&X.position.y-t.minY<n?e.y*=Math.max(0,(X.position.y-t.minY)/n):e.y>0&&t.maxY-X.position.y<n&&(e.y*=Math.max(0,(t.maxY-X.position.y)/n)),e.z<0&&X.position.z-t.minZ<n?e.z*=Math.max(0,(X.position.z-t.minZ)/n):e.z>0&&t.maxZ-X.position.z<n&&(e.z*=Math.max(0,(t.maxZ-X.position.z)/n));let r=X.position.clone().add(e);r.x<=t.minX?(r.x=t.minX,$.velocity.x=0):r.x>=t.maxX&&(r.x=t.maxX,$.velocity.x=0),r.y<=t.minY?(r.y=t.minY,$.velocity.y=0):r.y>=t.maxY&&(r.y=t.maxY,$.velocity.y=0),r.z<=t.minZ?(r.z=t.minZ,$.velocity.z=0):r.z>=t.maxZ&&(r.z=t.maxZ,$.velocity.z=0);let i=new V().subVectors(r,X.position);X.position.copy(r),fm.target.add(i)}}X.lookAt(fm.target);let a=X.quaternion.clone();Gf||Kf||i||Q.locked?Q.targetMouse.lerp(new B(0,0),Y.parallax.catchupSpeed):Q.targetMouse.lerp(Ih,Y.parallax.catchupSpeed);let o=new B().subVectors(Q.targetMouse,Q.currentMouse);Q.velocity.add(o.multiplyScalar(Y.parallax.springAccel)),Q.velocity.multiplyScalar(1-Y.parallax.springFriction),Q.currentMouse.add(Q.velocity),i&&(Dm(Q.targetMouse)&&Q.targetMouse.set(0,0),Dm(Q.velocity)&&Q.velocity.set(0,0),Dm(Q.currentMouse)&&Dm(Q.targetMouse)&&Dm(Q.velocity)&&Q.currentMouse.set(0,0));let s=Q.currentMouse.y*Nt.degToRad(Y.parallax.maxAngle),c=-Q.currentMouse.x*Nt.degToRad(Y.parallax.maxAngle);X.rotateX(s),X.rotateY(c);let l=Nm(e);Fm(e,{skyOnly:t&&!l&&!n,sceneAnimationActive:l}),X.quaternion.copy(a),Tm.renderRequested=!1,l?Am():t&&jm()}window.addEventListener(`resize`,()=>{X.aspect=window.innerWidth/window.innerHeight,X.updateProjectionMatrix(),im(),Oh(),Mm()}),Fh(),Am();